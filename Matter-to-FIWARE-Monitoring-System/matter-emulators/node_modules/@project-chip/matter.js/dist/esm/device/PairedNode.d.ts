...
export declare class PairedNode {
    ...
    subscribeAllAttributesAndEvents(options?: {
        ...
        attributeReports?: DecodedAttributeReportValue<any>[] | undefined;
        eventReports?: DecodedEventReportValue<any>[] | undefined;
    }>;
     ...
     * @param cluster ClusterServer to get or undefined if not existing
     */
    getClusterServerForDevice<F extends BitSchema, SF extends TypeFromPartialBitSchema<F>, A extends Attributes, C extends Commands, E extends Events>(endpointId: EndpointNumber, cluster: Cluster<F, SF, A, C, E>): ClusterServerObj<A, E> | undefined;
    /**
     * Get a cluster client from the root endpoint. This is mainly used internally and not needed to be called by the user.
     *
     * @param endpointId EndpointNumber to get the cluster from
     * @param cluster ClusterClient to get or undefined if not existing
     */
    getClusterClientForDevice<F extends BitSchema, SF extends TypeFromPartialBitSchema<F>, A extends Attributes, C extends Commands, E extends Events>(endpointId: EndpointNumber, cluster: Cluster<F, SF, A, C, E>): ClusterClientObj<F, A, C, E> | undefined;
}
