...
((OperationalCredentials2) => {
  OperationalCredentials2.TlvNOCStruct = TlvObject({
    /**
  ...
  OperationalCredentials2.TlvFabricDescriptorStruct = TlvObject({
    /**
  ...
  OperationalCredentials2.TlvAttestationRequestRequest = TlvObject({
  ...
  OperationalCredentials2.TlvCertificateChainRequestRequest = TlvObject({
    certificateType: TlvField(0, TlvEnum())
  });
  ...
  OperationalCredentials2.TlvCsrRequestRequest = TlvObject({
  ...
  OperationalCredentials2.TlvRemoveFabricRequest = TlvObject({ fabricIndex: TlvField(0, TlvFabricIndex) });
  ...
  OperationalCredentials2.Cluster = ClusterFactory.Definition({
    id: 62,
    ...
    attributes: {
      ...
      nocs: FabricScopedAttribute(
        0,
        TlvArray(OperationalCredentials2.TlvNOCStruct, { maxLength: 254 }),
        {
          persistent: true,
          omitChanges: true,
          default: [],
      ...
      fabrics: FabricScopedAttribute(
        1,
        TlvArray(OperationalCredentials2.TlvFabricDescriptorStruct, { maxLength: 254 }),
       ...
       */
      commissionedFabrics: Attribute(3, TlvUInt8.bound({ max: 254 }), { persistent: true }),
      /**
    ...
    commands: {
       ...
       */
      csrRequest: Command(4, OperationalCredentials2.TlvCsrRequestRequest, 5, OperationalCredentials2.TlvCsrResponse, { invokeAcl: AccessLevel.Administer }),
      /**
