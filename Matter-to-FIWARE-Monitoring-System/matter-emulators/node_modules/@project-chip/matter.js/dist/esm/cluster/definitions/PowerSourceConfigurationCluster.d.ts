...
export declare namespace PowerSourceConfiguration {
    ...
    const Cluster: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly sources: Attribute<import("../../datatype/EndpointNumber.js").EndpointNumber[], any>;
        };
    }>;
}
export type PowerSourceConfigurationCluster = typeof PowerSourceConfiguration.Cluster;
export declare const PowerSourceConfigurationCluster: ClusterFactory.Definition<{
    readonly id: 46;
    readonly name: "PowerSourceConfiguration";
    readonly revision: 1;
    readonly attributes: {
...
//# sourceMappingURL=PowerSourceConfigurationCluster.d.ts.map