...
const TlvAttributePath = TlvTaggedList({
  // AttributePathIB
...
const TlvEventPath = TlvTaggedList({
  // EventPathIB
...
const TlvAttributeStatus = TlvObject({
  // AttributeStatusIB
  path: TlvField(0, TlvAttributePath),
  status: TlvField(1, TlvStatus)
});
const TlvAttributeData = TlvObject({
...
const TlvDataReportForSend = TlvObject({
  subscriptionId: TlvOptionalField(0, TlvUInt32),
...
const TlvSubscribeResponse = TlvObject({
  subscriptionId: TlvField(0, TlvUInt32),
  maxInterval: TlvField(2, TlvUInt16),
  interactionModelRevision: TlvField(255, TlvUInt8)
});
const TlvInvokeRequest = TlvObject({
...
const TlvInvokeResponse = TlvObject({
  suppressResponse: TlvField(0, TlvBoolean),
  invokeResponses: TlvField(1, TlvArray(TlvInvokeResponseData)),
  interactionModelRevision: TlvField(255, TlvUInt8)
});
const TlvTimedRequest = TlvObject({
  timeout: TlvField(0, TlvUInt16),
  interactionModelRevision: TlvField(255, TlvUInt8)
});
const TlvWriteRequest = TlvObject({
...
const TlvWriteResponse = TlvObject({
