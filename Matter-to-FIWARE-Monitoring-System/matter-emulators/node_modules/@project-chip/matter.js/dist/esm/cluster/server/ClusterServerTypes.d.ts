...
import { Attribute, AttributeJsType, Attributes, Cluster, Command, Commands, Events, EventType, FabricScopedAttribute, FixedAttribute, GlobalAttributes, MandatoryAttributeNames, MandatoryEventNames, OptionalAttribute, OptionalAttributeNames, OptionalCommand, OptionalEventNames, OptionalFixedAttribute, OptionalWritableAttribute, OptionalWritableFabricScopedAttribute, RequestType, ResponseType, WritableAttribute, WritableFabricScopedAttribute } from "../Cluster.js";
...
type OptionalAttributeServers<A extends Attributes> = {
    [P in OptionalAttributeNames<A>]?: A[P] extends OptionalWritableFabricScopedAttribute<any, any> ? FabricScopedAttributeServer<AttributeJsType<A[P]>> : A[P] extends OptionalFixedAttribute<any, any> ? FixedAttributeServer<AttributeJsType<A[P]>> : AttributeServer<AttributeJsType<A[P]>>;
};
...
export type AttributeInitialValues<A extends Attributes> = Merge<Omit<{
...
type AttributeSetters<A extends Attributes> = {
    [P in keyof A as `${string & P}AttributeSetter`]?: (value: AttributeJsType<A[P]>, args: {
        attributes: AttributeServers<A>;
        endpoint?: Endpoint;
        session?: Session<MatterDevice>;
    }) => boolean;
...
type AttributeValidators<A extends Attributes> = {
    [P in keyof A as `${string & P}AttributeValidator`]?: (value: AttributeJsType<A[P]>, args: {
        attributes: AttributeServers<A>;
        endpoint?: Endpoint;
        session?: Session<MatterDevice>;
    }) => void;
};
export type CommandHandler<C extends Command<any, any, any>, AS extends AttributeServers<any>, ES extends EventServers<any>> = C extends Command<infer RequestT, infer ResponseT, any> ? (args: {
    request: RequestT;
    attributes: AS;
    events: ES;
    session: Session<MatterDevice>;
    message: Message;
    endpoint: Endpoint;
}) => Promise<ResponseT> | ResponseT : never;
...
export type ClusterServerHandlers<C extends Cluster<any, any, any, any, any>> = Merge<CommandHandlers<C["commands"], AttributeServers<C["attributes"]>, EventServers<C["events"]>>, Merge<AttributeHandlers<C["attributes"]>, {
...
type OptionalAttributeConf<T extends Attributes> = {
...
type UseOptionalAttributes<C extends Cluster<any, any, any, any, any>, A extends OptionalAttributeConf<C["attributes"]>> = Cluster<C["features"], C["supportedFeatures"], MakeAttributesMandatory<C["attributes"], A>, C["commands"], C["events"]>;
/** Forces the presence of the specified optional attributes, so they can be used in the command handlers */
export declare const UseOptionalAttributes: <C extends Cluster<any, any, any, any, any>, A extends OptionalAttributeConf<C["attributes"]>>(cluster: C, conf: A) => UseOptionalAttributes<C, A>;
export type FabricScopedAttributeNames<A extends Attributes> = {
    [K in keyof A]: A[K] extends FabricScopedAttribute<any, any> ? K : A[K] extends WritableFabricScopedAttribute<any, any> ? K : A[K] extends OptionalWritableFabricScopedAttribute<any, any> ? K : never;
}[keyof A];
export type NonFixedAttributeNames<A extends Attributes> = {
    [K in keyof A]: A[K] extends FixedAttribute<any, any> ? never : A[K] extends OptionalFixedAttribute<any, any> ? never : K;
}[keyof A];
...
export type ClusterServerObjForCluster<C extends Cluster<any, any, any, any, any>> = ClusterServerObj<C["attributes"], C["events"]>;
...
} & ServerAttributeGetters<A> & ServerAttributeSetters<A> & ServerAttributeSubscribers<A> & ServerEventTriggers<E>;
...
export type ClusterServerObjInternal<A extends Attributes, C extends Commands, E extends Events> = ClusterServerObj<A, E> & {
     ...
     * @private
     */
    readonly _setSceneExtensionFieldSets: (values: TypeFromSchema<typeof Scenes.TlvAttributeValuePair>[], transitionTime: number) => void;
    /**
...
export declare function isClusterServer<F extends BitSchema, A extends Attributes, C extends Commands, E extends Events>(obj: ClusterClientObj<F, A, C, E> | ClusterServerObj<A, E>): obj is ClusterServerObj<A, E>;
export declare function isClusterServerInternal<F extends BitSchema, A extends Attributes, C extends Commands, E extends Events>(obj: ClusterClientObj<F, A, C, E> | ClusterServerObj<A, E>): obj is ClusterServerObjInternal<A, C, E>;
export declare function asClusterServerInternal<A extends Attributes, E extends Events>(obj: ClusterServerObj<A, E>): ClusterServerObjInternal<A, Commands, E>;
export {};
//# sourceMappingURL=ClusterServerTypes.d.ts.map