...
var LevelControlCluster_exports = {};
__export(LevelControlCluster_exports, {
  LevelControl: () => LevelControl,
  LevelControlCluster: () => LevelControlCluster
});
module.exports = __toCommonJS(LevelControlCluster_exports);
...
var LevelControl;
((LevelControl2) => {
  LevelControl2.Options = { executeIfOff: (0, import_BitmapSchema.BitFlag)(0), coupleColorTempToLevel: (0, import_BitmapSchema.BitFlag)(1) };
  ...
  LevelControl2.TlvMoveToLevelWithOnOffRequest = (0, import_TlvObject.TlvObject)({
    level: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8),
    transitionTime: (0, import_TlvObject.TlvField)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16)),
    optionsMask: (0, import_TlvObject.TlvField)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvMoveWithOnOffRequest = (0, import_TlvObject.TlvObject)({
    moveMode: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    rate: (0, import_TlvObject.TlvField)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
    optionsMask: (0, import_TlvObject.TlvField)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvStepWithOnOffRequest = (0, import_TlvObject.TlvObject)({
    stepMode: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    stepSize: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt8),
    transitionTime: (0, import_TlvObject.TlvField)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16)),
    optionsMask: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options)),
  ...
  LevelControl2.TlvStopWithOnOffRequest = (0, import_TlvObject.TlvObject)({
    optionsMask: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(1, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, LevelControl2.Options))
  });
  ...
  LevelControl2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 8,
    name: "LevelControl",
    revision: 5,
    features: {
    ...
    attributes: {
       ...
       */
      currentLevel: (0, import_Cluster.Attribute)(
        0,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8.bound({ max: 254 })),
       ...
       */
      minLevel: (0, import_Cluster.OptionalAttribute)(2, import_TlvNumber.TlvUInt8, { default: 0 }),
      /**
       ...
       */
      onLevel: (0, import_Cluster.WritableAttribute)(17, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8.bound({ max: 254 })), { default: null }),
      /**
       ...
       */
      defaultMoveRate: (0, import_Cluster.OptionalWritableAttribute)(20, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8))
    },
    commands: {
      /**
       ...
       */
      moveToLevelWithOnOff: (0, import_Cluster.Command)(4, LevelControl2.TlvMoveToLevelWithOnOffRequest, 4, import_Cluster.TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      moveWithOnOff: (0, import_Cluster.Command)(5, LevelControl2.TlvMoveWithOnOffRequest, 5, import_Cluster.TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      stepWithOnOff: (0, import_Cluster.Command)(6, LevelControl2.TlvStepWithOnOffRequest, 6, import_Cluster.TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      stopWithOnOff: (0, import_Cluster.Command)(7, LevelControl2.TlvStopWithOnOffRequest, 7, import_Cluster.TlvNoResponse)
    }
  });
  LevelControl2.LightingComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
      ...
      startUpCurrentLevel: (0, import_Cluster.WritableAttribute)(
        ...
        { persistent: true, writeAcl: import_Cluster.AccessLevel.Manage }
      )
    }
  });
  LevelControl2.FrequencyComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
  ...
  LevelControl2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    { ...LevelControl2.Base, supportedFeatures: { onOff: true } },
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...LevelControl2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(LevelControl2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, LevelControl2.LightingComponent, { lighting: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, LevelControl2.FrequencyComponent, { frequency: true });
      return cluster;
    }
  );
  const LT = { lighting: true };
  const FQ = { frequency: true };
  LevelControl2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    attributes: {
      ...
      remainingTime: import_ClusterFactory.ClusterFactory.AsConditional(
        LevelControl2.LightingComponent.attributes.remainingTime,
        { mandatoryIf: [LT] }
      ),
      currentFrequency: import_ClusterFactory.ClusterFactory.AsConditional(
        LevelControl2.FrequencyComponent.attributes.currentFrequency,
        { mandatoryIf: [FQ] }
      ),
      minFrequency: import_ClusterFactory.ClusterFactory.AsConditional(
        LevelControl2.FrequencyComponent.attributes.minFrequency,
        { mandatoryIf: [FQ] }
      ),
      maxFrequency: import_ClusterFactory.ClusterFactory.AsConditional(
        LevelControl2.FrequencyComponent.attributes.maxFrequency,
        { mandatoryIf: [FQ] }
      ),
      startUpCurrentLevel: import_ClusterFactory.ClusterFactory.AsConditional(
    ...
    commands: {
      ...
      moveToClosestFrequency: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=LevelControlCluster.js.map
