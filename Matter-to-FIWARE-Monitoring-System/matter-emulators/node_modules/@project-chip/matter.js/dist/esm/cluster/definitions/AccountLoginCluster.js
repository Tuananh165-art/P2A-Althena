...
var AccountLogin;
((AccountLogin2) => {
  AccountLogin2.TlvGetSetupPinRequest = TlvObject({
    /**
  ...
  AccountLogin2.TlvGetSetupPinResponse = TlvObject({
    /**
  ...
  AccountLogin2.TlvLoginRequest = TlvObject({
    /**
  ...
  AccountLogin2.Cluster = ClusterFactory.Definition({
    id: 1294,
    name: "AccountLogin",
    revision: 1,
    commands: {
       ...
       */
      logout: Command(3, TlvNoArguments, 3, TlvNoResponse, { timed: true })
    }
  });
...
//# sourceMappingURL=AccountLoginCluster.js.map
