...
((LeafWetnessMeasurement2) => {
  LeafWetnessMeasurement2.Cluster = ClusterFactory.Definition({
    id: 1031,
    ...
    attributes: {
       ...
       */
      measuredValue: Attribute(0, TlvNullable(TlvUInt16.bound({ max: 1e4 }))),
      /**
