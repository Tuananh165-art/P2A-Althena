...
class Aggregator extends import_Endpoint.Endpoint {
  ...
  addBridgedDevice(device, bridgedBasicInformation) {
    ...
    if (bridgedBasicInformation !== void 0) {
      const bridgedBasicInformationCluster = (0, import_ClusterServer.ClusterServer)(
        import_BridgedDeviceBasicInformationCluster.BridgedDeviceBasicInformationCluster,
      ...
      if (!device.hasClusterServer(import_BridgedDeviceBasicInformationCluster.BridgedDeviceBasicInformationCluster)) {
  ...
  addBridgedDeviceWithPowerSourceInfo(device, bridgedBasicInformation) {
    ...
    if (bridgedBasicInformation !== void 0) {
      device.addClusterServer((0, import_ClusterServer.ClusterServer)(import_BridgedDeviceBasicInformationCluster.BridgedDeviceBasicInformationCluster, bridgedBasicInformation, {}));
    } else {
      if (!device.hasClusterServer(import_BridgedDeviceBasicInformationCluster.BridgedDeviceBasicInformationCluster)) {
        throw new import_MatterError.ImplementationError(
          "BridgedDeviceBasicInformationCluster is required for bridged devices. Please add yourself or provide as second parameter"
