...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "GroupId", id: 0, type: "group-id", conformance: "M", constraint: "min 1" },
        { tag: "datatype", name: "GroupName", id: 1, type: "string", conformance: "M", constraint: "max 16" }
      ]
    },
    {
      tag: "command",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "GroupId", id: 1, type: "group-id", conformance: "M", constraint: "min 1" }
      ]
    },
    {
      tag: "command",
      ...
      children: [
        { tag: "datatype", name: "Status", id: 0, type: "status", conformance: "M", constraint: "desc" },
        { tag: "datatype", name: "GroupId", id: 1, type: "group-id", conformance: "M", constraint: "min 1" },
        { tag: "datatype", name: "GroupName", id: 2, type: "string", conformance: "M", constraint: "max 16" }
      ]
    },
    {
      tag: "command",
      ...
      children: [
        { tag: "datatype", name: "Capacity", id: 0, type: "uint8", conformance: "M", quality: "X" },
        {
          tag: "datatype",
          name: "GroupList",
          id: 1,
