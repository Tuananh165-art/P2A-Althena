...
((KeypadInput2) => {
  ...
  KeypadInput2.Base = ClusterFactory.Definition({
    id: 1289,
    name: "KeypadInput",
    revision: 1,
    features: {
  ...
  KeypadInput2.Cluster = ClusterFactory.Extensible(
    KeypadInput2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...KeypadInput2.Base,
        supportedFeatures: BitFlags(KeypadInput2.Base.features, ...features)
      });
      return cluster;
    }
  );
