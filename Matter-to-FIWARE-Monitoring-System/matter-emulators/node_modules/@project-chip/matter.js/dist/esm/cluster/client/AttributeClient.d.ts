 ...
 */
export declare class AttributeClient<T> {
    readonly attribute: Attribute<T, any>;
    readonly name: string;
    readonly endpointId: EndpointNumber;
    readonly clusterId: ClusterId;
    private readonly interactionClient;
    private readonly isWritable;
    private readonly isFabricScoped;
    ...
    get(alwaysRequestFromRemote?: boolean, isFabricFiltered?: boolean): Promise<T | undefined>;
    /**
     * Get the value with version of the attribute. Fabric scoped reads are always done with the remote.
     * */
    getWithVersion(alwaysRequestFromRemote?: boolean, isFabricFiltered?: boolean): Promise<{
        value: T;
        version: number;
    } | undefined>;
    /** Subscribe to the attribute. */
    subscribe(minIntervalFloorSeconds: number, maxIntervalCeilingSeconds: number, knownDataVersion?: number, isFabricFiltered?: boolean): Promise<void>;
    /**
