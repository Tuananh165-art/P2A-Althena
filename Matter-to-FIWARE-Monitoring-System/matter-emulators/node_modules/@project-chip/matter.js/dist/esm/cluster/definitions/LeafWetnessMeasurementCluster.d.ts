...
export declare namespace LeafWetnessMeasurement {
    /**
...
export declare const LeafWetnessMeasurementCluster: ClusterFactory.Definition<{
    readonly id: 1031;
    readonly name: "LeafWetnessMeasurement";
    readonly revision: 3;
    readonly attributes: {
...
//# sourceMappingURL=LeafWetnessMeasurementCluster.d.ts.map