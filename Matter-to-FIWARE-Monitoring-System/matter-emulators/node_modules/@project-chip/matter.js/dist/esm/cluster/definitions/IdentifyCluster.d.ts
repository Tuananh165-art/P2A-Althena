...
import { WritableAttribute, Attribute, Command, OptionalCommand } from "../../cluster/Cluster.js";
export declare namespace Identify {
     ...
     */
    const TlvIdentifyRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        identifyTime: import("../../tlv/TlvObject.js").FieldType<number>;
    }>;
    /**
     ...
     */
    const TlvTriggerEffectRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
         ...
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.6.3.2
         */
        effectVariant: import("../../tlv/TlvObject.js").FieldType<EffectVariant>;
    }>;
    /**
     ...
     */
    const TlvIdentifyQueryResponse: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
    ...
    const Base: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly identifyTime: WritableAttribute<number, any>;
            /**
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.5.2
             */
            readonly identifyType: Attribute<IdentifyType, any>;
        };
        readonly commands: {
            /**
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.6.1
             */
            readonly identify: Command<import("../../tlv/TlvObject.js").TypeFromFields<{
                identifyTime: import("../../tlv/TlvObject.js").FieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.6.3
             */
            readonly triggerEffect: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field specifies the identify effect to use. All values of the EffectIdentifier shall be supported.
                 * Implementors may deviate from the example light effects in the table below, but they SHOULD indicate during
                 * testing how they handle each effect.
     ...
     */
    const QueryComponent: ClusterFactory.TypedComponent<{
        readonly commands: {
            /**
             ...
             */
            readonly identifyQuery: Command<void, import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field contains the current value of the IdentifyTime attribute, and specifies the length of time, in
                 * seconds, that the device will continue to identify itself.
                 *
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<3 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "Identify";
        revision: 4;
        features: {
            /**
        ...
        readonly with: <T extends "Query"[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * Query
             *
             * Multicast query for identification state
    ...
    const Complete: ClusterFactory.Definition<{
        readonly id: 3 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "Identify";
        readonly revision: 4;
        readonly features: {
            /**
        ...
        readonly attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
            /**
             * This attribute specifies the remaining length of time, in seconds, that the endpoint will continue to
             * identify itself.
             *
...
export declare const IdentifyCluster: {
    id: import("../../util/Type.js").Branded<3 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "Identify";
    revision: 4;
    features: {
    ...
    attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
         ...
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.5.2
         */
        readonly identifyType: Attribute<Identify.IdentifyType, any>;
    }, import("../../cluster/Cluster.js").GlobalAttributes<{
        /**
         * Query
         *
    ...
    commands: {
        ...
        readonly triggerEffect: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.6.3.1
             */
            effectIdentifier: import("../../tlv/TlvObject.js").FieldType<Identify.EffectIdentifier>;
            /**
             * This field is used to indicate which variant of the effect, indicated in the EffectIdentifier field, SHOULD
             * be triggered. If a device does not support the given variant, it shall use the default variant. This field
             * shall contain one of the values listed below:
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.2.6.3.2
             */
            effectVariant: import("../../tlv/TlvObject.js").FieldType<Identify.EffectVariant>;
        }>, void, any>;
    };
    events: {};
    unknown: false;
    ...
    readonly with: <T extends "Query"[]>(...features_0: T) => Identify.Extension<BitFlags<{
        /**
         * Query
         *
         * Multicast query for identification state
...
//# sourceMappingURL=IdentifyCluster.d.ts.map