...
class InteractionEndpointStructure {
  ...
  verifyAndInitializeStructureElementsFromEndpoint(endpoint) {
    ...
    if (this.endpoints.has(endpoint.id))
      throw new ImplementationError(`Endpoint ID ${endpoint.id} exists twice`);
  ...
  validateConcreteAttributePath(endpointId, clusterId, attributeId) {
    ...
    if (this.hasAttribute(endpointId, clusterId, attributeId))
      return true;
  ...
  validateConcreteEventPath(endpointId, clusterId, eventId) {
    ...
    if (this.hasEvent(endpointId, clusterId, eventId))
      return true;
  ...
  validateConcreteCommandPath(endpointId, clusterId, commandId) {
    ...
    if (this.hasCommand(endpointId, clusterId, commandId))
      return true;
