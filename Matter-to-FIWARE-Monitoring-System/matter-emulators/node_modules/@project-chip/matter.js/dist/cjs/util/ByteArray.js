...
Uint8Array.fromHex = function(hexString) {
  ...
  if (hexString.length % 2 !== 0)
    throw new import_MatterError.UnexpectedDataError("Hex string should have an even length.");
  const bytes = hexString.match(/.{1,2}/g)?.map((byteHex) => parseInt(byteHex, 16));
  if (bytes === void 0)
    throw new import_MatterError.UnexpectedDataError("Failed to parse the hex string.");
