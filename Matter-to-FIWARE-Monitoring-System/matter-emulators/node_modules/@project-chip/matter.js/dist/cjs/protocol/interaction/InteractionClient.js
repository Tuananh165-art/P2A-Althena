...
class InteractionClient {
  ...
  async processReadRequest(messenger, request) {
    ...
    const normalizedResult = {
      attributeReports: (0, import_AttributeDataDecoder.normalizeAndDecodeReadAttributeReport)(attributeReports),
      eventReports: (0, import_EventDataDecoder.normalizeAndDecodeReadEventReport)(eventReports)
    };
    logger.debug(
  ...
  registerSubscriptionUpdateTimer(subscriptionId, maxInterval, updateTimeoutHandler) {
    ...
    maxInterval += 5;
    const timer = import_Time.Time.getTimer(maxInterval * 1e3, () => {
