...
class DataWriter {
  constructor(endian) {
    ...
    this.littleEndian = endian === import_ByteArray.Endian.Little;
  }
  writeUInt8(value) {
    this.chunks.push(new import_ByteArray.ByteArray([(0, import_Number.toNumber)(value)]));
    this.length += 1;
  }
  writeUInt16(value) {
    const chunk = new import_ByteArray.ByteArray(2);
    new DataView(chunk.buffer, 0, 2).setUint16(0, (0, import_Number.toNumber)(value), this.littleEndian);
    this.chunks.push(chunk);
    this.length += 2;
  }
  writeUInt32(value) {
    const chunk = new import_ByteArray.ByteArray(4);
    new DataView(chunk.buffer, 0, 4).setUint32(0, (0, import_Number.toNumber)(value), this.littleEndian);
    this.chunks.push(chunk);
    this.length += 4;
  }
  writeUInt64(value) {
    const chunk = new import_ByteArray.ByteArray(8);
    new DataView(chunk.buffer, 0, 8).setBigUint64(0, (0, import_Number.toBigInt)(value), this.littleEndian);
    this.chunks.push(chunk);
    this.length += 8;
  }
  writeInt8(value) {
    const chunk = new import_ByteArray.ByteArray(1);
  ...
  toByteArray() {
    ...
    const result = new import_ByteArray.ByteArray(this.length);
    let offset = 0;
