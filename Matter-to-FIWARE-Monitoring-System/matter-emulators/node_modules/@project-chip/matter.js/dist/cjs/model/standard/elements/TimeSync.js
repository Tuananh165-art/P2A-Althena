  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "Name", id: 1, type: "string", conformance: "O", constraint: "0 to 64" }
      ]
    },
    {
      tag: "command",
      ...
      children: [
        ...
        },
        {
          ...
          conformance: "M",
          default: 0,
          details: "This shall give the Client\u2019s Granularity, as described in Section 11.16.8.2, \u201CGranularity Attribute\u201D.",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          id: 2,
          conformance: "M",
          description: "This indicates the server is synchronized to an upstream source using a low resolution protocol. UTC Time is accurate to \xB1 5 seconds."
        },
        {
          tag: "datatype",
          ...
          id: 3,
          conformance: "M",
          description: "This indicates the server is synchronized to an upstream source using high resolution time-synchronization protocol such as NTP, or has built-in GNSS with some amount of jitter applying its GNSS timestamp. UTC Time is accurate to \xB1 50ms."
        },
        {
          tag: "datatype",
          ...
          id: 4,
          conformance: "M",
          description: "This indicates the server is synchronized to an upstream source using a highly precise time-synchronization protocol such as PTP, or has built-in GNSS. UTC time is accurate to \xB1 10 \u03BCs."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          conformance: "O",
          constraint: "0 to 64",
          details: "The time zone name SHOULD provide a human-readable time zone name and it SHOULD use the country/city format specified by the IANA time zone database [https://www.iana.org/time-zones].",
    ...
    },
    {
      ...
      type: "struct",
      conformance: "M",
      details: "The DST offset in seconds. Normally this is in the range of 0 to 3600 seconds (1 hour), but this field will accept any values in the int32 range to accommodate potential future legislation that does not fit with these assumptions.",
      xref: { document: "core", section: "11.16.6.4" },
      children: [
        { tag: "datatype", name: "Offset", id: 0, type: "int32", conformance: "M", constraint: "desc" },
        {
          tag: "datatype",
          name: "ValidStarting",
          id: 1,
        ...
        },
        {
          ...
          type: "epoch-us",
          conformance: "M",
          details: "The UTC time when the offset shall stop being applied. This value shall be larger than the ValidStarting time.",
