...
var ModeSelect;
((ModeSelect2) => {
  ModeSelect2.TlvSemanticTagStruct = TlvObject({
    /**
  ...
  ModeSelect2.TlvModeOptionStruct = TlvObject({
    /**
     ...
     */
    semanticTags: TlvField(2, TlvArray(ModeSelect2.TlvSemanticTagStruct, { maxLength: 64 }))
  });
  ModeSelect2.TlvChangeToModeRequest = TlvObject({ newMode: TlvField(0, TlvUInt8) });
  let Feature;
  ((Feature2) => {
    Feature2["OnOff"] = "OnOff";
  })(Feature = ModeSelect2.Feature || (ModeSelect2.Feature = {}));
  ModeSelect2.Base = ClusterFactory.Definition({
    id: 80,
    name: "ModeSelect",
    revision: 1,
    features: {
    ...
    attributes: {
       ...
       */
      supportedModes: FixedAttribute(2, TlvArray(ModeSelect2.TlvModeOptionStruct, { maxLength: 255 }), { default: [] }),
      /**
    ...
    commands: {
       ...
       */
      changeToMode: Command(0, ModeSelect2.TlvChangeToModeRequest, 0, TlvNoResponse)
    }
  });
  ModeSelect2.OnOffComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  ModeSelect2.Cluster = ClusterFactory.Extensible(
    ModeSelect2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...ModeSelect2.Base,
        supportedFeatures: BitFlags(ModeSelect2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, ModeSelect2.OnOffComponent, { onOff: true });
      return cluster;
    }
  );
  const DEPONOFF = { onOff: true };
  ModeSelect2.Complete = ClusterFactory.Definition({
    ...
    attributes: {
      ...
      onMode: ClusterFactory.AsConditional(ModeSelect2.OnOffComponent.attributes.onMode, { mandatoryIf: [DEPONOFF] })
    },
...
//# sourceMappingURL=ModeSelectCluster.js.map
