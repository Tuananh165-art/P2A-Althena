 ...
 */
const logger = import_Logger.Logger.get("ValidateModel");
  ...
  class Result {
    ...
    report() {
      if (this.errors.length) {
        ...
        this.errors.forEach(
          (error) => logger.error(error.message, import_Logger.Logger.dict({ code: error.code, xref: error.xref, src: error.source }))
        );
