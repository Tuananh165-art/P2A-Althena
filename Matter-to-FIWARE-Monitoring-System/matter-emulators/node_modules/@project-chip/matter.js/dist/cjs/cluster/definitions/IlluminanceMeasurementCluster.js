...
var IlluminanceMeasurementCluster_exports = {};
__export(IlluminanceMeasurementCluster_exports, {
  IlluminanceMeasurement: () => IlluminanceMeasurement,
  IlluminanceMeasurementCluster: () => IlluminanceMeasurementCluster
});
module.exports = __toCommonJS(IlluminanceMeasurementCluster_exports);
...
((IlluminanceMeasurement2) => {
  IlluminanceMeasurement2.Cluster = import_ClusterFactory.ClusterFactory.Definition({
    id: 1024,
    ...
    attributes: {
       ...
       */
      minMeasuredValue: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16.bound({ min: 1 }))),
      /**
       ...
       */
      maxMeasuredValue: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16.bound({ max: 65534 }))),
      /**
       * See Measured Value.
       *
...
//# sourceMappingURL=IlluminanceMeasurementCluster.js.map
