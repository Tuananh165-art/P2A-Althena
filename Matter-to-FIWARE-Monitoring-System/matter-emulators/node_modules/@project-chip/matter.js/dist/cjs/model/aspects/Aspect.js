...
module.exports = __toCommonJS(Aspect_exports);
...
class Aspect {
  ...
  get empty() {
    for (const [k, v] of Object.entries(this)) {
      if (k !== "definition" && k !== "errors" && v !== void 0) {
        return false;
      }
    }
    return true;
  ...
  equals(other) {
    ...
    return (0, import_DeepEqual.isDeepEqual)(this.valueOf(), other.valueOf());
  }
  valueOf() {
  ...
  error(code, message) {
    ...
    this.errors.push({
      code,
      source: `${this.constructor.name} ${(0, import_String.serialize)(this.definition)}`,
      message
    });
  }
  extend(other) {
