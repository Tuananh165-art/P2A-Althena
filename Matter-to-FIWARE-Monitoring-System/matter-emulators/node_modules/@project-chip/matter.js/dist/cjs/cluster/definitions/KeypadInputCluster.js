...
var KeypadInputCluster_exports = {};
__export(KeypadInputCluster_exports, {
  KeypadInput: () => KeypadInput,
  KeypadInputCluster: () => KeypadInputCluster
});
module.exports = __toCommonJS(KeypadInputCluster_exports);
...
((KeypadInput2) => {
  ...
  ((CecKeyCode2) => {
    ...
    CecKeyCode2[CecKeyCode2["Reserved"] = 79] = "Reserved";
  ...
  KeypadInput2.TlvSendKeyRequest = (0, import_TlvObject.TlvObject)({
    /**
  ...
  KeypadInput2.TlvSendKeyResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  KeypadInput2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 1289,
    name: "KeypadInput",
    revision: 1,
    features: {
       ...
       */
      navigationKeyCodes: (0, import_BitmapSchema.BitFlag)(0),
      /**
       * LocationKeys
       *
       * Supports CEC keys 0x0A (Settings) and 0x09 (Home)
       */
      locationKeys: (0, import_BitmapSchema.BitFlag)(1),
      /**
       * NumberKeys
       *
       * Supports numeric input 0..9
       */
      numberKeys: (0, import_BitmapSchema.BitFlag)(2)
    },
    commands: {
      /**
  ...
  KeypadInput2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    KeypadInput2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...KeypadInput2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(KeypadInput2.Base.features, ...features)
      });
      return cluster;
    }
  );
...
//# sourceMappingURL=KeypadInputCluster.js.map
