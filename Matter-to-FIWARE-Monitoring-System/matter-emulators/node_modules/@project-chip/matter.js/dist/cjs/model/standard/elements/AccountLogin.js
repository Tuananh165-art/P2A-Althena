  ...
  children: [
    { tag: "attribute", name: "ClusterRevision", id: 65533, type: "ClusterRevision", default: 1 },
    {
      ...
      children: [{
        ...
        conformance: "M",
        constraint: "max 100",
        details: "This attribute shall specify the client\u2019s Temporary Account Identifier. The length of this field shall be at least 16 characters to protect the account holder against password guessing attacks.",
    ...
    },
    {
      ...
      children: [{
        ...
        constraint: "min 11",
        quality: "X",
        details: "This field shall provide the setup PIN code as a text string at least 11 characters in length or null to indicate that the accounts do not match.",
