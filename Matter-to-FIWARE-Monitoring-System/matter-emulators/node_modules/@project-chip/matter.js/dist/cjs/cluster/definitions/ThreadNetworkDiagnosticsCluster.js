...
var ThreadNetworkDiagnosticsCluster_exports = {};
__export(ThreadNetworkDiagnosticsCluster_exports, {
  ThreadNetworkDiagnostics: () => ThreadNetworkDiagnostics,
  ThreadNetworkDiagnosticsCluster: () => ThreadNetworkDiagnosticsCluster
});
module.exports = __toCommonJS(ThreadNetworkDiagnosticsCluster_exports);
...
((ThreadNetworkDiagnostics2) => {
  ...
  ThreadNetworkDiagnostics2.TlvNeighborTableStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    frameErrorRate: (0, import_TlvObject.TlvOptionalField)(8, import_TlvNumber.TlvUInt8.bound({ max: 100 })),
    /**
     ...
     */
    messageErrorRate: (0, import_TlvObject.TlvOptionalField)(9, import_TlvNumber.TlvUInt8.bound({ max: 100 })),
    /**
  ...
  ThreadNetworkDiagnostics2.TlvRouteTableStruct = (0, import_TlvObject.TlvObject)({
    extAddress: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt64),
  ...
  ThreadNetworkDiagnostics2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 53,
    ...
    attributes: {
       ...
       */
      networkName: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(import_TlvString.TlvString.bound({ maxLength: 16 })), { default: "" }),
      /**
       ...
       */
      panId: (0, import_Cluster.Attribute)(3, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16), { default: 0 }),
      /**
       ...
       */
      extendedPanId: (0, import_Cluster.Attribute)(4, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { default: 0 }),
      /**
       ...
       */
      meshLocalPrefix: (0, import_Cluster.Attribute)(5, (0, import_TlvNullable.TlvNullable)(import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 17 }))),
      /**
       ...
       */
      neighborTable: (0, import_Cluster.Attribute)(7, (0, import_TlvArray.TlvArray)(ThreadNetworkDiagnostics2.TlvNeighborTableStruct, { maxLength: 254 }), { default: [] }),
      /**
       ...
       */
      routeTable: (0, import_Cluster.Attribute)(8, (0, import_TlvArray.TlvArray)(ThreadNetworkDiagnostics2.TlvRouteTableStruct, { maxLength: 254 }), { default: [] }),
      /**
       ...
       */
      weighting: (0, import_Cluster.Attribute)(10, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
      /**
       ...
       */
      dataVersion: (0, import_Cluster.Attribute)(11, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
      /**
       ...
       */
      stableDataVersion: (0, import_Cluster.Attribute)(12, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
      /**
       ...
       */
      leaderRouterId: (0, import_Cluster.Attribute)(13, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8)),
      /**
       ...
       */
      activeNetworkFaults: (0, import_Cluster.Attribute)(62, (0, import_TlvArray.TlvArray)((0, import_TlvNumber.TlvEnum)(), { maxLength: 4 }), { default: [] })
    },
    events: {
      /**
  ...
  ThreadNetworkDiagnostics2.ErrorCountsComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
    ...
    commands: {
       ...
       */
      resetCounts: (0, import_Cluster.Command)(0, import_TlvNoArguments.TlvNoArguments, 0, import_Cluster.TlvNoResponse, { invokeAcl: import_Cluster.AccessLevel.Manage })
    }
  });
  ThreadNetworkDiagnostics2.MleCountsComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
  ...
  ThreadNetworkDiagnostics2.MacCountsComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      rxErrInvalidScrAddrCount: (0, import_Cluster.OptionalAttribute)(52, import_TlvNumber.TlvUInt32, { omitChanges: true, default: 0 }),
      /**
  ...
  ThreadNetworkDiagnostics2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    ThreadNetworkDiagnostics2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...ThreadNetworkDiagnostics2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(ThreadNetworkDiagnostics2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.ErrorCountsComponent, { errorCounts: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.MleCountsComponent, { mleCounts: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.MacCountsComponent, { macCounts: true });
      return cluster;
    }
  );
  ...
  ThreadNetworkDiagnostics2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    attributes: {
      ...
      overrunCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.ErrorCountsComponent.attributes.overrunCount,
        { mandatoryIf: [ERRCNT] }
      ),
      detachedRoleCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.detachedRoleCount,
        { optionalIf: [MLECNT] }
      ),
      childRoleCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.childRoleCount,
        { optionalIf: [MLECNT] }
      ),
      routerRoleCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.routerRoleCount,
        { optionalIf: [MLECNT] }
      ),
      leaderRoleCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.leaderRoleCount,
        { optionalIf: [MLECNT] }
      ),
      attachAttemptCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.attachAttemptCount,
        { optionalIf: [MLECNT] }
      ),
      partitionIdChangeCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.partitionIdChangeCount,
        { optionalIf: [MLECNT] }
      ),
      betterPartitionAttachAttemptCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.betterPartitionAttachAttemptCount,
        { optionalIf: [MLECNT] }
      ),
      parentChangeCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MleCountsComponent.attributes.parentChangeCount,
        { optionalIf: [MLECNT] }
      ),
      txTotalCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txTotalCount,
        { optionalIf: [MACCNT] }
      ),
      txUnicastCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txUnicastCount,
        { optionalIf: [MACCNT] }
      ),
      txBroadcastCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txBroadcastCount,
        { optionalIf: [MACCNT] }
      ),
      txAckRequestedCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txAckRequestedCount,
        { optionalIf: [MACCNT] }
      ),
      txAckedCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txAckedCount,
        { optionalIf: [MACCNT] }
      ),
      txNoAckRequestedCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txNoAckRequestedCount,
        { optionalIf: [MACCNT] }
      ),
      txDataCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txDataCount,
        { optionalIf: [MACCNT] }
      ),
      txDataPollCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txDataPollCount,
        { optionalIf: [MACCNT] }
      ),
      txBeaconCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txBeaconCount,
        { optionalIf: [MACCNT] }
      ),
      txBeaconRequestCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txBeaconRequestCount,
        { optionalIf: [MACCNT] }
      ),
      txOtherCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txOtherCount,
        { optionalIf: [MACCNT] }
      ),
      txRetryCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txRetryCount,
        { optionalIf: [MACCNT] }
      ),
      txDirectMaxRetryExpiryCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txDirectMaxRetryExpiryCount,
        { optionalIf: [MACCNT] }
      ),
      txIndirectMaxRetryExpiryCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txIndirectMaxRetryExpiryCount,
        { optionalIf: [MACCNT] }
      ),
      txErrCcaCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txErrCcaCount,
        { optionalIf: [MACCNT] }
      ),
      txErrAbortCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txErrAbortCount,
        { optionalIf: [MACCNT] }
      ),
      txErrBusyChannelCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.txErrBusyChannelCount,
        { optionalIf: [MACCNT] }
      ),
      rxTotalCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxTotalCount,
        { optionalIf: [MACCNT] }
      ),
      rxUnicastCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxUnicastCount,
        { optionalIf: [MACCNT] }
      ),
      rxBroadcastCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxBroadcastCount,
        { optionalIf: [MACCNT] }
      ),
      rxDataCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxDataCount,
        { optionalIf: [MACCNT] }
      ),
      rxDataPollCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxDataPollCount,
        { optionalIf: [MACCNT] }
      ),
      rxBeaconCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxBeaconCount,
        { optionalIf: [MACCNT] }
      ),
      rxBeaconRequestCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxBeaconRequestCount,
        { optionalIf: [MACCNT] }
      ),
      rxOtherCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxOtherCount,
        { optionalIf: [MACCNT] }
      ),
      rxAddressFilteredCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxAddressFilteredCount,
        { optionalIf: [MACCNT] }
      ),
      rxDestAddrFilteredCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxDestAddrFilteredCount,
        { optionalIf: [MACCNT] }
      ),
      rxDuplicatedCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxDuplicatedCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrNoFrameCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrNoFrameCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrUnknownNeighborCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrUnknownNeighborCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrInvalidScrAddrCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrInvalidScrAddrCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrSecCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrSecCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrFcsCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrFcsCount,
        { optionalIf: [MACCNT] }
      ),
      rxErrOtherCount: import_ClusterFactory.ClusterFactory.AsConditional(
        ThreadNetworkDiagnostics2.MacCountsComponent.attributes.rxErrOtherCount,
        { optionalIf: [MACCNT] }
      )
    },
    commands: {
      resetCounts: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=ThreadNetworkDiagnosticsCluster.js.map
