...
export declare namespace NodeId {
     ...
     */
    const getFromTemporaryLocalNodeId: (id: number) => NodeId;
    /**
     ...
     */
    const getFromCaseAuthenticatedTag: (id: CaseAuthenticatedTag) => NodeId;
