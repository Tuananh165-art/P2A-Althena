...
export declare const AllClustersMap: {
    [key: Cluster<any, any, any, any, any>["id"]]: Cluster<any, any, any, any, any>;
};
...
export declare const UnknownCluster: (clusterId: ClusterId) => Cluster<import("../schema/BitmapSchema.js").BitSchema, import("../schema/BitmapSchema.js").TypeFromPartialBitSchema<import("../schema/BitmapSchema.js").BitSchema>, import("../util/Type.js").Merge<{}, import("./Cluster.js").GlobalAttributes<import("../schema/BitmapSchema.js").BitSchema>>, {}, {}>;
...
export declare function resolveEventName({ nodeId, endpointId, clusterId, eventId }: TypeFromSchema<typeof TlvEventPath>): string;
