...
class Model {
      ...
      set: (target, p, newValue, receiver) => {
        if (typeof p === "string" && p.match(/^[0-9]+$/)) {
          if (typeof newValue !== "object" || newValue === null || !newValue.tag) {
            throw new import_MatterError.InternalError("Child must be Model or AnyElement");
          }
        }
   ...
   */
  all(constructor) {
    return this.children.filter((c) => c instanceof constructor);
  }
  /**
  ...
  get(constructor, key) {
    return this.children.find(
      (c) => c instanceof constructor && typeof key === "number" ? c.effectiveId === key : c.name === key
    );
  }
  /**
   ...
   */
  owner(constructor) {
    return new import_ModelTraversal.ModelTraversal().findOwner(constructor, this.parent);
  }
  /**
   ...
   */
  member(key, allowedTags = [import_definitions.ElementTag.Datatype, import_definitions.ElementTag.Attribute]) {
