...
((Actions2) => {
  ...
  Actions2.TlvActionStruct = TlvObject({
    /**
  ...
  Actions2.TlvEndpointListStruct = TlvObject({
  ...
  Actions2.Cluster = ClusterFactory.Definition({
    id: 37,
    name: "Actions",
    revision: 1,
    attributes: {
       ...
       */
      actionList: Attribute(0, TlvArray(Actions2.TlvActionStruct, { maxLength: 256 }), { default: [] }),
      /**
       ...
       */
      endpointLists: Attribute(1, TlvArray(Actions2.TlvEndpointListStruct, { maxLength: 256 }), { default: [] }),
      /**
