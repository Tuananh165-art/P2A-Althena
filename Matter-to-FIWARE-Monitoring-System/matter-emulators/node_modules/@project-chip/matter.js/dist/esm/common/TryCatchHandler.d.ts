 ...
 */
export declare function tryCatch<T, E extends Error>(codeBlock: () => T, errorType: ClassExtends<E>, fallbackValueOrFunction: ErrorHandler<T, E> | T): T;
/**
 ...
 * @param fallbackValueOrFunction Fallback value or function to compute the fallback value
 */
export declare function tryCatchAsync<T, E extends Error>(codeBlock: () => Promise<T>, errorType: ClassExtends<E>, fallbackValueOrFunction: ErrorHandler<Promise<T>, E> | T): Promise<T>;
export {};
