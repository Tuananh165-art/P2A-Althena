...
var PowerSourceCluster_exports = {};
__export(PowerSourceCluster_exports, {
  PowerSource: () => PowerSource,
  PowerSourceCluster: () => PowerSourceCluster
});
module.exports = __toCommonJS(PowerSourceCluster_exports);
...
((PowerSource2) => {
  ...
  PowerSource2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 47,
    name: "PowerSource",
    revision: 1,
    features: {
  ...
  PowerSource2.WiredComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      activeWiredFaults: (0, import_Cluster.OptionalAttribute)(10, (0, import_TlvArray.TlvArray)((0, import_TlvNumber.TlvEnum)(), { length: 8 }))
    },
    events: {
      /**
  ...
  PowerSource2.BatteryComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      batPercentRemaining: (0, import_Cluster.OptionalAttribute)(
        12,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8.bound({ max: 200 })),
        { omitChanges: true }
      ),
      /**
       ...
       */
      batTimeRemaining: (0, import_Cluster.OptionalAttribute)(13, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32), { omitChanges: true }),
      /**
       ...
       */
      activeBatFaults: (0, import_Cluster.OptionalAttribute)(18, (0, import_TlvArray.TlvArray)((0, import_TlvNumber.TlvEnum)(), { length: 8 }))
    },
    events: {
      /**
  ...
  PowerSource2.ReplaceableComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
  ...
  PowerSource2.RechargeableComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      batTimeToFullCharge: (0, import_Cluster.OptionalAttribute)(27, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32), { omitChanges: true }),
      /**
       ...
       */
      activeBatChargeFaults: (0, import_Cluster.OptionalAttribute)(30, (0, import_TlvArray.TlvArray)((0, import_TlvNumber.TlvEnum)(), { length: 16 }))
    },
    events: {
      /**
  ...
  PowerSource2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    PowerSource2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...PowerSource2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(PowerSource2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, PowerSource2.WiredComponent, { wired: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, PowerSource2.BatteryComponent, { battery: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, PowerSource2.ReplaceableComponent, { replaceable: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, PowerSource2.RechargeableComponent, { rechargeable: true });
      return cluster;
    }
  );
  ...
  PowerSource2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    id: PowerSource2.Cluster.id,
    name: PowerSource2.Cluster.name,
    revision: PowerSource2.Cluster.revision,
    features: PowerSource2.Cluster.features,
    attributes: {
      ...PowerSource2.Cluster.attributes,
      wiredAssessedInputVoltage: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredAssessedInputVoltage,
        { optionalIf: [WIRED] }
      ),
      wiredAssessedInputFrequency: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredAssessedInputFrequency,
        { optionalIf: [WIRED] }
      ),
      wiredCurrentType: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredCurrentType,
        { mandatoryIf: [WIRED] }
      ),
      wiredAssessedCurrent: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredAssessedCurrent,
        { optionalIf: [WIRED] }
      ),
      wiredNominalVoltage: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredNominalVoltage,
        { optionalIf: [WIRED] }
      ),
      wiredMaximumCurrent: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.wiredMaximumCurrent,
        { optionalIf: [WIRED] }
      ),
      wiredPresent: import_ClusterFactory.ClusterFactory.AsConditional(PowerSource2.WiredComponent.attributes.wiredPresent, { optionalIf: [WIRED] }),
      activeWiredFaults: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.attributes.activeWiredFaults,
        { optionalIf: [WIRED] }
      ),
      batVoltage: import_ClusterFactory.ClusterFactory.AsConditional(PowerSource2.BatteryComponent.attributes.batVoltage, { optionalIf: [BAT] }),
      batPercentRemaining: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.batPercentRemaining,
        { optionalIf: [BAT] }
      ),
      batTimeRemaining: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.batTimeRemaining,
        { optionalIf: [BAT] }
      ),
      batChargeLevel: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.batChargeLevel,
        { mandatoryIf: [BAT] }
      ),
      batReplacementNeeded: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.batReplacementNeeded,
        { mandatoryIf: [BAT] }
      ),
      batReplaceability: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.batReplaceability,
        { mandatoryIf: [BAT] }
      ),
      batPresent: import_ClusterFactory.ClusterFactory.AsConditional(PowerSource2.BatteryComponent.attributes.batPresent, { optionalIf: [BAT] }),
      activeBatFaults: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.BatteryComponent.attributes.activeBatFaults,
        { optionalIf: [BAT] }
      ),
      batReplacementDescription: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batReplacementDescription,
        { mandatoryIf: [REPLC] }
      ),
      batCommonDesignation: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batCommonDesignation,
        { optionalIf: [REPLC] }
      ),
      batAnsiDesignation: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batAnsiDesignation,
        { optionalIf: [REPLC] }
      ),
      batIecDesignation: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batIecDesignation,
        { optionalIf: [REPLC] }
      ),
      batApprovedChemistry: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batApprovedChemistry,
        { optionalIf: [REPLC] }
      ),
      batCapacity: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batCapacity,
        { optionalIf: [REPLC] }
      ),
      batQuantity: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.ReplaceableComponent.attributes.batQuantity,
        { mandatoryIf: [REPLC] }
      ),
      batChargeState: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.RechargeableComponent.attributes.batChargeState,
        { mandatoryIf: [RECHG] }
      ),
      batTimeToFullCharge: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.RechargeableComponent.attributes.batTimeToFullCharge,
        { optionalIf: [RECHG] }
      ),
      batFunctionalWhileCharging: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.RechargeableComponent.attributes.batFunctionalWhileCharging,
        { mandatoryIf: [RECHG] }
      ),
      batChargingCurrent: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.RechargeableComponent.attributes.batChargingCurrent,
        { optionalIf: [RECHG] }
      ),
      activeBatChargeFaults: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.RechargeableComponent.attributes.activeBatChargeFaults,
        { optionalIf: [RECHG] }
      )
    },
    events: {
      wiredFaultChange: import_ClusterFactory.ClusterFactory.AsConditional(
        PowerSource2.WiredComponent.events.wiredFaultChange,
        { optionalIf: [WIRED] }
      ),
      batFaultChange: import_ClusterFactory.ClusterFactory.AsConditional(PowerSource2.BatteryComponent.events.batFaultChange, { optionalIf: [BAT] }),
      batChargeFaultChange: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=PowerSourceCluster.js.map
