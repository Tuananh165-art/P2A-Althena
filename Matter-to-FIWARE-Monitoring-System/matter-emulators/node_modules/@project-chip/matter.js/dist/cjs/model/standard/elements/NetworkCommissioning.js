  ...
  children: [
      ...
      children: [
        {
          ...
          default: null,
          quality: "X",
          details: "This field, if present, shall contain the SSID for a directed scan of that particular Wi-Fi SSID. Otherwise, if the field is absent, or it is null, this shall indicate scanning of all BSSID in range. This field shall be ignored for ScanNetworks invocations on non-Wi-Fi server instances.",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "Breadcrumb", id: 2, type: "uint64", conformance: "O" }
      ]
    },
    {
      tag: "command",
      ...
      children: [
        ...
        { tag: "datatype", name: "Breadcrumb", id: 1, type: "uint64", conformance: "O" }
      ]
    },
    {
      tag: "command",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "DebugText", id: 1, type: "string", conformance: "O" },
        {
          tag: "datatype",
          name: "ErrorValue",
          id: 2,
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "NetworkIndex", id: 1, type: "uint8", conformance: "M", constraint: "desc" },
        { tag: "datatype", name: "Breadcrumb", id: 2, type: "uint64", conformance: "O" }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Success", id: 0, conformance: "M", description: "OK, no error" },
        { tag: "datatype", name: "OutOfRange", id: 1, conformance: "M", description: "Value Outside Range" },
        {
          tag: "datatype",
          name: "BoundsExceeded",
          id: 2,
        ...
        { tag: "datatype", name: "UnknownError", id: 12, conformance: "M", description: "Unknown error" }
      ]
    },
    {
      tag: "datatype",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Security", id: 0, type: "WiFiSecurityBitmap", conformance: "WI" },
        { tag: "datatype", name: "Ssid", id: 1, type: "octstr", conformance: "WI", constraint: "max 32" },
        { tag: "datatype", name: "Bssid", id: 2, type: "octstr", conformance: "WI", constraint: "6" },
        { tag: "datatype", name: "Channel", id: 3, type: "uint16", conformance: "WI" },
        {
          tag: "datatype",
          name: "WiFiBand",
          id: 4,
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "ExtendedPanId", id: 1, type: "uint64", conformance: "TH" },
        {
          tag: "datatype",
          name: "NetworkName",
          id: 2,
        ...
        { tag: "datatype", name: "Channel", id: 3, type: "uint16", conformance: "TH" },
        { tag: "datatype", name: "Version", id: 4, type: "uint8", conformance: "TH" },
        {
          tag: "datatype",
        ...
        { tag: "datatype", name: "Rssi", id: 6, type: "int8", conformance: "TH" },
        { tag: "datatype", name: "Lqi", id: 7, type: "uint8", conformance: "TH" }
      ]
    }
  ]
});
