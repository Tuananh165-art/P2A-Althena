...
import { Attribute, OptionalAttribute, OptionalCommand, Event } from "../../cluster/Cluster.js";
...
export declare namespace Actions {
    ...
    const TlvActionStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
         ...
         */
        type: import("../../tlv/TlvObject.js").FieldType<ActionType>;
        /**
         ...
         */
        endpointListId: import("../../tlv/TlvObject.js").FieldType<number>;
        /**
         ...
         */
        supportedCommands: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            /**
             * Indicate support for InstantAction command
             */
            instantAction: BitFlag;
         ...
         */
        state: import("../../tlv/TlvObject.js").FieldType<ActionState>;
    }>;
    /**
     ...
     */
    const TlvEndpointListStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        endpointListId: import("../../tlv/TlvObject.js").FieldType<number>;
        name: import("../../tlv/TlvObject.js").FieldType<string>;
        type: import("../../tlv/TlvObject.js").FieldType<EndpointListType>;
        /**
         * This field shall provide a list of endpoint numbers.
         *
         * @see {@link MatterCoreSpecificationV1_1} § 9.14.4.7.1
         */
        endpoints: import("../../tlv/TlvObject.js").FieldType<import("../../datatype/EndpointNumber.js").EndpointNumber[]>;
    }>;
    /**
     ...
     */
    const TlvInstantActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvInstantActionWithTransitionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
     ...
     */
    const TlvStartActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvStartActionWithDurationRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
     ...
     */
    const TlvStopActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvPauseActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvPauseActionWithDurationRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        duration: import("../../tlv/TlvObject.js").FieldType<number>;
    }>;
     ...
     */
    const TlvResumeActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvEnableActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvEnableActionWithDurationRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        duration: import("../../tlv/TlvObject.js").FieldType<number>;
    }>;
     ...
     */
    const TlvDisableActionRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
    }>;
    /**
     ...
     */
    const TlvDisableActionWithDurationRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        duration: import("../../tlv/TlvObject.js").FieldType<number>;
    }>;
     ...
     */
    const TlvActionFailedEvent: import("../../tlv/TlvObject.js").ObjectSchema<{
        actionId: import("../../tlv/TlvObject.js").FieldType<number>;
        invokeId: import("../../tlv/TlvObject.js").FieldType<number>;
        newState: import("../../tlv/TlvObject.js").FieldType<ActionState>;
        /**
         ...
         */
        error: import("../../tlv/TlvObject.js").FieldType<ActionError>;
    }>;
    /**
     * Actions
     *
    ...
    const Cluster: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly actionList: Attribute<import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This field shall provide an unique identifier used to identify an action.
                 *
                 * @see {@link MatterCoreSpecificationV1_1} § 9.14.4.6.1
             ...
             */
            readonly endpointLists: Attribute<import("../../tlv/TlvObject.js").TypeFromFields<{
                endpointListId: import("../../tlv/TlvObject.js").FieldType<number>;
                name: import("../../tlv/TlvObject.js").FieldType<string>;
                type: import("../../tlv/TlvObject.js").FieldType<EndpointListType>;
                /**
             ...
             */
            readonly setupUrl: OptionalAttribute<string, any>;
        };
        readonly commands: {
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.1
             */
            readonly instantAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.2
             */
            readonly instantActionWithTransition: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
                /**
                 * This field shall indicate the transition time in 1/10th of seconds.
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.3
             */
            readonly startAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.4
             */
            readonly startActionWithDuration: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
                /**
                 * This field shall indicate the requested duration in seconds.
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.5
             */
            readonly stopAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.6
             */
            readonly pauseAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.7
             */
            readonly pauseActionWithDuration: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
                duration: import("../../tlv/TlvObject.js").FieldType<number>;
            }>, void, any>;
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.8
             */
            readonly resumeAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.9
             */
            readonly enableAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.10
             */
            readonly enableActionWithDuration: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
                duration: import("../../tlv/TlvObject.js").FieldType<number>;
            }>, void, any>;
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.11
             */
            readonly disableAction: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
            }>, void, any>;
            /**
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.6.12
             */
            readonly disableActionWithDuration: OptionalCommand<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
                duration: import("../../tlv/TlvObject.js").FieldType<number>;
            }>, void, any>;
        ...
        readonly events: {
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.7.1
             */
            readonly stateChanged: Event<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                /**
                 * This field shall be set to the InvokeID which was provided to the most recent command referencing this
                 * ActionID.
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.7.2
             */
            readonly actionFailed: Event<import("../../tlv/TlvObject.js").TypeFromFields<{
                actionId: import("../../tlv/TlvObject.js").FieldType<number>;
                invokeId: import("../../tlv/TlvObject.js").FieldType<number>;
                newState: import("../../tlv/TlvObject.js").FieldType<ActionState>;
                /**
...
export declare const ActionsCluster: ClusterFactory.Definition<{
    readonly id: 37;
    readonly name: "Actions";
    readonly revision: 1;
    readonly attributes: {
        ...
        readonly actionList: Attribute<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.4.6.3
             */
            type: import("../../tlv/TlvObject.js").FieldType<Actions.ActionType>;
            /**
             * This field shall provide a reference to the associated endpoint list, which specifies the endpoints on this
             * Node which will be impacted by this ActionID.
             *
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.4.6.6
             */
            state: import("../../tlv/TlvObject.js").FieldType<Actions.ActionState>;
        }>[], any>;
        /**
         * The EndpointLists attribute holds the list of endpoint lists. Each entry shall have an unique
         * EndpointListID.
        ...
        readonly endpointLists: Attribute<import("../../tlv/TlvObject.js").TypeFromFields<{
            endpointListId: import("../../tlv/TlvObject.js").FieldType<number>;
            name: import("../../tlv/TlvObject.js").FieldType<string>;
            type: import("../../tlv/TlvObject.js").FieldType<Actions.EndpointListType>;
            /**
             * This field shall provide a list of endpoint numbers.
             *
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.4.7.1
    ...
    readonly events: {
        ...
        readonly stateChanged: Event<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.7.1.2
             */
            newState: import("../../tlv/TlvObject.js").FieldType<Actions.ActionState>;
        }>, any>;
        /**
         * This event shall be generated when there is some error which prevents the action from its normal planned
         * execution and the most recent command using that ActionID used an InvokeID data field.
        ...
        readonly actionFailed: Event<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 9.14.7.2.1
             */
            error: import("../../tlv/TlvObject.js").FieldType<Actions.ActionError>;
        }>, any>;
    };
}>;
//# sourceMappingURL=ActionsCluster.d.ts.map