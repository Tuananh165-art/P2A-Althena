...
export declare const DeviceTypeDefinition: ({ name, code, deviceClass, superSet, revision, requiredServerClusters, optionalServerClusters, requiredClientClusters, optionalClientClusters, unknown, }: {
    ...
    revision: number;
    requiredServerClusters?: ClusterId[] | undefined;
    optionalServerClusters?: ClusterId[] | undefined;
    requiredClientClusters?: ClusterId[] | undefined;
    optionalClientClusters?: ClusterId[] | undefined;
    unknown?: boolean | undefined;
}) => DeviceTypeDefinition;
export declare const DeviceTypes: {
    [key: string]: DeviceTypeDefinition;
};
export declare const UnknownDeviceType: (code: number) => DeviceTypeDefinition;
