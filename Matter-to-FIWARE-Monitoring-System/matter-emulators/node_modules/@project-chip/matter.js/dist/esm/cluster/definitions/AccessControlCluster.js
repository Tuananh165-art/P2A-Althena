...
((AccessControl2) => {
  ...
  AccessControl2.TlvAccessControlTargetStruct = TlvObject({
  ...
  AccessControl2.TlvAccessControlEntryStruct = TlvObject({
    /**
     ...
     */
    targets: TlvField(4, TlvNullable(TlvArray(AccessControl2.TlvAccessControlTargetStruct))),
    fabricIndex: TlvField(254, TlvFabricIndex)
  });
  AccessControl2.TlvAccessControlExtensionStruct = TlvObject({
    /**
  ...
  AccessControl2.TlvAccessControlEntryChangedEvent = TlvObject({
     ...
     */
    latestValue: TlvField(4, TlvNullable(AccessControl2.TlvAccessControlEntryStruct)),
    fabricIndex: TlvField(254, TlvFabricIndex)
  });
  AccessControl2.TlvAccessControlExtensionChangedEvent = TlvObject({
    ...
    adminPasscodeId: TlvField(2, TlvNullable(TlvUInt16)),
    changeType: TlvField(3, TlvEnum()),
    latestValue: TlvField(4, TlvNullable(AccessControl2.TlvAccessControlExtensionStruct)),
    fabricIndex: TlvField(254, TlvFabricIndex)
  });
  AccessControl2.Cluster = ClusterFactory.Definition({
    id: 31,
    name: "AccessControl",
    revision: 1,
    attributes: {
      ...
      acl: WritableFabricScopedAttribute(
        0,
        TlvArray(AccessControl2.TlvAccessControlEntryStruct),
      ...
      extension: OptionalWritableFabricScopedAttribute(
        1,
        TlvArray(AccessControl2.TlvAccessControlExtensionStruct),
        { default: [], readAcl: AccessLevel.Administer, writeAcl: AccessLevel.Administer }
      ),
      /**
