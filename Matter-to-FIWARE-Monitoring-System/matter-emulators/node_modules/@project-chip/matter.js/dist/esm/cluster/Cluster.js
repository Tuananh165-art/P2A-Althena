...
var AccessLevel = /* @__PURE__ */ ((AccessLevel2) => {
  AccessLevel2[AccessLevel2["View"] = 0] = "View";
  AccessLevel2[AccessLevel2["Operate"] = 1] = "Operate";
  AccessLevel2[AccessLevel2["Manage"] = 2] = "Manage";
  AccessLevel2[AccessLevel2["Administer"] = 3] = "Administer";
  return AccessLevel2;
})(AccessLevel || {});
...
const Command = (requestId, requestSchema, responseId, responseSchema, { invokeAcl = 1 /* Operate */, timed = false } = {}) => ({
  optional: false,
...
const OptionalCommand = (requestId, requestSchema, responseId, responseSchema, { invokeAcl = 1 /* Operate */, timed = false } = {}) => ({
  optional: true,
  requestId: CommandId(requestId),
  requestSchema,
  responseId: CommandId(responseId),
...
const Event = (id, priority, schema, { readAcl = 0 /* View */ } = {}) => ({
  id: EventId(id),
  schema,
  priority,
  optional: false,
...
const OptionalEvent = (id, priority, schema, { readAcl = 0 /* View */ } = {}) => ({
  id: EventId(id),
  schema,
  priority,
  optional: true,
...
const ConditionalEvent = (id, priority, schema, { readAcl = 0 /* View */, optionalIf = [], mandatoryIf = [] }) => ({
  id: EventId(id),
  schema,
  priority,
  optional: true,
...
const GlobalAttributes = (features) => ({
  ...
  eventList: Attribute(65530, TlvArray(TlvEventId)),
