...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "None", id: 0, conformance: "M", description: "No presentation." },
        {
          tag: "datatype",
          name: "LightOutput",
          id: 1,
        ...
        { tag: "datatype", name: "AudibleBeep", id: 3, conformance: "M" },
        {
          tag: "datatype",
          name: "Display",
          id: 4,
    ...
    },
    {
      ...
      children: [{ tag: "datatype", name: "IdentifyTime", id: 0, type: "uint16", conformance: "M" }]
    },
    {
      tag: "command",
      name: "IdentifyQuery",
      ...
      children: [
        {
          ...
          conformance: "M",
          constraint: "desc",
          details: "This field specifies the identify effect to use. All values of the EffectIdentifier shall be supported. Implementors may deviate from the example light effects in the table below, but they SHOULD indicate during testing how they handle each effect.\nThis field shall contain one of the non-reserved values listed below.\nTable 3. Values of the EffectIdentifier Field of the TriggerEffect Command",
        ...
        },
        {
          ...
          conformance: "M",
          constraint: "desc",
          details: "This field is used to indicate which variant of the effect, indicated in the EffectIdentifier field, SHOULD be triggered. If a device does not support the given variant, it shall use the default variant. This field shall contain one of the values listed below:\nTable 4. Values of the EffectVariant Field of the TriggerEffect Command",
          xref: { document: "cluster", section: "1.2.6.3.2" },
          children: [{ tag: "datatype", name: "Default", id: 0, conformance: "M" }]
        }
      ]
    },
    {
      ...
      children: [{
        ...
        type: "uint16",
        conformance: "M",
        details: "This field contains the current value of the IdentifyTime attribute, and specifies the length of time, in seconds, that the device will continue to identify itself.",
