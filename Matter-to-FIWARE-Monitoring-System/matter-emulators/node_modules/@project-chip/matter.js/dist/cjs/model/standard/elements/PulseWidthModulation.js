...
import_Matter.Matter.children.push({
  ...
  children: [
    { tag: "attribute", name: "ClusterRevision", id: 65533, type: "ClusterRevision", default: 5 },
    {
      ...
      children: [
        ...
        },
        {
          ...
          details: "Supports frequency attributes and behavior. The Pulse Width Modulation cluster was created for frequency control."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Level", id: 0, type: "uint8", conformance: "M", constraint: "0 to 254" },
        { tag: "datatype", name: "TransitionTime", id: 1, type: "uint16", conformance: "M", quality: "X" },
        {
          tag: "datatype",
          name: "OptionsMask",
          id: 2,
      ...
      children: [
        {
          ...
          children: [{ tag: "datatype", name: "Up", id: 0 }, { tag: "datatype", name: "Down", id: 1 }]
        },
        {
          tag: "datatype",
          name: "Rate",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "StepMode", id: 0, type: "enum8", conformance: "M", constraint: "desc" },
        { tag: "datatype", name: "StepSize", id: 1, type: "uint8", conformance: "M" },
        { tag: "datatype", name: "TransitionTime", id: 2, type: "uint16", conformance: "M", quality: "X" },
        {
          tag: "datatype",
          name: "OptionsMask",
          id: 3,
    ...
    },
    {
      ...
      children: [{ tag: "datatype", name: "Frequency", id: 0, type: "uint16", conformance: "M", default: 0 }]
    }
  ]
});
//# sourceMappingURL=PulseWidthModulation.js.map
