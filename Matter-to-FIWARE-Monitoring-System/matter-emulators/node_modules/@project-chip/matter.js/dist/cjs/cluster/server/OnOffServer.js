...
var import_OnOffCluster = require("../definitions/OnOffCluster.js");
...
const OnOffClusterDefaultHandler = () => {
  ...
  const getTimedOnTimer = (onTime, onOff) => {
    if (timedOnTimer === void 0) {
      timedOnTimer = import_Time.Time.getPeriodicTimer(100, () => {
  ...
  const getDelayedOffTimer = (offWaitTime) => {
    if (delayedOffTimer === void 0) {
      delayedOffTimer = import_Time.Time.getTimer(100, () => {
  ...
  return {
    initializeClusterServer: ({ attributes: { onOff, startUpOnOff } }) => {
      ...
      if (startUpOnOffValue !== null) {
        ...
        const targetOnOffValue = startUpOnOffValue === import_OnOffCluster.OnOff.StartUpOnOff.Toggle ? !currentOnOffStatus : startUpOnOffValue === import_OnOffCluster.OnOff.StartUpOnOff.On;
    ...
    offWithEffect: async () => {
      throw new import_MatterError.NotImplementedError("Not implemented");
    },
    ...
    onWithTimedOff: async ({
      ...
      if (onTime === void 0 || offWaitTime === void 0)
        return;
...
const createDefaultOnOffClusterServer = (commandHandler, attributeInitialValues, isLighting = false) => {
  const cluster = isLighting ? import_OnOffCluster.OnOff.Cluster.with(import_OnOffCluster.OnOff.Feature.LevelControlForLighting) : import_OnOffCluster.OnOff.Cluster;
  return (0, import_ClusterServer.ClusterServer)(
    cluster,
    attributeInitialValues ?? {
      onOff: false,
      globalSceneControl: isLighting ? false : void 0,
      onTime: isLighting ? null : void 0,
      offWaitTime: isLighting ? null : void 0,
      startUpOnOff: isLighting ? null : void 0
    },
