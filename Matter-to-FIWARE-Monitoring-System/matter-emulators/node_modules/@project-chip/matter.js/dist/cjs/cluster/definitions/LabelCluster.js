...
var LabelCluster_exports = {};
__export(LabelCluster_exports, {
  Label: () => Label
});
module.exports = __toCommonJS(LabelCluster_exports);
...
((Label2) => {
  ...
  Label2.Base = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      labelList: (0, import_Cluster.Attribute)(0, (0, import_TlvArray.TlvArray)(Label2.TlvLabelStruct), { default: [] })
    }
  });
})(Label || (Label = {}));
//# sourceMappingURL=LabelCluster.js.map
