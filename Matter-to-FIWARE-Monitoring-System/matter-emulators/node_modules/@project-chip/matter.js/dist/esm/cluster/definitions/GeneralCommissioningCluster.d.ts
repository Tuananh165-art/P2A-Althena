...
export declare const GeneralCommissioningCluster: ClusterFactory.Definition<{
    readonly id: 48;
    readonly name: "GeneralCommissioning";
    readonly revision: 1;
    readonly attributes: {
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.9.5.3
         */
        readonly regulatoryConfig: Attribute<GeneralCommissioning.RegulatoryLocationType, any>;
        /**
         * LocationCapability is statically set by the manufacturer and indicates if this Node needs to be told an
         * exact RegulatoryLocation. For example a Node which is "Indoor Only" would not be certified for outdoor
         * use at all, and thus there is no need for a commissioner to set or ask the user about whether the device
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.9.5.4
         */
        readonly locationCapability: FixedAttribute<GeneralCommissioning.RegulatoryLocationType, any>;
        /**
         * This attribute shall indicate whether this device supports "concurrent connection flow" commissioning
         * mode (see Section 5.5, “Commissioning Flows”). If false, the device only supports "non-concurrent
         * connection flow" mode.
    ...
    readonly commands: {
         ...
         */
        readonly setRegulatoryConfig: Command<import("../../tlv/TlvObject.js").TypeFromFields<{
            newRegulatoryConfig: import("../../tlv/TlvObject.js").FieldType<GeneralCommissioning.RegulatoryLocationType>;
            countryCode: import("../../tlv/TlvObject.js").FieldType<string>;
            breadcrumb: import("../../tlv/TlvObject.js").FieldType<number | bigint>;
        }>, import("../../tlv/TlvObject.js").TypeFromFields<{
            errorCode: import("../../tlv/TlvObject.js").FieldType<GeneralCommissioning.CommissioningError>;
...
//# sourceMappingURL=GeneralCommissioningCluster.d.ts.map