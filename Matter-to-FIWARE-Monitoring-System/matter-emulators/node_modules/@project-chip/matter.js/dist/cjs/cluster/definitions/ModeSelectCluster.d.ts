...
import { FixedAttribute, Attribute, OptionalWritableAttribute, Command, WritableAttribute } from "../../cluster/Cluster.js";
export declare namespace ModeSelect {
     ...
     */
    const TlvSemanticTagStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     */
    const TlvModeOptionStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     */
    const OnOffComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<80 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "ModeSelect";
        revision: 1;
        features: {
            /**
        ...
        readonly with: <T extends "OnOff"[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * OnOff
             *
             * Dependency with the On/Off cluster
    ...
    const Complete: ClusterFactory.Definition<{
        readonly id: 80 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "ModeSelect";
        readonly revision: 1;
        readonly features: {
            /**
...
export declare const ModeSelectCluster: {
    id: import("../../util/Type.js").Branded<80 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "ModeSelect";
    revision: 1;
    features: {
    ...
    readonly with: <T extends "OnOff"[]>(...features_0: T) => ModeSelect.Extension<BitFlags<{
        /**
         * OnOff
         *
         * Dependency with the On/Off cluster
...
//# sourceMappingURL=ModeSelectCluster.d.ts.map