...
((GeneralCommissioning2) => {
  GeneralCommissioning2.TlvBasicCommissioningInfo = TlvObject({
    /**
  ...
  GeneralCommissioning2.TlvArmFailSafeRequest = TlvObject({
  ...
  GeneralCommissioning2.TlvArmFailSafeResponse = TlvObject({
    /**
  ...
  GeneralCommissioning2.TlvSetRegulatoryConfigRequest = TlvObject({
    newRegulatoryConfig: TlvField(0, TlvEnum()),
    countryCode: TlvField(1, TlvString.bound({ length: 2 })),
    breadcrumb: TlvField(2, TlvUInt64)
  });
  GeneralCommissioning2.TlvSetRegulatoryConfigResponse = TlvObject({
    errorCode: TlvField(0, TlvEnum()),
    debugText: TlvField(1, TlvString)
  });
  GeneralCommissioning2.TlvCommissioningCompleteResponse = TlvObject({
    errorCode: TlvField(0, TlvEnum()),
    debugText: TlvField(1, TlvString)
  });
  GeneralCommissioning2.Cluster = ClusterFactory.Definition({
    id: 48,
    ...
    attributes: {
       ...
       */
      basicCommissioningInfo: FixedAttribute(1, GeneralCommissioning2.TlvBasicCommissioningInfo),
      /**
...
//# sourceMappingURL=GeneralCommissioningCluster.js.map
