...
const CASE2_ENCRYPTED_LENGTH = 800 + CRYPTO_AEAD_MIC_LENGTH_BYTES + CASE_SIGNATURE_LENGTH;
const KDFSR1_KEY_INFO = ByteArray.fromString("Sigma1_Resume");
const KDFSR2_KEY_INFO = ByteArray.fromString("Sigma2_Resume");
const RESUME1_MIC_NONCE = ByteArray.fromString("NCASE_SigmaS1");
const RESUME2_MIC_NONCE = ByteArray.fromString("NCASE_SigmaS2");
const KDFSR2_INFO = ByteArray.fromString("Sigma2");
const KDFSR3_INFO = ByteArray.fromString("Sigma3");
const TBE_DATA2_NONCE = ByteArray.fromString("NCASE_Sigma2N");
const TBE_DATA3_NONCE = ByteArray.fromString("NCASE_Sigma3N");
