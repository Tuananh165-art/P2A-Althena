...
((WiFiNetworkDiagnostics2) => {
  ...
  WiFiNetworkDiagnostics2.Base = ClusterFactory.Definition({
    id: 54,
  ...
  WiFiNetworkDiagnostics2.ErrorCountsComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  WiFiNetworkDiagnostics2.PacketCountsComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  WiFiNetworkDiagnostics2.Cluster = ClusterFactory.Extensible(
    WiFiNetworkDiagnostics2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...WiFiNetworkDiagnostics2.Base,
        supportedFeatures: BitFlags(WiFiNetworkDiagnostics2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, WiFiNetworkDiagnostics2.ErrorCountsComponent, { errorCounts: true });
      ClusterFactory.extend(cluster, WiFiNetworkDiagnostics2.PacketCountsComponent, { packetCounts: true });
      return cluster;
    }
  );
  const ERRCNT = { errorCounts: true };
  const PKTCNT = { packetCounts: true };
  WiFiNetworkDiagnostics2.Complete = ClusterFactory.Definition({
...
//# sourceMappingURL=WiFiNetworkDiagnosticsCluster.js.map
