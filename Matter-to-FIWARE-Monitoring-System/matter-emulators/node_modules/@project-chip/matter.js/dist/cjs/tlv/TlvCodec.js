...
class TlvCodec {
  static getUIntTlvLength(value) {
    if (value <= import_Number.UINT8_MAX) {
      return 0 /* OneByte */;
    } else if (value <= import_Number.UINT16_MAX) {
      return 1 /* TwoBytes */;
    } else if (value <= import_Number.UINT32_MAX) {
      return 2 /* FourBytes */;
    } else {
      return 3 /* EightBytes */;
    }
  ...
  static getIntTlvLength(value) {
    if (value > 0) {
      if (value <= import_Number.INT8_MAX) {
        return 0 /* OneByte */;
      } else if (value <= import_Number.INT16_MAX) {
        return 1 /* TwoBytes */;
      } else if (value <= import_Number.INT32_MAX) {
        return 2 /* FourBytes */;
      } else {
        return 3 /* EightBytes */;
      }
    } else {
      if (value >= import_Number.INT8_MIN) {
        return 0 /* OneByte */;
      } else if (value >= import_Number.INT16_MIN) {
        return 1 /* TwoBytes */;
      } else if (value >= import_Number.INT32_MIN) {
        return 2 /* FourBytes */;
      } else {
        return 3 /* EightBytes */;
      }
  ...
  static readTag(reader, tagControl) {
    switch (tagControl) {
      ...
      case 5 /* ImplicitProfile32 */:
        throw new import_MatterError.NotImplementedError(`Unsupported implicit profile ${tagControl}`);
      case 6 /* FullyQualified48 */:
        return { profile: reader.readUInt32(), id: reader.readUInt16() };
      default:
        throw new import_MatterError.NotImplementedError(`Unexpected tagControl ${tagControl}`);
    }
  }
      ...
      case 8 /* Boolean */:
        switch (length) {
          ...
          case 3 /* EightBytes */:
            return { type: 10 /* Float */, length };
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected Boolean length ${length}`);
        }
      default:
    ...
    switch (typeLength.type) {
      case 0 /* SignedInt */: {
        ...
        switch (length) {
          ...
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected SignedInt length ${length}`);
        }
      }
      case 4 /* UnsignedInt */: {
        const length = typeLength.length;
        switch (length) {
          ...
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected UnsignedInt length ${length}`);
        }
      }
      case 10 /* Float */: {
        const length = typeLength.length;
        switch (length) {
          ...
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected Float length ${length}`);
        }
      }
      case 12 /* Utf8String */: {
        const length = typeLength.length;
        switch (length) {
          ...
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected Utf8String length ${length}`);
        }
      }
      case 16 /* ByteString */: {
        const length = typeLength.length;
        switch (length) {
          ...
          default:
            throw new import_MatterError.UnexpectedDataError(`Unexpected ByteString length ${length}`);
        }
      }
      case 8 /* Boolean */:
      ...
      case 20 /* Null */:
        return null;
      default:
        throw new import_MatterError.UnexpectedDataError(`Unexpected TLV type ${typeLength.type}`);
    }
  }
  ...
  static writeTag(writer, typeLengthValue, tag) {
    ...
    if (profile === void 0 && id === void 0) {
      ...
      if (id === void 0)
        throw new import_MatterError.UnexpectedDataError("Invalid TLV tag: id should be defined for a context specific tag.");
      ...
      if (id === void 0)
        throw new import_MatterError.UnexpectedDataError("Invalid TLV tag: id should be defined for a datatype profile.");
      if ((id & 4294901760) === 0) {
      ...
      if (id === void 0)
        throw new import_MatterError.UnexpectedDataError("Invalid TLV tag: id should be defined for a custom profile.");
      if ((id & 4294901760) === 0) {
  ...
  static writePrimitive(writer, typeLength, value) {
    switch (typeLength.type) {
      ...
      case 12 /* Utf8String */: {
        const string = value;
        const stringData = import_ByteArray.ByteArray.fromString(string);
