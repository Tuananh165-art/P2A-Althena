...
import { Attribute, OptionalAttribute, OptionalEvent, Command } from "../../cluster/Cluster.js";
export declare namespace ThreadNetworkDiagnostics {
     ...
     */
    const TlvNeighborTableStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
         ...
         */
        frameErrorRate: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
         ...
         */
        messageErrorRate: import("../../tlv/TlvObject.js").OptionalFieldType<number>;
        /**
     ...
     */
    const TlvRouteTableStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        extAddress: import("../../tlv/TlvObject.js").FieldType<number | bigint>;
        rloc16: import("../../tlv/TlvObject.js").FieldType<number>;
        /**
    ...
    const Base: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly activeNetworkFaults: Attribute<NetworkFault[], any>;
        };
        readonly events: {
            /**
     ...
     */
    const ErrorCountsComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const MleCountsComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const MacCountsComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
             ...
             */
            readonly rxErrInvalidScrAddrCount: OptionalAttribute<number, any>;
            /**
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<53 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        ...
        readonly with: <T extends ("PacketCounts" | "ErrorCounts" | "MleCounts" | "MacCounts")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * PacketCounts
             *
             * Server supports the counts for the number of received and transmitted packets on the Thread interface.
    ...
    type Extension<SF extends TypeFromPartialBitSchema<typeof Base.features>> = Omit<typeof Base, "supportedFeatures"> & {
        ...
        errorCounts: true;
    } ? typeof ErrorCountsComponent : {}) & (SF extends {
        mleCounts: true;
    } ? typeof MleCountsComponent : {}) & (SF extends {
        macCounts: true;
    } ? typeof MacCountsComponent : {});
    /**
    ...
    const Complete: ClusterFactory.Definition<{
        readonly id: 53 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "ThreadNetworkDiagnostics";
        readonly revision: 1;
        readonly features: {
            /**
...
export declare const ThreadNetworkDiagnosticsCluster: {
    id: import("../../util/Type.js").Branded<53 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "ThreadNetworkDiagnostics";
    revision: 1;
    features: {
    ...
    attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.13.6.2
         */
        readonly routingRole: Attribute<ThreadNetworkDiagnostics.RoutingRole | null, any>;
        /**
         * The NetworkName attribute shall indicate a human-readable (displayable) name for the Thread network that
         * the Node has been configured to join to. A value of null shall indicate that the Thread interface is not
         * currently configured or operational.
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.13.6.63
         */
        readonly activeNetworkFaults: Attribute<ThreadNetworkDiagnostics.NetworkFault[], any>;
    }, import("../../cluster/Cluster.js").GlobalAttributes<{
        /**
         * PacketCounts
         *
    ...
    events: {
         ...
         */
        readonly connectionStatus: OptionalEvent<import("../../tlv/TlvObject.js").TypeFromFields<{
            connectionStatus: import("../../tlv/TlvObject.js").FieldType<ThreadNetworkDiagnostics.ConnectionStatus>;
        }>, any>;
        /**
         * The NetworkFaultChange Event shall indicate a change in the set of network faults currently detected by
         * the Node.
        ...
        readonly networkFaultChange: OptionalEvent<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 11.13.8.1.1
             */
            current: import("../../tlv/TlvObject.js").FieldType<ThreadNetworkDiagnostics.NetworkFault[]>;
            /**
             * This field shall represent the set of faults detected prior to this change event, as per Section 11.13.5.1,
             * “NetworkFaultEnum”.
             *
             * @see {@link MatterCoreSpecificationV1_1} § 11.13.8.1.2
             */
            previous: import("../../tlv/TlvObject.js").FieldType<ThreadNetworkDiagnostics.NetworkFault[]>;
        }>, any>;
    };
    unknown: false;
} & Omit<ClusterFactory.Definition<{
    ...
    readonly with: <T extends ("PacketCounts" | "ErrorCounts" | "MleCounts" | "MacCounts")[]>(...features_0: T) => ThreadNetworkDiagnostics.Extension<BitFlags<{
        /**
         * PacketCounts
         *
         * Server supports the counts for the number of received and transmitted packets on the Thread interface.
...
//# sourceMappingURL=ThreadNetworkDiagnosticsCluster.d.ts.map