...
var MediaPlaybackCluster_exports = {};
__export(MediaPlaybackCluster_exports, {
  MediaPlayback: () => MediaPlayback,
  MediaPlaybackCluster: () => MediaPlaybackCluster
});
module.exports = __toCommonJS(MediaPlaybackCluster_exports);
...
((MediaPlayback2) => {
  ...
  MediaPlayback2.TlvPlaybackResponse = (0, import_TlvObject.TlvObject)({
    /**
  ...
  MediaPlayback2.TlvSkipForwardRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    deltaPositionMilliseconds: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt64)
  });
  MediaPlayback2.TlvSkipBackwardRequest = (0, import_TlvObject.TlvObject)({
    /**
  ...
  MediaPlayback2.TlvPlaybackPositionStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    updatedAt: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvEpochUs),
    /**
     ...
     */
    position: (0, import_TlvObject.TlvField)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64))
  });
  MediaPlayback2.TlvSeekRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    position: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt64)
  });
  let Feature;
  ((Feature2) => {
  ...
  MediaPlayback2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 1286,
    name: "MediaPlayback",
    revision: 1,
    features: {
       ...
       */
      advancedSeek: (0, import_BitmapSchema.BitFlag)(0),
      /**
       * VariableSpeed
       *
       * Support for commands to support variable speed playback on media that supports it.
       */
      variableSpeed: (0, import_BitmapSchema.BitFlag)(1)
    },
    attributes: {
      /**
       ...
       */
      currentState: (0, import_Cluster.Attribute)(0, (0, import_TlvNumber.TlvEnum)(), { default: 0 /* Playing */ })
    },
    commands: {
      /**
       ...
       */
      play: (0, import_Cluster.Command)(0, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       * Upon receipt, this shall pause playback of the media.
       *
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.2
       */
      pause: (0, import_Cluster.Command)(1, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      stop: (0, import_Cluster.Command)(2, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       * Upon receipt, this shall Start Over with the current media playback item.
       *
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.4
       */
      startOver: (0, import_Cluster.OptionalCommand)(3, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      previous: (0, import_Cluster.OptionalCommand)(4, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      next: (0, import_Cluster.OptionalCommand)(5, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      skipForward: (0, import_Cluster.OptionalCommand)(8, MediaPlayback2.TlvSkipForwardRequest, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      skipBackward: (0, import_Cluster.OptionalCommand)(9, MediaPlayback2.TlvSkipBackwardRequest, 10, MediaPlayback2.TlvPlaybackResponse)
    }
  });
  MediaPlayback2.AdvancedSeekComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      startTime: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvEpochUs), { default: null }),
      /**
       ...
       */
      duration: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { default: null }),
      /**
       ...
       */
      sampledPosition: (0, import_Cluster.Attribute)(3, (0, import_TlvNullable.TlvNullable)(MediaPlayback2.TlvPlaybackPositionStruct), { default: null }),
      /**
       ...
       */
      seekRangeEnd: (0, import_Cluster.Attribute)(5, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { default: null }),
      /**
       ...
       */
      seekRangeStart: (0, import_Cluster.Attribute)(6, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt64), { default: null })
    },
    commands: {
      /**
       ...
       */
      seek: (0, import_Cluster.Command)(11, MediaPlayback2.TlvSeekRequest, 10, MediaPlayback2.TlvPlaybackResponse)
    }
  });
  MediaPlayback2.VariableSpeedComponent = import_ClusterFactory.ClusterFactory.Component({
    commands: {
      /**
       ...
       */
      rewind: (0, import_Cluster.Command)(6, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse),
      /**
       ...
       */
      fastForward: (0, import_Cluster.Command)(7, import_TlvNoArguments.TlvNoArguments, 10, MediaPlayback2.TlvPlaybackResponse)
    }
  });
  MediaPlayback2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    MediaPlayback2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...MediaPlayback2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(MediaPlayback2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, MediaPlayback2.AdvancedSeekComponent, { advancedSeek: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, MediaPlayback2.VariableSpeedComponent, { variableSpeed: true });
      return cluster;
    }
  );
  const AS = { advancedSeek: true };
  const VS = { variableSpeed: true };
  MediaPlayback2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    attributes: {
      ...
      startTime: import_ClusterFactory.ClusterFactory.AsConditional(MediaPlayback2.AdvancedSeekComponent.attributes.startTime, { mandatoryIf: [AS] }),
      duration: import_ClusterFactory.ClusterFactory.AsConditional(MediaPlayback2.AdvancedSeekComponent.attributes.duration, { mandatoryIf: [AS] }),
      sampledPosition: import_ClusterFactory.ClusterFactory.AsConditional(
        MediaPlayback2.AdvancedSeekComponent.attributes.sampledPosition,
        { mandatoryIf: [AS] }
      ),
      playbackSpeed: import_ClusterFactory.ClusterFactory.AsConditional(
        MediaPlayback2.AdvancedSeekComponent.attributes.playbackSpeed,
        { mandatoryIf: [AS] }
      ),
      seekRangeEnd: import_ClusterFactory.ClusterFactory.AsConditional(
        MediaPlayback2.AdvancedSeekComponent.attributes.seekRangeEnd,
        { mandatoryIf: [AS] }
      ),
      seekRangeStart: import_ClusterFactory.ClusterFactory.AsConditional(
    ...
    commands: {
      ...
      rewind: import_ClusterFactory.ClusterFactory.AsConditional(MediaPlayback2.VariableSpeedComponent.commands.rewind, { mandatoryIf: [VS] }),
      fastForward: import_ClusterFactory.ClusterFactory.AsConditional(
        MediaPlayback2.VariableSpeedComponent.commands.fastForward,
        { mandatoryIf: [VS] }
      ),
      seek: import_ClusterFactory.ClusterFactory.AsConditional(MediaPlayback2.AdvancedSeekComponent.commands.seek, { mandatoryIf: [AS] })
    }
  });
})(MediaPlayback || (MediaPlayback = {}));
const MediaPlaybackCluster = MediaPlayback.Cluster;
//# sourceMappingURL=MediaPlaybackCluster.js.map
