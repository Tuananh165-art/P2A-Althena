...
var LevelControl;
((LevelControl2) => {
  LevelControl2.Options = { executeIfOff: BitFlag(0), coupleColorTempToLevel: BitFlag(1) };
  LevelControl2.TlvMoveToLevelRequest = TlvObject({
    level: TlvField(0, TlvUInt8.bound({ max: 254 })),
    transitionTime: TlvField(1, TlvNullable(TlvUInt16)),
    optionsMask: TlvField(2, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(3, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  let MoveMode;
  ((MoveMode2) => {
  ...
  LevelControl2.TlvMoveRequest = TlvObject({
    /**
  ...
  LevelControl2.TlvStepRequest = TlvObject({
    stepMode: TlvField(0, TlvEnum()),
    stepSize: TlvField(1, TlvUInt8),
    transitionTime: TlvField(2, TlvNullable(TlvUInt16)),
    optionsMask: TlvField(3, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(4, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvStopRequest = TlvObject({
    optionsMask: TlvField(0, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(1, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvMoveToLevelWithOnOffRequest = TlvObject({
    level: TlvField(0, TlvUInt8),
    transitionTime: TlvField(1, TlvNullable(TlvUInt16)),
    optionsMask: TlvField(2, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(3, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvMoveWithOnOffRequest = TlvObject({
    moveMode: TlvField(0, TlvEnum()),
    rate: TlvField(1, TlvNullable(TlvUInt8)),
    optionsMask: TlvField(2, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(3, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvStepWithOnOffRequest = TlvObject({
    stepMode: TlvField(0, TlvEnum()),
    stepSize: TlvField(1, TlvUInt8),
    transitionTime: TlvField(2, TlvNullable(TlvUInt16)),
    optionsMask: TlvField(3, TlvBitmap(TlvUInt8, LevelControl2.Options)),
  ...
  LevelControl2.TlvStopWithOnOffRequest = TlvObject({
    optionsMask: TlvField(0, TlvBitmap(TlvUInt8, LevelControl2.Options)),
    optionsOverride: TlvField(1, TlvBitmap(TlvUInt8, LevelControl2.Options))
  });
  LevelControl2.TlvMoveToClosestFrequencyRequest = TlvObject({ frequency: TlvField(0, TlvUInt16) });
  let Feature;
  ((Feature2) => {
  ...
  LevelControl2.Base = ClusterFactory.Definition({
    id: 8,
    name: "LevelControl",
    revision: 5,
    features: {
    ...
    attributes: {
       ...
       */
      options: WritableAttribute(15, TlvBitmap(TlvUInt8, LevelControl2.Options)),
      /**
       ...
       */
      onLevel: WritableAttribute(17, TlvNullable(TlvUInt8.bound({ max: 254 })), { default: null }),
      /**
    ...
    commands: {
       ...
       */
      moveToLevel: Command(0, LevelControl2.TlvMoveToLevelRequest, 0, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6.2
       */
      move: Command(1, LevelControl2.TlvMoveRequest, 1, TlvNoResponse),
      /**
       ...
       */
      step: Command(2, LevelControl2.TlvStepRequest, 2, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6.4
       */
      stop: Command(3, LevelControl2.TlvStopRequest, 3, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      moveToLevelWithOnOff: Command(4, LevelControl2.TlvMoveToLevelWithOnOffRequest, 4, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      moveWithOnOff: Command(5, LevelControl2.TlvMoveWithOnOffRequest, 5, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      stepWithOnOff: Command(6, LevelControl2.TlvStepWithOnOffRequest, 6, TlvNoResponse),
      /**
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
       */
      stopWithOnOff: Command(7, LevelControl2.TlvStopWithOnOffRequest, 7, TlvNoResponse)
    }
  });
  LevelControl2.LightingComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  LevelControl2.FrequencyComponent = ClusterFactory.Component({
    attributes: {
      /**
    ...
    commands: {
       ...
       */
      moveToClosestFrequency: Command(8, LevelControl2.TlvMoveToClosestFrequencyRequest, 8, TlvNoResponse)
    }
  });
  LevelControl2.Cluster = ClusterFactory.Extensible(
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...LevelControl2.Base,
        supportedFeatures: BitFlags(LevelControl2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, LevelControl2.LightingComponent, { lighting: true });
      ClusterFactory.extend(cluster, LevelControl2.FrequencyComponent, { frequency: true });
      return cluster;
    }
  );
  const LT = { lighting: true };
  const FQ = { frequency: true };
  LevelControl2.Complete = ClusterFactory.Definition({
