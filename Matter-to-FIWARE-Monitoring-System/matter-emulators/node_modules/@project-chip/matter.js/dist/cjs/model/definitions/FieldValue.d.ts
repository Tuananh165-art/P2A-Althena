 ...
 */
export type FieldValue = null | string | number | bigint | boolean | Date | [] | FieldValue.Properties | FieldValue.Reference | FieldValue.Percent | FieldValue.Celsius;
export declare namespace FieldValue {
     ...
     */
    type Type = percent | celsius | reference | properties;
    /**
     ...
     */
    function serialize(value: FieldValue): string | undefined;
    /**
     ...
     */
    function unwrap(value: FieldValue | undefined, typeName?: string): string | number | bigint | boolean | Date | [] | {
        [name: string]: FieldValue;
    } | null | undefined;
    /**
