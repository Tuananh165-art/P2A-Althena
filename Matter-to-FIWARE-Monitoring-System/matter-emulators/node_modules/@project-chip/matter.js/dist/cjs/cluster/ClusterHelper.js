...
var ClusterHelper_exports = {};
__export(ClusterHelper_exports, {
  AllClustersMap: () => AllClustersMap,
  UnknownCluster: () => UnknownCluster,
  getClusterAttributeById: () => getClusterAttributeById,
  getClusterById: () => getClusterById,
  getClusterCommandById: () => getClusterCommandById,
  getClusterEventById: () => getClusterEventById,
  getClusterNameById: () => getClusterNameById,
  resolveAttributeName: () => resolveAttributeName,
  resolveCommandName: () => resolveCommandName,
  resolveEventName: () => resolveEventName
});
module.exports = __toCommonJS(ClusterHelper_exports);
var import_Logger = require("../log/Logger.js");
var import_Number = require("../util/Number.js");
var import_Cluster = require("./Cluster.js");
var Clusters = __toESM(require("./definitions/index.js"), 1);
/**
 * @license
 * Copyright 2022 The node-matter Authors
 * SPDX-License-Identifier: Apache-2.0
 */
const logger = import_Logger.Logger.get("ClusterHelper");
const AllClustersMap = {
...
const UnknownCluster = (clusterId) => (0, import_Cluster.Cluster)({
  id: clusterId,
...
function getClusterNameById(clusterId) {
  return AllClustersMap[clusterId]?.name ?? `Unknown cluster ${(0, import_Number.toHexString)(clusterId)}`;
}
function getClusterById(clusterId) {
  if (AllClustersMap[clusterId] === void 0) {
...
function resolveEventName({ nodeId, endpointId, clusterId, eventId }) {
  const endpointClusterName = resolveEndpointClusterName(nodeId, endpointId, clusterId);
