...
declare const DimmableBaseDevice_base: new (definition: DeviceTypeDefinition, attributeInitialValues?: {
    ...
    removeCommandHandler<K_1 extends keyof DimmableDeviceCommands>(action: K_1, handler: DimmableDeviceCommands[K_1]): void;
    _executeHandler<K_2 extends keyof DimmableDeviceCommands>(action: K_2, ...args: Parameters<DimmableDeviceCommands[K_2]>): Promise<void>;
};
