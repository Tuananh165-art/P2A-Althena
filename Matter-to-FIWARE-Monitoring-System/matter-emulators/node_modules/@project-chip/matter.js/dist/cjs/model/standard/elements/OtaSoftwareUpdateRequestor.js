...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      conformance: "M",
      default: 0,
      details: "This field shall reflect the current state of the OTA Requestor with regards to obtaining software updates. See Section 11.19.7.4.2, \u201CUpdateStateEnum\u201D for possible values.\nThis field SHOULD be updated in a timely manner whenever OTA Requestor internal state updates.",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "NewState", id: 1, type: "UpdateStateEnum", conformance: "M" },
        { tag: "datatype", name: "Reason", id: 2, type: "ChangeReasonEnum", conformance: "M" },
        {
          tag: "datatype",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "SoftwareVersion", id: 0, type: "uint32", conformance: "M" },
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "SoftwareVersion", id: 0, type: "uint32", conformance: "M" },
        { tag: "datatype", name: "BytesDownloaded", id: 1, type: "uint64", conformance: "M" },
        {
          tag: "datatype",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "ProviderNodeId", id: 0, type: "node-id", access: "F", conformance: "M" },
        { tag: "datatype", name: "VendorId", id: 1, type: "vendor-id", access: "F", conformance: "M" },
        {
          tag: "datatype",
        ...
        { tag: "datatype", name: "Endpoint", id: 4, type: "endpoint-no", access: "F", conformance: "M" },
        {
          tag: "datatype",
          name: "FabricIndex",
          id: 254,
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "ProviderNodeId", id: 1, type: "node-id", access: "F", conformance: "M" },
        { tag: "datatype", name: "Endpoint", id: 2, type: "endpoint-no", access: "F", conformance: "M" },
        {
          tag: "datatype",
          name: "FabricIndex",
          id: 254,
