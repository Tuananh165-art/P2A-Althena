...
var ColorControlCluster_exports = {};
__export(ColorControlCluster_exports, {
  ColorControl: () => ColorControl,
  ColorControlCluster: () => ColorControlCluster
});
module.exports = __toCommonJS(ColorControlCluster_exports);
var import_ClusterFactory = require("../../cluster/ClusterFactory.js");
...
((ColorControl2) => {
  ...
  ColorControl2.FeatureMap = {
    /**
     * HueSaturation
     *
     * Supports color specification via hue/saturation.
     */
    hs: (0, import_BitmapSchema.BitFlag)(0),
    /**
     * EnhancedHue
     *
     * Enhanced hue is supported.
     */
    ehue: (0, import_BitmapSchema.BitFlag)(1),
    /**
     * ColorLoop
     *
     * Color loop is supported.
     */
    cl: (0, import_BitmapSchema.BitFlag)(2),
    /**
     * Xy
     *
     ...
     */
    ct: (0, import_BitmapSchema.BitFlag)(4)
  };
  let ColorControlDirection;
  ((ColorControlDirection2) => {
    ColorControlDirection2[ColorControlDirection2["ShortestDistance"] = 0] = "ShortestDistance";
    ColorControlDirection2[ColorControlDirection2["LongestDistance"] = 1] = "LongestDistance";
    ColorControlDirection2[ColorControlDirection2["Up"] = 2] = "Up";
    ColorControlDirection2[ColorControlDirection2["Down"] = 3] = "Down";
  })(ColorControlDirection = ColorControl2.ColorControlDirection || (ColorControl2.ColorControlDirection = {}));
  ColorControl2.TlvMoveToHueRequest = (0, import_TlvObject.TlvObject)({
    ...
    optionsOverride: (0, import_TlvObject.TlvField)(4, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  let MoveMode;
  ((MoveMode2) => {
  ...
  ColorControl2.TlvMoveHueRequest = (0, import_TlvObject.TlvObject)({
    ...
    optionsOverride: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  let StepMode;
  ((StepMode2) => {
  ...
  ColorControl2.TlvMoveToSaturationRequest = (0, import_TlvObject.TlvObject)({
    saturation: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8.bound({ max: 254 })),
    transitionTime: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt16.bound({ max: 65534 })),
    optionsMask: (0, import_TlvObject.TlvField)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  ...
  ColorControl2.TlvMoveToHueAndSaturationRequest = (0, import_TlvObject.TlvObject)({
    hue: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8.bound({ max: 254 })),
  ...
  ColorControl2.TlvMoveToColorRequest = (0, import_TlvObject.TlvObject)({
    colorX: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16.bound({ max: 65279 })),
    colorY: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt16.bound({ max: 65279 })),
    transitionTime: (0, import_TlvObject.TlvField)(2, import_TlvNumber.TlvUInt16.bound({ max: 65534 })),
    optionsMask: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(4, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  ...
  ColorControl2.TlvStepColorRequest = (0, import_TlvObject.TlvObject)({
  ...
  ColorControl2.TlvMoveToColorTemperatureRequest = (0, import_TlvObject.TlvObject)({
    colorTemperatureMireds: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16.bound({ max: 65279 })),
    transitionTime: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt16.bound({ max: 65534 })),
    optionsMask: (0, import_TlvObject.TlvField)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(3, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  ColorControl2.TlvMoveColorTemperatureRequest = (0, import_TlvObject.TlvObject)({
     ...
     */
    moveMode: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8),
    /**
    ...
    optionsOverride: (0, import_TlvObject.TlvField)(5, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  ColorControl2.TlvStepColorTemperatureRequest = (0, import_TlvObject.TlvObject)({
     ...
     */
    stepMode: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt8),
    /**
    ...
    optionsOverride: (0, import_TlvObject.TlvField)(6, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  ...
  ColorControl2.TlvStopMoveStepRequest = (0, import_TlvObject.TlvObject)({
    optionsMask: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options)),
    optionsOverride: (0, import_TlvObject.TlvField)(1, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, ColorControl2.Options))
  });
  let Feature;
  ((Feature2) => {
  ...
  ColorControl2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 768,
    name: "ColorControl",
    revision: 5,
    features: {
    ...
    attributes: {
       ...
       */
      remainingTime: (0, import_Cluster.OptionalAttribute)(2, import_TlvNumber.TlvUInt16.bound({ max: 65534 }), { default: 0 }),
      /**
      ...
      whitePointX: (0, import_Cluster.OptionalWritableAttribute)(
        48,
        import_TlvNumber.TlvUInt16.bound({ max: 65279 }),
        { writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
       ...
       */
      enhancedColorMode: (0, import_Cluster.Attribute)(
        16385,
        (0, import_TlvNumber.TlvEnum)(),
        { persistent: true, default: 1 /* CurrentXAndCurrentY */ }
      ),
       ...
       */
      colorCapabilities: (0, import_Cluster.FixedAttribute)(16394, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt32, ColorControl2.FeatureMap))
    }
  });
  ColorControl2.HueSaturationComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      currentSaturation: (0, import_Cluster.Attribute)(
        1,
        import_TlvNumber.TlvUInt8.bound({ max: 254 }),
  ...
  ColorControl2.XyComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      currentX: (0, import_Cluster.Attribute)(
        3,
        import_TlvNumber.TlvUInt16.bound({ max: 65279 }),
       ...
       */
      currentY: (0, import_Cluster.Attribute)(
        4,
        import_TlvNumber.TlvUInt16.bound({ max: 65279 }),
  ...
  ColorControl2.ColorTemperatureComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      colorTemperatureMireds: (0, import_Cluster.Attribute)(
        7,
        import_TlvNumber.TlvUInt16.bound({ max: 65279 }),
       ...
       */
      coupleColorTempToLevelMinMireds: (0, import_Cluster.OptionalAttribute)(16397, import_TlvNumber.TlvUInt16.bound({ max: 65279 })),
      /**
  ...
  ColorControl2.EnhancedHueComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      enhancedCurrentHue: (0, import_Cluster.Attribute)(16384, import_TlvNumber.TlvUInt16, { scene: true, persistent: true, default: 0 })
    },
    commands: {
      /**
  ...
  ColorControl2.ColorLoopComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      colorLoopActive: (0, import_Cluster.Attribute)(16386, import_TlvNumber.TlvUInt8, { scene: true, persistent: true, default: 0 }),
      /**
       ...
       */
      colorLoopDirection: (0, import_Cluster.Attribute)(16387, import_TlvNumber.TlvUInt8, { scene: true, persistent: true, default: 0 }),
      /**
       ...
       */
      colorLoopStoredEnhancedHue: (0, import_Cluster.Attribute)(16390, import_TlvNumber.TlvUInt16, { default: 0 })
    },
    commands: {
      /**
  ...
  ColorControl2.HueSaturationOrXyOrColorTemperatureComponent = import_ClusterFactory.ClusterFactory.Component({
    commands: {
      /**
  ...
  ColorControl2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    ColorControl2.Base,
    /**
     ...
     */
    (...features) => {
      import_ClusterFactory.ClusterFactory.validateFeatureSelection(features, Feature);
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...ColorControl2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(ColorControl2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, ColorControl2.HueSaturationComponent, { hueSaturation: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ColorControl2.XyComponent, { xy: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ColorControl2.ColorTemperatureComponent, { colorTemperature: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ColorControl2.EnhancedHueComponent, { enhancedHue: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, ColorControl2.ColorLoopComponent, { colorLoop: true });
      import_ClusterFactory.ClusterFactory.extend(
        cluster,
        ColorControl2.HueSaturationOrXyOrColorTemperatureComponent,
        { hueSaturation: true },
        { xy: true },
  ...
  ColorControl2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    attributes: {
      ...
      currentHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.attributes.currentHue,
        { mandatoryIf: [HS] }
      ),
      currentSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.attributes.currentSaturation,
        { mandatoryIf: [HS] }
      ),
      currentX: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.XyComponent.attributes.currentX, { mandatoryIf: [XY] }),
      currentY: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.XyComponent.attributes.currentY, { mandatoryIf: [XY] }),
      colorTemperatureMireds: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.attributes.colorTemperatureMireds,
        { mandatoryIf: [CT] }
      ),
      enhancedCurrentHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.EnhancedHueComponent.attributes.enhancedCurrentHue,
        { mandatoryIf: [EHUE] }
      ),
      colorLoopActive: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorLoopComponent.attributes.colorLoopActive,
        { mandatoryIf: [CL] }
      ),
      colorLoopDirection: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorLoopComponent.attributes.colorLoopDirection,
        { mandatoryIf: [CL] }
      ),
      colorLoopTime: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorLoopComponent.attributes.colorLoopTime,
        { mandatoryIf: [CL] }
      ),
      colorLoopStartEnhancedHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorLoopComponent.attributes.colorLoopStartEnhancedHue,
        { mandatoryIf: [CL] }
      ),
      colorLoopStoredEnhancedHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorLoopComponent.attributes.colorLoopStoredEnhancedHue,
        { mandatoryIf: [CL] }
      ),
      colorTempPhysicalMinMireds: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.attributes.colorTempPhysicalMinMireds,
        { mandatoryIf: [CT] }
      ),
      colorTempPhysicalMaxMireds: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.attributes.colorTempPhysicalMaxMireds,
        { mandatoryIf: [CT] }
      ),
      coupleColorTempToLevelMinMireds: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.attributes.coupleColorTempToLevelMinMireds,
        { optionalIf: [CT] }
      ),
      startUpColorTemperatureMireds: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.attributes.startUpColorTemperatureMireds,
        { optionalIf: [CT] }
      )
    },
    commands: {
      moveToHue: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.HueSaturationComponent.commands.moveToHue, { mandatoryIf: [HS] }),
      moveHue: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.HueSaturationComponent.commands.moveHue, { mandatoryIf: [HS] }),
      stepHue: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.HueSaturationComponent.commands.stepHue, { mandatoryIf: [HS] }),
      moveToSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.commands.moveToSaturation,
        { mandatoryIf: [HS] }
      ),
      moveSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.commands.moveSaturation,
        { mandatoryIf: [HS] }
      ),
      stepSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.commands.stepSaturation,
        { mandatoryIf: [HS] }
      ),
      moveToHueAndSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationComponent.commands.moveToHueAndSaturation,
        { mandatoryIf: [HS] }
      ),
      moveToColor: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.XyComponent.commands.moveToColor, { mandatoryIf: [XY] }),
      moveColor: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.XyComponent.commands.moveColor, { mandatoryIf: [XY] }),
      stepColor: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.XyComponent.commands.stepColor, { mandatoryIf: [XY] }),
      moveToColorTemperature: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.commands.moveToColorTemperature,
        { mandatoryIf: [CT] }
      ),
      enhancedMoveToHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.EnhancedHueComponent.commands.enhancedMoveToHue,
        { mandatoryIf: [EHUE] }
      ),
      enhancedMoveHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.EnhancedHueComponent.commands.enhancedMoveHue,
        { mandatoryIf: [EHUE] }
      ),
      enhancedStepHue: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.EnhancedHueComponent.commands.enhancedStepHue,
        { mandatoryIf: [EHUE] }
      ),
      enhancedMoveToHueAndSaturation: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.EnhancedHueComponent.commands.enhancedMoveToHueAndSaturation,
        { mandatoryIf: [EHUE] }
      ),
      colorLoopSet: import_ClusterFactory.ClusterFactory.AsConditional(ColorControl2.ColorLoopComponent.commands.colorLoopSet, { mandatoryIf: [CL] }),
      stopMoveStep: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.HueSaturationOrXyOrColorTemperatureComponent.commands.stopMoveStep,
        { mandatoryIf: [HS, XY, CT] }
      ),
      moveColorTemperature: import_ClusterFactory.ClusterFactory.AsConditional(
        ColorControl2.ColorTemperatureComponent.commands.moveColorTemperature,
        { mandatoryIf: [CT] }
      ),
      stepColorTemperature: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=ColorControlCluster.js.map
