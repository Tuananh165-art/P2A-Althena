...
export declare namespace NetworkCommissioning {
     ...
     */
    const TlvNetworkInfoStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     */
    const TlvWiFiInterfaceScanResultStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        security: import("../../tlv/TlvObject.js").OptionalFieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            /**
             * Supports unencrypted Wi-Fi
             */
            unencrypted: BitFlag;
     ...
     */
    const TlvThreadInterfaceScanResultStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
    ...
    const Base: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly lastNetworkId: Attribute<Uint8Array | null, any>;
            /**
     ...
     * ThreadNetworkInterface.
     */
    const WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const WiFiNetworkInterfaceComponent: ClusterFactory.TypedComponent<{
        readonly commands: {
            /**
     ...
     */
    const ThreadNetworkInterfaceComponent: ClusterFactory.TypedComponent<{
        readonly commands: {
            /**
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<49 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        ...
        readonly with: <T extends ("WiFiNetworkInterface" | "ThreadNetworkInterface" | "EthernetNetworkInterface")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * WiFiNetworkInterface
             *
             * Wi-Fi related features
    ...
    } ? typeof WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent : {}) & (SF extends {
        wiFiNetworkInterface: true;
    } ? typeof WiFiNetworkInterfaceComponent : {}) & (SF extends {
        threadNetworkInterface: true;
    } ? typeof ThreadNetworkInterfaceComponent : {}) & (SF extends {
        wiFiNetworkInterface: true;
        threadNetworkInterface: true;
    } ? never : {}) & (SF extends {
        wiFiNetworkInterface: true;
    ...
    const Complete: ClusterFactory.Definition<{
        readonly id: 49 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "NetworkCommissioning";
        readonly revision: 1;
        readonly features: {
            /**
...
export declare const NetworkCommissioningCluster: {
    id: import("../../util/Type.js").Branded<49 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "NetworkCommissioning";
    revision: 1;
    features: {
    ...
    attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.8.6.6
         */
        readonly lastNetworkingStatus: Attribute<NetworkCommissioning.NetworkCommissioningStatus | null, any>;
        /**
         * This attribute shall indicate the NetworkID used in the last attempt to connect to an operational
         * network, using this interface, whether by invocation of the ConnectNetwork command or by autonomous
         * connection after loss of connectivity or during initial establishment. If no such attempt was made, or
    ...
    readonly with: <T extends ("WiFiNetworkInterface" | "ThreadNetworkInterface" | "EthernetNetworkInterface")[]>(...features_0: T) => NetworkCommissioning.Extension<BitFlags<{
        /**
         * WiFiNetworkInterface
         *
         * Wi-Fi related features
...
//# sourceMappingURL=NetworkCommissioningCluster.d.ts.map