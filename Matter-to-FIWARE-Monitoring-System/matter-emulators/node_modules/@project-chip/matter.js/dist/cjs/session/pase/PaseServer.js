...
class PaseServer {
  ...
  static fromVerificationValue(verificationValue, pbkdfParameters) {
    const w0 = new import_bn.default(verificationValue.slice(0, 32));
  ...
  async handlePairingRequest(server, messenger) {
    ...
    this.pairingTimer = import_Time.Time.getTimer(PASE_PAIRING_TIMEOUT_MS, () => this.cancelPairing(messenger)).start();
    const {
      requestPayload,
