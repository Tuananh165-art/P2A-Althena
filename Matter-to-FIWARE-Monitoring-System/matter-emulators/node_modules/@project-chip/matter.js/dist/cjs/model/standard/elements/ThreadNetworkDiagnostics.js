...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "ConnectionStatus", id: 0, type: "ConnectionStatusEnum", conformance: "M" }
      ]
    },
    {
      tag: "event",
      ...
      children: [
        {
          ...
          conformance: "M",
          constraint: "max 4",
          details: "This field shall represent the set of faults currently detected, as per Section 11.13.5.1, \u201CNetworkFaultEnum\u201D.",
        ...
        },
        {
          ...
          conformance: "M",
          constraint: "max 4",
          details: "This field shall represent the set of faults detected prior to this change event, as per Section 11.13.5.1, \u201CNetworkFaultEnum\u201D.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Connected", id: 0, conformance: "M", description: "Node is connected" },
        {
          tag: "datatype",
          name: "NotConnected",
          id: 1,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          default: null,
          quality: "X",
          details: "This field SHOULD specify the average RSSI across all received frames from the neighboring Node since the receiving Node\u2019s last reboot. If there is no known received frames this field SHOULD have\nthe value of null. This field shall have the units of dBm, having the range -128 dBm to 0 dBm.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "ExtAddress", id: 0, type: "uint64", conformance: "M" },
        { tag: "datatype", name: "Rloc16", id: 1, type: "uint16", conformance: "M" },
        {
          tag: "datatype",
          name: "RouterId",
          id: 2,
        ...
        { tag: "datatype", name: "Age", id: 7, type: "uint8", conformance: "M" },
        {
          tag: "datatype",
          name: "Allocated",
          id: 8,
      ...
      children: [
        {
          ...
          type: "uint16",
          conformance: "M",
          details: "This field shall specify the interval of time, in hours, that Thread security keys are rotated. This attribute shall be null when there is no dataset configured.",
        ...
        },
        {
          ...
          type: "uint16",
          conformance: "M",
          details: "This field shall specify the flags as specified in Thread 1.3.0 section 8.10.1.15. This attribute shall be null when there is no dataset configured.",
