...
var GeneralCommissioningCluster_exports = {};
__export(GeneralCommissioningCluster_exports, {
  GeneralCommissioning: () => GeneralCommissioning,
  GeneralCommissioningCluster: () => GeneralCommissioningCluster
});
module.exports = __toCommonJS(GeneralCommissioningCluster_exports);
...
((GeneralCommissioning2) => {
  ...
  GeneralCommissioning2.Cluster = import_ClusterFactory.ClusterFactory.Definition({
    id: 48,
    ...
    attributes: {
       ...
       */
      breadcrumb: (0, import_Cluster.WritableAttribute)(0, import_TlvNumber.TlvUInt64, { default: 0, writeAcl: import_Cluster.AccessLevel.Administer }),
      /**
