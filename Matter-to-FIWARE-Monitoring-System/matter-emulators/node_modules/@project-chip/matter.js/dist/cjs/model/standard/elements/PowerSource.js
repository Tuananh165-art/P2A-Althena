...
import_Matter.Matter.children.push({
  ...
  children: [
      ...
      children: [
        {
          ...
          constraint: "max 8",
          default: [],
          details: "This field shall represent the set of faults currently detected, as per Section 11.7.6.11, \u201CActiveWiredFaults Attribute\u201D.",
        ...
        },
        {
          ...
          constraint: "max 8",
          default: [],
          details: "This field shall represent the set of faults detected prior to this change event, as per Section 11.7.6.11, \u201CActiveWiredFaults Attribute\u201D.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Ac", id: 0, conformance: "M", description: "Indicates AC current" },
        { tag: "datatype", name: "Dc", id: 1, conformance: "M", description: "Indicates DC current" }
      ]
    },
    {
      tag: "datatype",
      ...
      children: [
        { tag: "datatype", name: "Ok", id: 0, conformance: "M", description: "Charge level is nominal" },
        {
          tag: "datatype",
          name: "Warning",
          id: 1,
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "Aaa", id: 1, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "Aa", id: 2, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "C", id: 3, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "D", id: 4, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "4V5", id: 5, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "6V0", id: 6, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "9V0", id: 7, conformance: "M", description: "Common type is as specified" },
        {
          tag: "datatype",
          name: "12Aa",
          id: 8,
        ...
        { tag: "datatype", name: "A", id: 10, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "B", id: 11, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "F", id: 12, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "N", id: 13, conformance: "M", description: "Common type is as specified" },
        { tag: "datatype", name: "No6", id: 14, conformance: "M", description: "Common type is as specified" },
        {
          tag: "datatype",
          name: "SubC",
          id: 15,
        ...
        { tag: "datatype", name: "J", id: 28, conformance: "M", description: "Common type is as specified" },
        {
          tag: "datatype",
          name: "Cr123A",
          id: 29,
        ...
        { tag: "datatype", name: "A5", id: 56, conformance: "M", description: "Common type is as specified" },
        {
          tag: "datatype",
          name: "A10",
          id: 57,
