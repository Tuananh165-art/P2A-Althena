...
((BallastConfiguration2) => {
  BallastConfiguration2.BallastStatus = { ballastNonOperational: BitFlag(0), lampFailure: BitFlag(1) };
  BallastConfiguration2.LampAlarmMode = { lampBurnHours: BitFlag(0) };
  BallastConfiguration2.Cluster = ClusterFactory.Definition({
    id: 769,
    ...
    attributes: {
       ...
       */
      minLevel: WritableAttribute(16, TlvUInt8.bound({ min: 1, max: 254 }), { writeAcl: AccessLevel.Manage }),
      /**
       ...
       */
      maxLevel: WritableAttribute(17, TlvUInt8.bound({ min: 1, max: 254 }), { writeAcl: AccessLevel.Manage }),
      /**
...
//# sourceMappingURL=BallastConfigurationCluster.js.map
