...
((BasicInformation2) => {
  BasicInformation2.TlvCapabilityMinimaStruct = TlvObject({
    /**
  ...
  BasicInformation2.TlvProductAppearanceStruct = TlvObject({
  ...
  BasicInformation2.Cluster = ClusterFactory.Definition({
    id: 40,
    ...
    attributes: {
      ...
      productAppearance: OptionalFixedAttribute(20, BasicInformation2.TlvProductAppearanceStruct)
    },
    events: {
      /**
