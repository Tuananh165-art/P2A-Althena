...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [{ tag: "datatype", name: "GroupKeySetId", id: 0, type: "uint16", conformance: "M" }]
    },
    {
      tag: "command",
    ...
    },
    {
      ...
      type: "struct",
      conformance: "M",
      details: "This field shall provide the fabric-unique index for the associated group key set, as specified in Section 4.15.3.5.1, \u201CGroup Key Set ID\u201D.",
      xref: { document: "core", section: "11.2.6.4" },
      children: [
        { tag: "datatype", name: "GroupKeySetId", id: 0, type: "uint16", conformance: "M" },
        {
          tag: "datatype",
        ...
        },
        {
          ...
          constraint: "16",
          quality: "X",
          details: "This field, if not null, shall be the root credential used in the derivation of an operational group key for epoch slot 0 of the given group key set. If EpochKey0 is not null, EpochStartTime0 shall NOT be null.",
        ...
        },
        {
          ...
          conformance: "M",
          quality: "X",
          details: "This field, if not null, shall define when EpochKey0 becomes valid as specified by Section 4.15.3, \u201CEpoch Keys\u201D. Units are absolute UTC time in microseconds encoded using the epoch-us representation.",
        ...
        },
        {
          ...
          constraint: "16",
          quality: "X",
          details: "This field, if not null, shall be the root credential used in the derivation of an operational group key for epoch slot 1 of the given group key set. If EpochKey1 is not null, EpochStartTime1 shall NOT be null.",
        ...
        },
        {
          ...
          conformance: "M",
          quality: "X",
          details: "This field, if not null, shall define when EpochKey1 becomes valid as specified by Section 4.15.3, \u201CEpoch Keys\u201D. Units are absolute UTC time in microseconds encoded using the epoch-us representation.",
        ...
        },
        {
          ...
          constraint: "16",
          quality: "X",
          details: "This field, if not null, shall be the root credential used in the derivation of an operational group key for epoch slot 2 of the given group key set. If EpochKey2 is not null, EpochStartTime2 shall NOT be null.",
        ...
        },
        {
          ...
          conformance: "M",
          quality: "X",
          details: "This field, if not null, shall define when EpochKey2 becomes valid as specified by Section 4.15.3, \u201CEpoch Keys\u201D. Units are absolute UTC time in microseconds encoded using the epoch-us representation.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "GroupId", id: 1, type: "group-id", access: "R F", conformance: "M" },
        {
          tag: "datatype",
          name: "Endpoints",
          id: 2,
          ...
          conformance: "M",
          constraint: "min 1",
          details: "This field provides the list of Endpoint IDs on the Node to which messages to this group shall be forwarded.",
        ...
        },
        {
          ...
          conformance: "O",
          constraint: "max 16",
          details: "This field provides a name for the group. This field shall contain the last GroupName written for a given GroupId on any Endpoint via the Groups cluster.",
...
//# sourceMappingURL=GroupKeyManagement.js.map
