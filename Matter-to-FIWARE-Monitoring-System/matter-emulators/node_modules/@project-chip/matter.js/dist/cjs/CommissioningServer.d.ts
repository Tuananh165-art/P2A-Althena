...
import { GeneralCommissioningCluster } from "./cluster/definitions/GeneralCommissioningCluster.js";
import { GeneralDiagnosticsCluster } from "./cluster/definitions/GeneralDiagnosticsCluster.js";
...
import { CommissionningFlowType, DiscoveryCapabilitiesBitmap } from "./schema/PairingCodeSchema.js";
...
export declare class CommissioningServer extends MatterNode {
     ...
     */
    getRootClusterServer<F extends BitSchema, SF extends TypeFromPartialBitSchema<F>, A extends Attributes, C extends Commands, E extends Events>(cluster: Cluster<F, SF, A, C, E>): ClusterServerObj<A, E> | undefined;
    /**
     * Add a cluster client to the root endpoint. This is mainly used internally and not needed to be called by the user.
     *
     * @param cluster ClusterClient object to add
     */
    addRootClusterClient<F extends BitSchema, A extends Attributes, C extends Commands, E extends Events>(cluster: ClusterClientObj<F, A, C, E>): void;
    /**
     * Get a cluster client from the root endpoint. This is mainly used internally and not needed to be called by the user.
     *
     * @param cluster ClusterClient to get or undefined if not existing
     */
    getRootClusterClient<F extends BitSchema, SF extends TypeFromPartialBitSchema<F>, A extends Attributes, C extends Commands, E extends Events>(cluster: Cluster<F, SF, A, C, E>): ClusterClientObj<F, A, C, E> | undefined;
    /**
     ...
     * @param cluster
     */
    addRootClusterServer<A extends Attributes, E extends Events>(cluster: ClusterServerObj<A, E>): void;
    /**
     ...
     * @param storage
     */
    setStorage(storage: StorageContext): void;
    /**
    ...
    getCommissionedFabricInformation(fabricIndex?: FabricIndex): {
        ...
        nodeId: import("./datatype/NodeId.js").NodeId;
        rootNodeId: import("./datatype/NodeId.js").NodeId;
    ...
    getActiveSessionInformation(fabricIndex?: FabricIndex): {
        name: string;
        nodeId: import("./datatype/NodeId.js").NodeId;
        peerNodeId: import("./datatype/NodeId.js").NodeId;
        fabric: {
            fabricIndex: FabricIndex;
            fabricId: import("./datatype/FabricId.js").FabricId;
            nodeId: import("./datatype/NodeId.js").NodeId;
