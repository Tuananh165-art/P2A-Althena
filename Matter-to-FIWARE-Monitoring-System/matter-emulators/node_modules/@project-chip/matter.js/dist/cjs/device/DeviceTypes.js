...
var MatterClusters = __toESM(require("../cluster/definitions/index.js"), 1);
...
const DeviceTypeDefinition = ({
  ...
  name,
  code: (0, import_DeviceTypeId.DeviceTypeId)(code),
  deviceClass,
  superSet,
  revision,
  requiredServerClusters,
...
const UnknownDeviceType = (code) => DeviceTypeDefinition({
  code,
