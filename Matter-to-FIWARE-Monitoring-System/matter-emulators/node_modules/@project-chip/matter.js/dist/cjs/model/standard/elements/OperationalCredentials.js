...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      details: "This command shall be generated to request the Attestation Information, in the form of an AttestationResponse Command. If the AttestationNonce that is provided in the command is malformed, a\nrecipient shall fail the command with a Status Code of INVALID_COMMAND. The AttestationNonce field shall be used in the computation of the Attestation Information.",
      xref: { document: "core", section: "11.17.6.1" },
      children: [{ tag: "datatype", name: "AttestationNonce", id: 0, type: "octstr", conformance: "M", constraint: "32" }]
    },
    {
      tag: "command",
      ...
      children: [
        ...
        },
        {
          ...
          conformance: "M",
          constraint: "64",
          details: "This field shall contain the octet string of the necessary attestation_signature as described in Section 11.17.4.7, \u201CAttestation Information\u201D.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "CsrNonce", id: 0, type: "octstr", conformance: "M", constraint: "32" },
        { tag: "datatype", name: "IsForUpdateNoc", id: 1, type: "bool", conformance: "O", default: true }
      ]
    },
    {
      tag: "command",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "NocValue", id: 0, type: "octstr", conformance: "M", constraint: "max 400" },
        {
          tag: "datatype",
          name: "IcacValue",
          id: 1,
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Ok", id: 0, conformance: "M", description: "OK, no error" },
        {
          tag: "datatype",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          conformance: "M",
          constraint: "desc",
          details: "This field shall contain the value of AdminVendorID provided in the AddNOC command that led to the creation of this FabricDescriptorStruct. The set of allowed values is defined in Section 11.17.6.8.3, \u201CAdminVendorID Field\u201D.\nThe intent is to provide some measure of user transparency about which entities have Administer privileges on the Node.",
