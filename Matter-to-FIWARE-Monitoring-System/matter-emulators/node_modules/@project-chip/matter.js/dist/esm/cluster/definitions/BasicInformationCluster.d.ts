...
export declare namespace BasicInformation {
     ...
     */
    const TlvCapabilityMinimaStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
    ...
    const TlvProductAppearanceStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
...
export declare const BasicInformationCluster: ClusterFactory.Definition<{
    readonly id: 40;
    readonly name: "BasicInformation";
    readonly revision: 2;
    readonly attributes: {
...
//# sourceMappingURL=BasicInformationCluster.d.ts.map