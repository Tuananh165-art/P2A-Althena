...
export declare namespace MediaPlayback {
     ...
     */
    const TlvPlaybackPositionStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     */
    const AdvancedSeekComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const VariableSpeedComponent: ClusterFactory.TypedComponent<{
        readonly commands: {
            /**
             ...
             */
            readonly rewind: Command<void, import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This shall indicate the status of the command which resulted in this response.
                 *
                 * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.12.1
             ...
             */
            readonly fastForward: Command<void, import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * This shall indicate the status of the command which resulted in this response.
                 *
                 * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.12.1
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<1286 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "MediaPlayback";
        revision: 1;
        features: {
            /**
        ...
        readonly with: <T extends ("AdvancedSeek" | "VariableSpeed")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * AdvancedSeek
             *
             * Enables clients to implement more advanced media seeking behavior in their user interface, such as for
    ...
    type Extension<SF extends TypeFromPartialBitSchema<typeof Base.features>> = Omit<typeof Base, "supportedFeatures"> & {
        ...
        advancedSeek: true;
    } ? typeof AdvancedSeekComponent : {}) & (SF extends {
        variableSpeed: true;
    } ? typeof VariableSpeedComponent : {});
    /**
    ...
    const Complete: ClusterFactory.Definition<{
        readonly id: 1286 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "MediaPlayback";
        readonly revision: 1;
        readonly features: {
            /**
...
export declare const MediaPlaybackCluster: {
    id: import("../../util/Type.js").Branded<1286 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "MediaPlayback";
    revision: 1;
    features: {
    ...
    attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
         ...
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.3.1
         */
        readonly currentState: Attribute<MediaPlayback.PlaybackState, any>;
    }, import("../../cluster/Cluster.js").GlobalAttributes<{
        /**
         * AdvancedSeek
         *
    ...
    commands: {
        ...
        readonly play: Command<void, import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.12.1
             */
            status: import("../../tlv/TlvObject.js").FieldType<MediaPlayback.Status>;
            /**
             * This shall indicate Optional app-specific data.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.12.2
    ...
    readonly with: <T extends ("AdvancedSeek" | "VariableSpeed")[]>(...features_0: T) => MediaPlayback.Extension<BitFlags<{
        /**
         * AdvancedSeek
         *
         * Enables clients to implement more advanced media seeking behavior in their user interface, such as for
...
//# sourceMappingURL=MediaPlaybackCluster.d.ts.map