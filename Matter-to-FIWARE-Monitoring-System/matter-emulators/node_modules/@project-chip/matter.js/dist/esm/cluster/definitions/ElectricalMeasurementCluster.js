...
((ElectricalMeasurement2) => {
  ElectricalMeasurement2.TlvGetMeasurementProfileCommandRequest = TlvObject({
    attributeId: TlvField(0, TlvUInt16),
    startTime: TlvField(1, TlvUInt32),
    numberOfIntervals: TlvField(2, TlvUInt8)
  });
  ElectricalMeasurement2.Cluster = ClusterFactory.Definition({
    id: 2820,
    ...
    attributes: {
      ...
      dcVoltageMultiplier: OptionalAttribute(512, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      dcVoltageDivisor: OptionalAttribute(513, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      dcCurrentMultiplier: OptionalAttribute(514, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      dcCurrentDivisor: OptionalAttribute(515, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      dcPowerMultiplier: OptionalAttribute(516, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      dcPowerDivisor: OptionalAttribute(517, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      ...
      totalApparentPower: OptionalAttribute(774, TlvUInt32.bound({ max: 16777215 }), { default: 1 }),
      ...
      acFrequencyMultiplier: OptionalAttribute(1024, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acFrequencyDivisor: OptionalAttribute(1025, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      powerMultiplier: OptionalAttribute(1026, TlvUInt32.bound({ max: 16777215 }), { default: 1 }),
      powerDivisor: OptionalAttribute(1027, TlvUInt32.bound({ max: 16777215 }), { default: 1 }),
      harmonicCurrentMultiplier: OptionalAttribute(1028, TlvInt8.bound({ min: -127 }), { default: 0 }),
      phaseHarmonicCurrentMultiplier: OptionalAttribute(1029, TlvInt8.bound({ min: -127 }), { default: 0 }),
      ...
      acPowerFactor: OptionalAttribute(1296, TlvInt8.bound({ min: -100, max: 100 }), { default: 0 }),
      ...
      acVoltageMultiplier: OptionalAttribute(1536, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acVoltageDivisor: OptionalAttribute(1537, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acCurrentMultiplier: OptionalAttribute(1538, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acCurrentDivisor: OptionalAttribute(1539, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acPowerMultiplier: OptionalAttribute(1540, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      acPowerDivisor: OptionalAttribute(1541, TlvUInt16.bound({ min: 1 }), { default: 1 }),
      ...
      powerFactorPhaseB: OptionalAttribute(2320, TlvInt8.bound({ min: -100, max: 100 }), { default: 0 }),
      ...
      powerFactorPhaseC: OptionalAttribute(2576, TlvInt8.bound({ min: -100, max: 100 }), { default: 0 }),
    ...
    commands: {
      ...
      getMeasurementProfileCommand: OptionalCommand(
        1,
        ElectricalMeasurement2.TlvGetMeasurementProfileCommandRequest,
        1,
        TlvNoResponse
      )
    }
...
const ElectricalMeasurementCluster = ElectricalMeasurement.Cluster;
export {
  ElectricalMeasurement,
  ElectricalMeasurementCluster
};
//# sourceMappingURL=ElectricalMeasurementCluster.js.map
