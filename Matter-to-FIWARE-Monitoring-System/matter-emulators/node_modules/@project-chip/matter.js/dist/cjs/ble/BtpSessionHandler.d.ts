...
export declare class BtpSessionHandler {
    ...
    static createFromHandshakeRequest(maxDataSize: number | undefined, handshakeRequestPayload: ByteArray, writeBleCallback: (data: ByteArray) => Promise<void>, disconnectBleCallback: () => Promise<void>, handleMatterMessagePayload: (data: ByteArray) => Promise<void>): Promise<BtpSessionHandler>;
    static createAsCentral(handshakeResponsePayload: ByteArray, writeBleCallback: (data: ByteArray) => Promise<void>, disconnectBleCallback: () => Promise<void>, handleMatterMessagePayload: (data: ByteArray) => Promise<void>): Promise<BtpSessionHandler>;
    /**
     ...
     */
    constructor(role: "central" | "peripheral", btpVersion: number, fragmentSize: number, clientWindowSize: number, writeBleCallback: (data: ByteArray) => Promise<void>, disconnectBleCallback: () => Promise<void>, handleMatterMessagePayload: (data: ByteArray) => Promise<void>);
    /**
     ...
     */
    handleIncomingBleData(data: ByteArray): Promise<void>;
    /**
     ...
     */
    sendMatterMessage(data: ByteArray): Promise<void>;
