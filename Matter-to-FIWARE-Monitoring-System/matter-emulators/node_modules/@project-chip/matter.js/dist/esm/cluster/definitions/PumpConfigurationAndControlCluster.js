...
((PumpConfigurationAndControl2) => {
  PumpConfigurationAndControl2.PumpStatusBitmap = {
    /**
  ...
  PumpConfigurationAndControl2.Base = ClusterFactory.Definition({
    id: 512,
    ...
    attributes: {
       ...
       */
      maxSpeed: FixedAttribute(1, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       ...
       */
      maxFlow: FixedAttribute(2, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       ...
       */
      pumpStatus: OptionalAttribute(16, TlvBitmap(TlvUInt16, PumpConfigurationAndControl2.PumpStatusBitmap)),
      /**
       ...
       */
      capacity: Attribute(19, TlvNullable(TlvInt16.bound({ min: 0 })), { default: null }),
      /**
       ...
       */
      speed: OptionalAttribute(20, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
  ...
  PumpConfigurationAndControl2.ConstantPressureComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  PumpConfigurationAndControl2.AutomaticComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the minimum pressure the pump can achieve when it is working with the
       * ControlMode attribute set to ConstantPressure.
       ...
       */
      minConstSpeed: OptionalFixedAttribute(7, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       ...
       */
      maxConstSpeed: OptionalFixedAttribute(8, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       ...
       */
      minConstFlow: OptionalFixedAttribute(9, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       ...
       */
      maxConstFlow: OptionalFixedAttribute(10, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
  ...
  PumpConfigurationAndControl2.CompensatedPressureComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the minimum compensated pressure the pump can achieve when it is working with
       * the ControlMode attribute set to ProportionalPressure.
  ...
  PumpConfigurationAndControl2.ConstantSpeedComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the minimum speed the pump can achieve when it is working with the ControlMode
       * attribute set to ConstantSpeed.
       ...
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.2.7.8
       */
      minConstSpeed: FixedAttribute(7, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       * This attribute specifies the maximum speed the pump can achieve when it is working with the ControlMode
       * attribute set to ConstantSpeed.
       *
       ...
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.2.7.9
       */
      maxConstSpeed: FixedAttribute(8, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null })
    }
  });
  PumpConfigurationAndControl2.ConstantFlowComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the minimum flow the pump can achieve when it is working with the Con
       *
       ...
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.2.7.10
       */
      minConstFlow: FixedAttribute(9, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null }),
      /**
       * This attribute specifies the maximum flow the pump can achieve when it is working with the ControlMode
       * attribute set to ConstantFlow.
       *
       ...
       * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.2.7.11
       */
      maxConstFlow: FixedAttribute(10, TlvNullable(TlvUInt16.bound({ max: 65534 })), { default: null })
    }
  });
  PumpConfigurationAndControl2.ConstantTemperatureComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the minimum temperature the pump can maintain in the system when it is working
       * with the ControlMode attribute set to ConstantTemperature.
  ...
  PumpConfigurationAndControl2.Cluster = ClusterFactory.Extensible(
    PumpConfigurationAndControl2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...PumpConfigurationAndControl2.Base,
        supportedFeatures: BitFlags(PumpConfigurationAndControl2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.ConstantPressureComponent, { constantPressure: true });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.AutomaticComponent, { automatic: true });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.CompensatedPressureComponent, { compensatedPressure: true });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.ConstantSpeedComponent, { constantSpeed: true });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.ConstantFlowComponent, { constantFlow: true });
      ClusterFactory.extend(cluster, PumpConfigurationAndControl2.ConstantTemperatureComponent, { constantTemperature: true });
  ...
  PumpConfigurationAndControl2.Complete = ClusterFactory.Definition({
    id: PumpConfigurationAndControl2.Cluster.id,
    name: PumpConfigurationAndControl2.Cluster.name,
    revision: PumpConfigurationAndControl2.Cluster.revision,
    features: PumpConfigurationAndControl2.Cluster.features,
    attributes: {
      ...PumpConfigurationAndControl2.Cluster.attributes,
    ...
    events: PumpConfigurationAndControl2.Cluster.events
  });
...
//# sourceMappingURL=PumpConfigurationAndControlCluster.js.map
