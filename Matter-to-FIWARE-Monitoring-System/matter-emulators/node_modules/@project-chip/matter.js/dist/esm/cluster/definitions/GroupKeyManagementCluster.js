...
((GroupKeyManagement2) => {
  GroupKeyManagement2.TlvGroupKeyMapStruct = TlvObject({
    /**
  ...
  GroupKeyManagement2.TlvGroupInfoMapStruct = TlvObject({
    groupId: TlvField(1, TlvGroupId),
    /**
  ...
  GroupKeyManagement2.TlvGroupKeySetStruct = TlvObject({
     ...
     */
    groupKeyMulticastPolicy: TlvField(8, TlvEnum())
  });
  GroupKeyManagement2.TlvKeySetWriteRequest = TlvObject({ groupKeySet: TlvField(0, GroupKeyManagement2.TlvGroupKeySetStruct) });
  GroupKeyManagement2.TlvKeySetReadRequest = TlvObject({ groupKeySetId: TlvField(0, TlvUInt16) });
  GroupKeyManagement2.TlvKeySetReadResponse = TlvObject({ groupKeySet: TlvField(0, GroupKeyManagement2.TlvGroupKeySetStruct) });
  GroupKeyManagement2.TlvKeySetRemoveRequest = TlvObject({ groupKeySetId: TlvField(0, TlvUInt16) });
  GroupKeyManagement2.TlvKeySetReadAllIndicesResponse = TlvObject({ groupKeySetIDs: TlvField(0, TlvArray(TlvUInt16)) });
  let Feature;
  ((Feature2) => {
    Feature2["CacheAndSync"] = "CacheAndSync";
  })(Feature = GroupKeyManagement2.Feature || (GroupKeyManagement2.Feature = {}));
  GroupKeyManagement2.Base = ClusterFactory.Definition({
    id: 63,
    ...
    attributes: {
      ...
      groupKeyMap: WritableFabricScopedAttribute(
        0,
        TlvArray(GroupKeyManagement2.TlvGroupKeyMapStruct, { maxLength: 254 }),
      ...
      groupTable: FabricScopedAttribute(
        1,
        TlvArray(GroupKeyManagement2.TlvGroupInfoMapStruct, { maxLength: 254 }),
        { default: [] }
      ),
      /**
  ...
  GroupKeyManagement2.Cluster = ClusterFactory.Extensible(
    GroupKeyManagement2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...GroupKeyManagement2.Base,
        supportedFeatures: BitFlags(GroupKeyManagement2.Base.features, ...features)
      });
      return cluster;
    }
  );
...
//# sourceMappingURL=GroupKeyManagementCluster.js.map
