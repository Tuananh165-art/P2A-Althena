...
# Demo scenario
powershell -ExecutionPolicy Bypass -File scripts\demo-scenario.ps1 -Mode critical
```

---

## 11) Việc cần làm ngay (Next Actions)
- [ ] Dọn lệch path docs/scripts/CLAUDE/master-plan về đúng thư mục project
- [ ] Chạy lại smoke test sau khi dọn path
- [ ] Chốt KPI scorecard cho phần pitch
- [ ] Tạo `dev-down.ps1` để reset nhanh trước demo
