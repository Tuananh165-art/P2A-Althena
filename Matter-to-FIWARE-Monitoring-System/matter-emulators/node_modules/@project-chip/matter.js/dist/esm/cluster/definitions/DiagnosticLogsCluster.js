...
((DiagnosticLogs2) => {
  ...
  DiagnosticLogs2.TlvRetrieveLogsRequestRequest = TlvObject({
    /**
     ...
     */
    requestedProtocol: TlvField(1, TlvEnum()),
    /**
  ...
  DiagnosticLogs2.TlvRetrieveLogsResponse = TlvObject({
    /**
  ...
  DiagnosticLogs2.Cluster = ClusterFactory.Definition({
    id: 50,
    name: "DiagnosticLogs",
    revision: 1,
    commands: {
       ...
       */
      retrieveLogsRequest: Command(0, DiagnosticLogs2.TlvRetrieveLogsRequestRequest, 1, DiagnosticLogs2.TlvRetrieveLogsResponse)
    }
  });
...
//# sourceMappingURL=DiagnosticLogsCluster.js.map
