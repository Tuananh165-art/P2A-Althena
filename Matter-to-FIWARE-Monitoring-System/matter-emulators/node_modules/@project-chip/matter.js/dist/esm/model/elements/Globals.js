...
const UINT32 = "uint32";
const UINT64 = "uint64";
const bool = (name, description) => DatatypeElement({ name, description, metatype: Metatype.boolean });
const map = (name, description, byteSize) => DatatypeElement({ name, description, byteSize, metatype: Metatype.bitmap });
const int = (name, description, byteSize) => DatatypeElement({ name, description, byteSize, metatype: Metatype.integer });
const float = (name, description, byteSize) => DatatypeElement({ name, description, byteSize, metatype: Metatype.float });
const octet = (name, description) => DatatypeElement({ name, description, metatype: Metatype.bytes });
const string = (name, description) => DatatypeElement({ name, description, metatype: Metatype.string });
const list = (name, description) => DatatypeElement({ name, description, metatype: Metatype.array });
const struct = (name, description) => DatatypeElement({ name, description, metatype: Metatype.object });
const enumt = (name, description, type) => DatatypeElement({ name, description, metatype: Metatype.enum, type });
const extInt = (name, description, type) => DatatypeElement({ name, description, type });
const depInt = (name, description, type) => DatatypeElement({ name, description, type, conformance: Conformance.Flag.Deprecated });
const extOctet = (name, description, constraint) => DatatypeElement({ name, description, type: OCTSTR, constraint });
const extEnum = (name, description, values) => DatatypeElement({ name, description, type: ENUM8, children: DatatypeElement.ListValues(values) });
const extStruct = (name, description, children) => DatatypeElement({ name, description, type: STRUCT, children });
const TodFields = [
