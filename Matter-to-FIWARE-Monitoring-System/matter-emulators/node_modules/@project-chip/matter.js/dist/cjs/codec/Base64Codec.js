...
const A2B = [];
const B2A = new import_ByteArray.ByteArray(64);
const B2A_URL = new import_ByteArray.ByteArray(64);
const PAD = cp("=");
{
...
((Base642) => {
  function encode(input, url = false) {
    ...
    const out = new import_ByteArray.ByteArray(outLength);
  ...
  function decode(input) {
    if (!input.length) {
      return new import_ByteArray.ByteArray();
    }
    let inputLength = input.length;
    while (input.codePointAt(inputLength - 1) === PAD)
      inputLength--;
