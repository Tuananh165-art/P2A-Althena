...
var OperationalCredentialsCluster_exports = {};
__export(OperationalCredentialsCluster_exports, {
  OperationalCredentials: () => OperationalCredentials,
  OperationalCredentialsCluster: () => OperationalCredentialsCluster
});
module.exports = __toCommonJS(OperationalCredentialsCluster_exports);
...
((OperationalCredentials2) => {
  OperationalCredentials2.TlvNOCStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    noc: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    /**
  ...
  OperationalCredentials2.TlvFabricDescriptorStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    rootPublicKey: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ length: 65 })),
    /**
     ...
     */
    vendorId: (0, import_TlvObject.TlvField)(2, import_VendorId.TlvVendorId),
    /**
     ...
     */
    fabricId: (0, import_TlvObject.TlvField)(3, import_FabricId.TlvFabricId),
    /**
     ...
     */
    nodeId: (0, import_TlvObject.TlvField)(4, import_NodeId.TlvNodeId),
    /**
     ...
     */
    label: (0, import_TlvObject.TlvField)(5, import_TlvString.TlvString.bound({ maxLength: 32 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  OperationalCredentials2.TlvAttestationRequestRequest = (0, import_TlvObject.TlvObject)({
    attestationNonce: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ length: 32 }))
  });
  OperationalCredentials2.TlvAttestationResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    attestationElements: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 900 })),
    /**
     ...
     */
    attestationSignature: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ length: 64 }))
  });
  ...
  OperationalCredentials2.TlvCertificateChainRequestRequest = (0, import_TlvObject.TlvObject)({
    certificateType: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)())
  });
  OperationalCredentials2.TlvCertificateChainResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    certificate: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 600 }))
  });
  OperationalCredentials2.TlvCsrRequestRequest = (0, import_TlvObject.TlvObject)({
    csrNonce: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ length: 32 })),
    isForUpdateNoc: (0, import_TlvObject.TlvOptionalField)(1, import_TlvBoolean.TlvBoolean)
  });
  OperationalCredentials2.TlvCsrResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    nocsrElements: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 900 })),
    attestationSignature: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ length: 64 }))
  });
  OperationalCredentials2.TlvAddNocRequest = (0, import_TlvObject.TlvObject)({
    nocValue: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    icacValue: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    /**
     ...
     */
    ipkValue: (0, import_TlvObject.TlvField)(2, import_TlvString.TlvByteString.bound({ length: 16 })),
    /**
     ...
     */
    caseAdminSubject: (0, import_TlvObject.TlvField)(3, import_SubjectId.TlvSubjectId),
    /**
     ...
     */
    adminVendorId: (0, import_TlvObject.TlvField)(4, import_VendorId.TlvVendorId)
  });
  ...
  OperationalCredentials2.TlvNocResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    fabricIndex: (0, import_TlvObject.TlvOptionalField)(1, import_FabricIndex.TlvFabricIndex),
    /**
     ...
     */
    debugText: (0, import_TlvObject.TlvOptionalField)(2, import_TlvString.TlvString.bound({ maxLength: 128 }))
  });
  OperationalCredentials2.TlvUpdateNocRequest = (0, import_TlvObject.TlvObject)({
    nocValue: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    icacValue: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvByteString.bound({ maxLength: 400 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  OperationalCredentials2.TlvUpdateFabricLabelRequest = (0, import_TlvObject.TlvObject)({
    label: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvString.bound({ maxLength: 32 })),
    fabricIndex: (0, import_TlvObject.TlvField)(254, import_FabricIndex.TlvFabricIndex)
  });
  OperationalCredentials2.TlvRemoveFabricRequest = (0, import_TlvObject.TlvObject)({ fabricIndex: (0, import_TlvObject.TlvField)(0, import_FabricIndex.TlvFabricIndex) });
  OperationalCredentials2.TlvAddTrustedRootCertificateRequest = (0, import_TlvObject.TlvObject)({
    rootCaCertificate: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 400 }))
  });
  OperationalCredentials2.Cluster = import_ClusterFactory.ClusterFactory.Definition({
    id: 62,
    ...
    attributes: {
       ...
       */
      nocs: (0, import_Cluster.FabricScopedAttribute)(
        0,
        (0, import_TlvArray.TlvArray)(OperationalCredentials2.TlvNOCStruct, { maxLength: 254 }),
        {
          persistent: true,
          omitChanges: true,
          default: [],
          readAcl: import_Cluster.AccessLevel.Administer,
          writeAcl: import_Cluster.AccessLevel.Administer
        }
      ),
      /**
       ...
       */
      fabrics: (0, import_Cluster.FabricScopedAttribute)(
        1,
        (0, import_TlvArray.TlvArray)(OperationalCredentials2.TlvFabricDescriptorStruct, { maxLength: 254 }),
       ...
       */
      supportedFabrics: (0, import_Cluster.FixedAttribute)(2, import_TlvNumber.TlvUInt8.bound({ min: 5, max: 254 })),
      /**
       ...
       */
      commissionedFabrics: (0, import_Cluster.Attribute)(3, import_TlvNumber.TlvUInt8.bound({ max: 254 }), { persistent: true }),
      /**
       ...
       */
      trustedRootCertificates: (0, import_Cluster.Attribute)(
        4,
        (0, import_TlvArray.TlvArray)(import_TlvString.TlvByteString, { maxLength: 254 }),
       ...
       */
      currentFabricIndex: (0, import_Cluster.Attribute)(5, import_FabricIndex.TlvFabricIndex, { default: (0, import_FabricIndex.FabricIndex)(0) })
    },
    commands: {
      /**
      ...
      attestationRequest: (0, import_Cluster.Command)(
        0,
        OperationalCredentials2.TlvAttestationRequestRequest,
        1,
       ...
       */
      certificateChainRequest: (0, import_Cluster.Command)(
        2,
        OperationalCredentials2.TlvCertificateChainRequestRequest,
        3,
       ...
       */
      csrRequest: (0, import_Cluster.Command)(4, OperationalCredentials2.TlvCsrRequestRequest, 5, OperationalCredentials2.TlvCsrResponse, { invokeAcl: import_Cluster.AccessLevel.Administer }),
      /**
       ...
       */
      addNoc: (0, import_Cluster.Command)(6, OperationalCredentials2.TlvAddNocRequest, 8, OperationalCredentials2.TlvNocResponse, { invokeAcl: import_Cluster.AccessLevel.Administer }),
      /**
       ...
       */
      updateNoc: (0, import_Cluster.Command)(7, OperationalCredentials2.TlvUpdateNocRequest, 8, OperationalCredentials2.TlvNocResponse, { invokeAcl: import_Cluster.AccessLevel.Administer }),
      /**
       ...
       */
      updateFabricLabel: (0, import_Cluster.Command)(
        9,
       ...
       */
      removeFabric: (0, import_Cluster.Command)(
        10,
       ...
       */
      addTrustedRootCertificate: (0, import_Cluster.Command)(
        11,
...
//# sourceMappingURL=OperationalCredentialsCluster.js.map
