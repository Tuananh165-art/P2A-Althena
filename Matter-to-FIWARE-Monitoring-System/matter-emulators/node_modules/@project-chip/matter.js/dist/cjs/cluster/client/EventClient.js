...
__export(EventClient_exports, {
  ...
  SupportedEventClient: () => SupportedEventClient,
  UnknownSupportedEventClient: () => UnknownSupportedEventClient,
 ...
 */
function createEventClient(event, name, endpointId, clusterId, interactionClient, present = false) {
  if (event.unknown) {
...
class SupportedEventClient extends EventClient {
}
class UnknownSupportedEventClient extends EventClient {
}
