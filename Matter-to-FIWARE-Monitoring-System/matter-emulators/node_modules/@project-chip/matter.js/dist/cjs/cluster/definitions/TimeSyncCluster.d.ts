...
import { Attribute, OptionalAttribute, WritableAttribute, Command, FixedAttribute, Event } from "../../cluster/Cluster.js";
export declare namespace TimeSync {
    /**
     ...
     */
    const TlvTimeZoneStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        /**
     ...
     */
    const TlvDSTOffsetStruct: import("../../tlv/TlvObject.js").ObjectSchema<{
        offset: import("../../tlv/TlvObject.js").FieldType<number>;
        /**
         * The UTC time when the offset shall be applied.
         *
         ...
         */
        validUntil: import("../../tlv/TlvObject.js").FieldType<number | bigint>;
    }>;
    /**
    ...
    const Base: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             */
            readonly trustedTimeNodeId: WritableAttribute<import("../../datatype/NodeId.js").NodeId | null, any>;
        };
        readonly commands: {
            /**
     ...
     */
    const NtpClientComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
             ...
             */
            readonly defaultNtp: WritableAttribute<string | null, any>;
        };
    }>;
    /**
     * A TimeSyncCluster supports these elements if it supports feature TimeZone.
     */
    const TimeZoneComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
             ...
             */
            readonly timeZone: WritableAttribute<import("../../tlv/TlvObject.js").TypeFromFields<{
                /**
                 * The time zone offset from UTC in seconds.
                 *
                 * @see {@link MatterCoreSpecificationV1_1} § 11.16.6.3.1
             ...
             */
            readonly dstOffset: WritableAttribute<import("../../tlv/TlvObject.js").TypeFromFields<{
                offset: import("../../tlv/TlvObject.js").FieldType<number>;
                /**
                 * The UTC time when the offset shall be applied.
                 *
             ...
             */
            readonly timeZoneDatabase: FixedAttribute<boolean, any>;
        };
        readonly events: {
            /**
             ...
             */
            readonly dstStatus: Event<void, any>;
            /**
     ...
     */
    const NtpServerComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
             ...
             */
            readonly ntpServerPort: Attribute<number | null, any>;
        };
    }>;
    /**
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<56 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "TimeSync";
        revision: 1;
        features: {
            /**
        ...
        supportedFeatures: {};
        attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
            /**
             * If the server has achieved time synchronization, this shall indicate the current time as a UTC epoch-us
             * (Epoch Time in Microseconds).
             *
        ...
        readonly with: <T extends ("TimeZone" | "NtpClient" | "NtpServer")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * TimeZone
             *
             * Server supports time zone.
    ...
    type Extension<SF extends TypeFromPartialBitSchema<typeof Base.features>> = Omit<typeof Base, "supportedFeatures"> & {
        ...
        ntpClient: true;
    } ? typeof NtpClientComponent : {}) & (SF extends {
        timeZone: true;
    } ? typeof TimeZoneComponent : {}) & (SF extends {
        ntpServer: true;
    } ? typeof NtpServerComponent : {});
    /**
     ...
     */
    const Complete: ClusterFactory.Definition<{
        readonly id: 56 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "TimeSync";
        readonly revision: 1;
        readonly features: {
            /**
        ...
        readonly attributes: {
            ...
            readonly featureMap: Attribute<TypeFromPartialBitSchema<{
                /**
                 * TimeZone
                 *
                 * Server supports time zone.
...
export declare const TimeSyncCluster: {
    id: import("../../util/Type.js").Branded<56 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "TimeSync";
    revision: 1;
    features: {
    ...
    attributes: import("../../util/Type.js").Merge<import("../../util/Type.js").Merge<{
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.16.8.2
         */
        readonly granularity: Attribute<TimeSync.Granularity, any>;
        /**
         * The server’s time source. This attribute indicates what method the server is using to sync, whether the
         * source uses NTS or not and whether the source is internal or external to the Fabric. This attribute may
         * be used by a client to determine its level of trust in the UTCTime. It is of type TimeSourceEnum.
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.16.8.3
         */
        readonly timeSource: OptionalAttribute<TimeSync.TimeSource, any>;
        /**
         * The Node ID of a trusted Time Cluster. The TrustedTimeNodeId Node is used as a check on external time
         * sync sources and may be used as the primary time source if other time sources are unavailable. See
         * Section 11.16.13, “Time source prioritization”. This attribute is writeable only by an Administrator. It
    ...
    commands: {
        ...
        readonly setUtcTime: Command<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 11.16.9.1.2
             */
            granularity: import("../../tlv/TlvObject.js").FieldType<TimeSync.Granularity>;
            /**
             * This shall give the Client’s TimeSource, as described in Section 11.16.8.3, “TimeSource Attribute”.
             *
             * @see {@link MatterCoreSpecificationV1_1} § 11.16.9.1.3
             */
            timeSource: import("../../tlv/TlvObject.js").OptionalFieldType<TimeSync.TimeSource>;
        }>, void, any>;
    };
    /**
     * NTP from multiple servers on the Fabric and external. NTS is used on at least one server.
    ...
    readonly with: <T extends ("TimeZone" | "NtpClient" | "NtpServer")[]>(...features_0: T) => TimeSync.Extension<BitFlags<{
        /**
         * TimeZone
         *
         * Server supports time zone.
...
//# sourceMappingURL=TimeSyncCluster.d.ts.map