...
var AdministratorCommissioningCluster_exports = {};
__export(AdministratorCommissioningCluster_exports, {
  AdministratorCommissioning: () => AdministratorCommissioning,
  AdministratorCommissioningCluster: () => AdministratorCommissioningCluster
});
module.exports = __toCommonJS(AdministratorCommissioningCluster_exports);
...
((AdministratorCommissioning2) => {
  ...
  AdministratorCommissioning2.TlvOpenCommissioningWindowRequest = (0, import_TlvObject.TlvObject)({
    /**
  ...
  AdministratorCommissioning2.TlvOpenBasicCommissioningWindowRequest = (0, import_TlvObject.TlvObject)({ commissioningTimeout: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16) });
  let Feature;
  ((Feature2) => {
    Feature2["Basic"] = "Basic";
  })(Feature = AdministratorCommissioning2.Feature || (AdministratorCommissioning2.Feature = {}));
  AdministratorCommissioning2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 60,
    ...
    features: {
       ...
       */
      basic: (0, import_BitmapSchema.BitFlag)(0)
    },
    attributes: {
      /**
       ...
       */
      windowStatus: (0, import_Cluster.Attribute)(0, (0, import_TlvNumber.TlvEnum)()),
      /**
       ...
       */
      adminFabricIndex: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(import_FabricIndex.TlvFabricIndex)),
      /**
       ...
       */
      adminVendorId: (0, import_Cluster.Attribute)(2, (0, import_TlvNullable.TlvNullable)(import_VendorId.TlvVendorId))
    },
    commands: {
      /**
      ...
      openCommissioningWindow: (0, import_Cluster.Command)(
        ...
        { invokeAcl: import_Cluster.AccessLevel.Administer, timed: true }
      ),
      /**
       ...
       */
      revokeCommissioning: (0, import_Cluster.Command)(
        2,
  ...
  AdministratorCommissioning2.BasicComponent = import_ClusterFactory.ClusterFactory.Component({
    commands: {
      /**
       ...
       */
      openBasicCommissioningWindow: (0, import_Cluster.Command)(
        1,
  ...
  AdministratorCommissioning2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    AdministratorCommissioning2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...AdministratorCommissioning2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(AdministratorCommissioning2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, AdministratorCommissioning2.BasicComponent, { basic: true });
      return cluster;
    }
  );
  const BC = { basic: true };
  AdministratorCommissioning2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    commands: {
      ...
      openBasicCommissioningWindow: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=AdministratorCommissioningCluster.js.map
