    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          conformance: "M",
          constraint: "16 to 32",
          details: "This field shall be used by the Node as the PAKE Salt associated with the ephemeral PAKE passcode verifier to be used for this commissioning, which shall be sent by the Node to the new\nAdministrator\u2019s software as response to the PBKDFParamRequest during PASE negotiation. The constraints on the value shall match those specified in Section 3.9, \u201CPassword-Based Key Derivation Function (PBKDF)\u201D, within the definition of the Crypto_PBKDFParameterSet.\nWhen a Node receives the Open Commissioning Window command, it shall begin advertising on DNS-SD as described in Section 4.3.1, \u201CCommissionable Node Discovery\u201D and for a time period as described in Section 11.18.8.1.1, \u201CCommissioningTimeout Field\u201D. When the command is received by a SED, it shall enter into active mode and set its fast-polling interval to SLEEPY_ACTIVE_INTERVAL for at least the entire duration of the CommissioningTimeout.",
