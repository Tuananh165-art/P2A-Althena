...
export declare class Conformance extends Aspect<Conformance.Definition> {
    ...
    validateReferences(lookup: Conformance.ReferenceResolver<boolean>): void;
    toString(): string;
}
export declare namespace Conformance {
    ...
    type ReferenceResolver<T> = (name: string) => T;
    /**
    ...
    function validateReferences(conformance: Conformance, ast: Ast, resolver: ReferenceResolver<boolean>): void;
