...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      direction: "request",
      response: "LauncherResponse",
      details: "Upon receipt of this command, the server shall hide the application. The application shall be either\n  \u2022 the specified application, if the Application Platform feature is supported;\n  \u2022 otherwise the application corresponding to the endpoint.\nThe endpoint may decide to stop the application based on manufacturer specific behavior or resource constraints if any. The Status attribute shall be updated to ACTIVE_HIDDEN or STOPPED, depending on the action taken, on the Application Basic cluster of the Endpoint corresponding to the application on which the action was taken. The Status attribute shall be updated on any other application whose Status may have changed as a result of this command.\nThis command returns a Launcher Response.",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          type: "string",
          conformance: "M",
          details: 'This shall indicate the application identifier, expressed as a string, such as "PruneVideo" or "Company X". This field shall be unique within a catalog.\nFor the DIAL registry catalog, this value shall be the DIAL prefix (see [DIAL Registry]).',
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Application", id: 0, type: "ApplicationStruct", conformance: "M" },
        { tag: "datatype", name: "Endpoint", id: 1, type: "endpoint-no", conformance: "O" }
      ]
    }
  ]
});
