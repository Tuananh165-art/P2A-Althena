...
- F4: Alert center (warning/critical)
- F5: One-click simulate disaster event
- F6: Command execution demo (light/plug)
- F7: Audit trail (event + action + ack)
