...
((ThreadNetworkDiagnostics2) => {
  ...
  ThreadNetworkDiagnostics2.TlvNeighborTableStruct = TlvObject({
    /**
  ...
  ThreadNetworkDiagnostics2.TlvRouteTableStruct = TlvObject({
    extAddress: TlvField(0, TlvUInt64),
  ...
  ThreadNetworkDiagnostics2.Base = ClusterFactory.Definition({
    id: 53,
    ...
    attributes: {
       ...
       */
      meshLocalPrefix: Attribute(5, TlvNullable(TlvByteString.bound({ minLength: 1, maxLength: 17 }))),
      /**
       ...
       */
      neighborTable: Attribute(7, TlvArray(ThreadNetworkDiagnostics2.TlvNeighborTableStruct, { maxLength: 254 }), { default: [] }),
      /**
       ...
       */
      routeTable: Attribute(8, TlvArray(ThreadNetworkDiagnostics2.TlvRouteTableStruct, { maxLength: 254 }), { default: [] }),
      /**
       ...
       */
      activeNetworkFaults: Attribute(62, TlvArray(TlvEnum(), { maxLength: 4 }), { default: [] })
    },
    events: {
      /**
  ...
  ThreadNetworkDiagnostics2.ErrorCountsComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  ThreadNetworkDiagnostics2.MleCountsComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  ThreadNetworkDiagnostics2.MacCountsComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  ThreadNetworkDiagnostics2.Cluster = ClusterFactory.Extensible(
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...ThreadNetworkDiagnostics2.Base,
        supportedFeatures: BitFlags(ThreadNetworkDiagnostics2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.ErrorCountsComponent, { errorCounts: true });
      ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.MleCountsComponent, { mleCounts: true });
      ClusterFactory.extend(cluster, ThreadNetworkDiagnostics2.MacCountsComponent, { macCounts: true });
      return cluster;
    }
  );
  ...
  ThreadNetworkDiagnostics2.Complete = ClusterFactory.Definition({
