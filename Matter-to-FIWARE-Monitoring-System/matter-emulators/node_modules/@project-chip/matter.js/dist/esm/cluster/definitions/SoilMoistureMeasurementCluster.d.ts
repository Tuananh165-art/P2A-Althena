...
export declare namespace SoilMoistureMeasurement {
    /**
...
export declare const SoilMoistureMeasurementCluster: ClusterFactory.Definition<{
    readonly id: 1032;
    readonly name: "SoilMoistureMeasurement";
    readonly revision: 3;
    readonly attributes: {
...
//# sourceMappingURL=SoilMoistureMeasurementCluster.d.ts.map