...
const PairingHintBitmap = {
   ...
   */
  deviceManufacturerUrl: (0, import_BitmapSchema.BitFlag)(1),
  /**
   ...
   */
  administrator: (0, import_BitmapSchema.BitFlag)(2),
  /**
   * The settings menu on the Device provides instructions to put it into Commissioning Mode.
   */
  settingsMenuOnNode: (0, import_BitmapSchema.BitFlag)(3),
  /**
   ...
   */
  customInstruction: (0, import_BitmapSchema.BitFlag)(4),
  /**
   ...
   */
  pressRestButtonForNumberOfSeconds: (0, import_BitmapSchema.BitFlag)(8),
  /**
   ...
   */
  pressResetButtonUntilLightBlinks: (0, import_BitmapSchema.BitFlag)(9),
  /**
   ...
   */
  pressResetButtonForNumberOfSecondsWithApplicationOfPower: (0, import_BitmapSchema.BitFlag)(10),
  /**
   ...
   */
  pressResetButtonUntilLightBlinksWithApplicationOfPower: (0, import_BitmapSchema.BitFlag)(11),
  /**
