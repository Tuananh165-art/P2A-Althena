  ...
  children: [
    ...
    },
    {
      ...
      children: [{
        ...
        type: "int16",
        conformance: "M",
        details: "This shall indicate the number of steps to increase (Count is positive) or decrease (Count is negative) the current channel.",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "LineupName", id: 1, type: "string", conformance: "O", default: "" },
        { tag: "datatype", name: "PostalCode", id: 2, type: "string", conformance: "O", default: "" },
        {
          tag: "datatype",
          name: "LineupInfoType",
          id: 3,
    ...
    },
    {
      ...
      children: [{ tag: "datatype", name: "Mso", id: 0, conformance: "M", description: "MultiSystemOperator" }]
    },
    {
      tag: "datatype",
      name: "StatusEnum",
