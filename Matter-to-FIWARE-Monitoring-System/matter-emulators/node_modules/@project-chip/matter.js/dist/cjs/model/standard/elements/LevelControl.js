...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "StepMode", id: 0, type: "StepMode", conformance: "M", constraint: "desc" },
    ...
    },
    {
      ...
      conformance: "M",
      children: [
        { tag: "datatype", name: "Up", id: 0, conformance: "M" },
        { tag: "datatype", name: "Down", id: 1, conformance: "M" }
      ]
    },
    {
      tag: "datatype",
