...
class TlvByteArrayWriter {
  constructor() {
    this.writer = new import_DataWriter.DataWriter(import_ByteArray.Endian.Little);
  }
  writeTag(typeLength, tag) {
...
class TlvByteArrayReader {
  constructor(byteArray) {
    this.reader = new import_DataReader.DataReader(byteArray, import_ByteArray.Endian.Little);
  }
  readTagType() {
