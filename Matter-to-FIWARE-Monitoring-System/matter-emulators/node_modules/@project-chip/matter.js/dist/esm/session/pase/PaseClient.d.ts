...
import { PbkdfParameters } from "../../crypto/Spake2p.js";
...
export declare class PaseClient {
    ...
    pair(client: MatterController, exchange: MessageExchange<MatterController>, setupPin: number): Promise<import("../SecureSession.js").SecureSession<MatterController>>;
}
