...
export declare class ControllerCommissioner {
    ...
    private readonly reconnectWithDeviceCallback;
    ...
    constructor(interactionClient: InteractionClient, certificateManager: RootCertificateManager, fabric: Fabric, commissioningOptions: CommissioningOptions, nodeId: NodeId, adminVendorId: VendorId, reconnectWithDeviceCallback: () => Promise<InteractionClient>);
    /**
