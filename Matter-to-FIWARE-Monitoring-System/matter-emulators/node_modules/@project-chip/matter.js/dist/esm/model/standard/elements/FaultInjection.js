...
Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      conformance: "M",
      children: [
        { tag: "datatype", name: "Unspecified", id: 0, conformance: "M" },
        { tag: "datatype", name: "SystemFault", id: 1, conformance: "M" },
        { tag: "datatype", name: "InetFault", id: 2, conformance: "M" },
        { tag: "datatype", name: "ChipFault", id: 3, conformance: "M" },
        { tag: "datatype", name: "CertFault", id: 4, conformance: "M" }
      ]
    }
  ]
});
