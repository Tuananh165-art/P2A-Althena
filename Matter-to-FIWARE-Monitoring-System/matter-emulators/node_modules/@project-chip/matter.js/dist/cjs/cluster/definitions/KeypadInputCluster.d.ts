...
export declare namespace KeypadInput {
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<1289 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "KeypadInput";
        revision: 1;
        features: {
            /**
        ...
        supportedFeatures: {};
        attributes: import("../../util/Type.js").Merge<{}, import("../../cluster/Cluster.js").GlobalAttributes<{
            /**
             * NavigationKeyCodes
             *
             * Supports UP, DOWN, LEFT, RIGHT, SELECT, BACK, EXIT, MENU
        ...
        readonly with: <T extends ("NavigationKeyCodes" | "LocationKeys" | "NumberKeys")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * NavigationKeyCodes
             *
             * Supports UP, DOWN, LEFT, RIGHT, SELECT, BACK, EXIT, MENU
...
export declare const KeypadInputCluster: {
    id: import("../../util/Type.js").Branded<1289 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "KeypadInput";
    revision: 1;
    features: {
    ...
    commands: {
        ...
        readonly sendKey: Command<import("../../tlv/TlvObject.js").TypeFromFields<{
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.8.3.1.1
             */
            keyCode: import("../../tlv/TlvObject.js").FieldType<KeypadInput.CecKeyCode>;
        }>, import("../../tlv/TlvObject.js").TypeFromFields<{
            /**
             * This shall indicate the of the command.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.8.3.2.1
             */
            status: import("../../tlv/TlvObject.js").FieldType<KeypadInput.Status>;
        }>, any>;
    };
    events: {};
    unknown: false;
    ...
    readonly with: <T extends ("NavigationKeyCodes" | "LocationKeys" | "NumberKeys")[]>(...features_0: T) => KeypadInput.Extension<BitFlags<{
        /**
         * NavigationKeyCodes
         *
         * Supports UP, DOWN, LEFT, RIGHT, SELECT, BACK, EXIT, MENU
...
//# sourceMappingURL=KeypadInputCluster.d.ts.map