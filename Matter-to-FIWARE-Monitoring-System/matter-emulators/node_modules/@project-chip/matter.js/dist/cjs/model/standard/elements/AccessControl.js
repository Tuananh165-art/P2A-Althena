  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "ChangeType", id: 3, type: "ChangeTypeEnum", access: "S", conformance: "M" },
        {
          tag: "datatype",
          name: "LatestValue",
          id: 4,
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Cluster", id: 0, type: "cluster-id", conformance: "M", quality: "X" },
        { tag: "datatype", name: "Endpoint", id: 1, type: "endpoint-no", conformance: "M", quality: "X" },
        { tag: "datatype", name: "DeviceType", id: 2, type: "devtype-id", conformance: "M", quality: "X" }
      ]
    },
    {
      tag: "datatype",
