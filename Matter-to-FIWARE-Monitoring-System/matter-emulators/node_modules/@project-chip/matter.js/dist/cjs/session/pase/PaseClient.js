...
var import_CommissioningServer = require("../../CommissioningServer.js");
...
class PaseClient {
  static async generatePakePasscodeVerifier(setupPinCode, pbkdfParameters) {
    ...
    return import_ByteArray.ByteArray.concat(import_ByteArray.ByteArray.from(w0.toArray()), L);
  }
  static generateRandomPasscode() {
    let passcode;
    passcode = import_Crypto.Crypto.getRandomUInt32() % 99999998 + 1;
    if (import_CommissioningServer.FORBIDDEN_PASSCODES.includes(passcode)) {
      passcode += 1;
    }
    return passcode;
  }
