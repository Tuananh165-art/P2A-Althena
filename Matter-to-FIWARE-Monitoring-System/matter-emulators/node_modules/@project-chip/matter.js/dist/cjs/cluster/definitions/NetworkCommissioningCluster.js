...
var NetworkCommissioningCluster_exports = {};
__export(NetworkCommissioningCluster_exports, {
  NetworkCommissioning: () => NetworkCommissioning,
  NetworkCommissioningCluster: () => NetworkCommissioningCluster
});
module.exports = __toCommonJS(NetworkCommissioningCluster_exports);
...
((NetworkCommissioning2) => {
  NetworkCommissioning2.TlvNetworkInfoStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    networkId: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 32 })),
    /**
     ...
     */
    connected: (0, import_TlvObject.TlvField)(1, import_TlvBoolean.TlvBoolean)
  });
  ...
  NetworkCommissioning2.TlvScanNetworksRequest = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    ssid: (0, import_TlvObject.TlvOptionalField)(0, (0, import_TlvNullable.TlvNullable)(import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 32 }))),
    /**
  ...
  NetworkCommissioning2.WiFiSecurityBitmap = {
    /**
     * Supports unencrypted Wi-Fi
     */
    unencrypted: (0, import_BitmapSchema.BitFlag)(0),
    /**
     * Supports Wi-Fi using WEP security
     */
    wep: (0, import_BitmapSchema.BitFlag)(1),
    /**
     * Supports Wi-Fi using WPA-Personal security
     */
    wpaPersonal: (0, import_BitmapSchema.BitFlag)(2),
    /**
     * Supports Wi-Fi using WPA2-Personal security
     */
    wpa2Personal: (0, import_BitmapSchema.BitFlag)(3),
    /**
     * Supports Wi-Fi using WPA3-Personal security
     */
    wpa3Personal: (0, import_BitmapSchema.BitFlag)(4)
  };
  let WiFiBand;
  ((WiFiBand2) => {
  ...
  NetworkCommissioning2.TlvWiFiInterfaceScanResultStruct = (0, import_TlvObject.TlvObject)({
    security: (0, import_TlvObject.TlvOptionalField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, NetworkCommissioning2.WiFiSecurityBitmap)),
    ssid: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvByteString.bound({ maxLength: 32 })),
    bssid: (0, import_TlvObject.TlvOptionalField)(2, import_TlvString.TlvByteString.bound({ length: 6 })),
    channel: (0, import_TlvObject.TlvOptionalField)(3, import_TlvNumber.TlvUInt16),
    /**
     ...
     */
    wiFiBand: (0, import_TlvObject.TlvOptionalField)(4, (0, import_TlvNumber.TlvEnum)()),
    /**
     ...
     */
    rssi: (0, import_TlvObject.TlvOptionalField)(5, import_TlvNumber.TlvInt8)
  });
  NetworkCommissioning2.TlvThreadInterfaceScanResultStruct = (0, import_TlvObject.TlvObject)({
    panId: (0, import_TlvObject.TlvOptionalField)(0, import_TlvNumber.TlvUInt16.bound({ max: 65534 })),
    extendedPanId: (0, import_TlvObject.TlvOptionalField)(1, import_TlvNumber.TlvUInt64),
    networkName: (0, import_TlvObject.TlvOptionalField)(2, import_TlvString.TlvString.bound({ minLength: 1, maxLength: 16 })),
    channel: (0, import_TlvObject.TlvOptionalField)(3, import_TlvNumber.TlvUInt16),
    version: (0, import_TlvObject.TlvOptionalField)(4, import_TlvNumber.TlvUInt8),
    /**
     * ExtendedAddress stands for an IEEE 802.15.4 Extended Address.
     *
     * @see {@link MatterCoreSpecificationV1_1} § 11.8.5.6.1
     */
    extendedAddress: (0, import_TlvObject.TlvOptionalField)(5, import_TlvString.TlvByteString.bound({ minLength: 6, maxLength: 8 })),
    rssi: (0, import_TlvObject.TlvOptionalField)(6, import_TlvNumber.TlvInt8),
    lqi: (0, import_TlvObject.TlvOptionalField)(7, import_TlvNumber.TlvUInt8)
  });
  NetworkCommissioning2.TlvScanNetworksResponse = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    networkingStatus: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    /**
     ...
     */
    debugText: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvString.bound({ maxLength: 512 })),
    /**
     ...
     */
    wiFiScanResults: (0, import_TlvObject.TlvOptionalField)(2, (0, import_TlvArray.TlvArray)(NetworkCommissioning2.TlvWiFiInterfaceScanResultStruct)),
    /**
     ...
     */
    threadScanResults: (0, import_TlvObject.TlvOptionalField)(3, (0, import_TlvArray.TlvArray)(NetworkCommissioning2.TlvThreadInterfaceScanResultStruct))
  });
  NetworkCommissioning2.TlvRemoveNetworkRequest = (0, import_TlvObject.TlvObject)({
    networkId: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 32 })),
    breadcrumb: (0, import_TlvObject.TlvOptionalField)(1, import_TlvNumber.TlvUInt64)
  });
  NetworkCommissioning2.TlvNetworkConfigResponse = (0, import_TlvObject.TlvObject)({
    networkingStatus: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    debugText: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvString.bound({ maxLength: 512 })),
    /**
     ...
     */
    networkIndex: (0, import_TlvObject.TlvOptionalField)(2, import_TlvNumber.TlvUInt8)
  });
  NetworkCommissioning2.TlvConnectNetworkRequest = (0, import_TlvObject.TlvObject)({
    networkId: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 32 })),
    breadcrumb: (0, import_TlvObject.TlvOptionalField)(1, import_TlvNumber.TlvUInt64)
  });
  NetworkCommissioning2.TlvConnectNetworkResponse = (0, import_TlvObject.TlvObject)({
    networkingStatus: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    debugText: (0, import_TlvObject.TlvOptionalField)(1, import_TlvString.TlvString),
    /**
     ...
     */
    errorValue: (0, import_TlvObject.TlvField)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt32))
  });
  NetworkCommissioning2.TlvReorderNetworkRequest = (0, import_TlvObject.TlvObject)({
    networkId: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ minLength: 1, maxLength: 32 })),
    networkIndex: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt8),
    breadcrumb: (0, import_TlvObject.TlvOptionalField)(2, import_TlvNumber.TlvUInt64)
  });
  NetworkCommissioning2.TlvAddOrUpdateWiFiNetworkRequest = (0, import_TlvObject.TlvObject)({
    ssid: (0, import_TlvObject.TlvField)(0, import_TlvString.TlvByteString.bound({ maxLength: 32 })),
    /**
     ...
     */
    credentials: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ maxLength: 64 })),
    breadcrumb: (0, import_TlvObject.TlvOptionalField)(2, import_TlvNumber.TlvUInt64)
  });
  NetworkCommissioning2.TlvAddOrUpdateThreadNetworkRequest = (0, import_TlvObject.TlvObject)({
    /**
  ...
  NetworkCommissioning2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 49,
    ...
    features: {
       ...
       */
      wiFiNetworkInterface: (0, import_BitmapSchema.BitFlag)(0),
      /**
       * ThreadNetworkInterface
       *
       * Thread related features
       */
      threadNetworkInterface: (0, import_BitmapSchema.BitFlag)(1),
      /**
       * EthernetNetworkInterface
       *
       * Ethernet related features
       */
      ethernetNetworkInterface: (0, import_BitmapSchema.BitFlag)(2)
    },
    attributes: {
      /**
       ...
       */
      maxNetworks: (0, import_Cluster.FixedAttribute)(
        0,
        import_TlvNumber.TlvUInt8.bound({ min: 1 }),
        { readAcl: import_Cluster.AccessLevel.Administer, writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
       ...
       */
      networks: (0, import_Cluster.Attribute)(
        1,
        (0, import_TlvArray.TlvArray)(NetworkCommissioning2.TlvNetworkInfoStruct),
        { default: [], readAcl: import_Cluster.AccessLevel.Administer, writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
       ...
       */
      interfaceEnabled: (0, import_Cluster.WritableAttribute)(
        4,
        import_TlvBoolean.TlvBoolean,
        { persistent: true, default: true, writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
       ...
       */
      lastNetworkingStatus: (0, import_Cluster.Attribute)(
        5,
        (0, import_TlvNullable.TlvNullable)((0, import_TlvNumber.TlvEnum)()),
        { default: null, readAcl: import_Cluster.AccessLevel.Administer, writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
       ...
       */
      lastNetworkId: (0, import_Cluster.Attribute)(
        6,
       ...
       */
      lastConnectErrorValue: (0, import_Cluster.Attribute)(
        7,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt32),
        { default: null, readAcl: import_Cluster.AccessLevel.Administer, writeAcl: import_Cluster.AccessLevel.Administer }
      )
    }
  });
  NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      scanMaxTimeSeconds: (0, import_Cluster.FixedAttribute)(2, import_TlvNumber.TlvUInt8),
      /**
       * This attribute shall indicate the maximum duration taken, in seconds, by the network interface on this
       ...
       */
      connectMaxTimeSeconds: (0, import_Cluster.FixedAttribute)(3, import_TlvNumber.TlvUInt8)
    },
    commands: {
      /**
       ...
       */
      scanNetworks: (0, import_Cluster.Command)(
        0,
       ...
       */
      connectNetwork: (0, import_Cluster.Command)(
        6,
       ...
       */
      reorderNetwork: (0, import_Cluster.Command)(
        8,
  ...
  NetworkCommissioning2.WiFiNetworkInterfaceComponent = import_ClusterFactory.ClusterFactory.Component({
    commands: {
      /**
       ...
       */
      addOrUpdateWiFiNetwork: (0, import_Cluster.Command)(
        2,
  ...
  NetworkCommissioning2.ThreadNetworkInterfaceComponent = import_ClusterFactory.ClusterFactory.Component({
    commands: {
      /**
       ...
       */
      addOrUpdateThreadNetwork: (0, import_Cluster.Command)(
        3,
  ...
  NetworkCommissioning2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    NetworkCommissioning2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...NetworkCommissioning2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(NetworkCommissioning2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(
        cluster,
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent,
        { wiFiNetworkInterface: true },
        { threadNetworkInterface: true }
      );
      import_ClusterFactory.ClusterFactory.extend(cluster, NetworkCommissioning2.WiFiNetworkInterfaceComponent, { wiFiNetworkInterface: true });
      import_ClusterFactory.ClusterFactory.extend(cluster, NetworkCommissioning2.ThreadNetworkInterfaceComponent, { threadNetworkInterface: true });
      import_ClusterFactory.ClusterFactory.prevent(
        cluster,
  ...
  NetworkCommissioning2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    id: NetworkCommissioning2.Cluster.id,
    name: NetworkCommissioning2.Cluster.name,
    revision: NetworkCommissioning2.Cluster.revision,
    features: NetworkCommissioning2.Cluster.features,
    attributes: {
      ...NetworkCommissioning2.Cluster.attributes,
      scanMaxTimeSeconds: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent.attributes.scanMaxTimeSeconds,
        { mandatoryIf: [WI, TH] }
      ),
      connectMaxTimeSeconds: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent.attributes.connectMaxTimeSeconds,
        { mandatoryIf: [WI, TH] }
      )
    },
    commands: {
      scanNetworks: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent.commands.scanNetworks,
        { mandatoryIf: [WI, TH] }
      ),
      addOrUpdateWiFiNetwork: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceComponent.commands.addOrUpdateWiFiNetwork,
        { mandatoryIf: [WI] }
      ),
      addOrUpdateThreadNetwork: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.ThreadNetworkInterfaceComponent.commands.addOrUpdateThreadNetwork,
        { mandatoryIf: [TH] }
      ),
      removeNetwork: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent.commands.removeNetwork,
        { mandatoryIf: [WI, TH] }
      ),
      connectNetwork: import_ClusterFactory.ClusterFactory.AsConditional(
        NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent.commands.connectNetwork,
        { mandatoryIf: [WI, TH] }
      ),
      reorderNetwork: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=NetworkCommissioningCluster.js.map
