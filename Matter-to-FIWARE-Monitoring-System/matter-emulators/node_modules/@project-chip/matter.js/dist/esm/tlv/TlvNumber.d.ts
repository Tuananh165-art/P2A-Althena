...
export declare const TlvBitmap: <T extends BitSchema>(underlyingSchema: TlvNumberSchema, bitSchema: T) => TlvWrapper<import("../schema/BitmapSchema.js").TypeFromBitSchema<T>, number>;
