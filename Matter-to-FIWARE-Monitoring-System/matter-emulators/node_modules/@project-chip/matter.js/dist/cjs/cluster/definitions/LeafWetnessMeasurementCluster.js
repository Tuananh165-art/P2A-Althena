...
var LeafWetnessMeasurementCluster_exports = {};
__export(LeafWetnessMeasurementCluster_exports, {
  LeafWetnessMeasurement: () => LeafWetnessMeasurement,
  LeafWetnessMeasurementCluster: () => LeafWetnessMeasurementCluster
});
module.exports = __toCommonJS(LeafWetnessMeasurementCluster_exports);
 ...
 */
var LeafWetnessMeasurement;
((LeafWetnessMeasurement2) => {
  LeafWetnessMeasurement2.Cluster = import_ClusterFactory.ClusterFactory.Definition({
    id: 1031,
    ...
    attributes: {
       ...
       */
      measuredValue: (0, import_Cluster.Attribute)(0, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16.bound({ max: 1e4 }))),
      /**
       ...
       */
      minMeasuredValue: (0, import_Cluster.Attribute)(1, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt16)),
      /**
...
const LeafWetnessMeasurementCluster = LeafWetnessMeasurement.Cluster;
//# sourceMappingURL=LeafWetnessMeasurementCluster.js.map
