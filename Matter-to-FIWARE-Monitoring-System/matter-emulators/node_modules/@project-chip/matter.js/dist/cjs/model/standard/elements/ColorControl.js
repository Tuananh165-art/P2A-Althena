...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "None", id: 0 },
        { tag: "datatype", name: "OtherUnknown", id: 1 },
        { tag: "datatype", name: "TemperatureMonitoring", id: 2 },
        { tag: "datatype", name: "OpticalLuminanceMonitoringAndFeedback", id: 3 },
        { tag: "datatype", name: "OpticalColorMonitoringAndFeedback", id: 4 }
      ]
    },
    {
      tag: "attribute",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "CurrentHueAndCurrentSaturation", id: 0 },
        { tag: "datatype", name: "CurrentXAndCurrentY", id: 1 },
        { tag: "datatype", name: "ColorTemperatureMireds", id: 2 }
      ]
    },
    {
      tag: "attribute",
      ...
      children: [{ tag: "datatype", name: "ExecuteIfOff", id: 1, conformance: "M", constraint: "0" }]
    },
    {
      tag: "attribute",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "datatype", name: "CurrentXAndCurrentY", id: 1 },
        { tag: "datatype", name: "ColorTemperatureMireds", id: 2 },
        { tag: "datatype", name: "EnhancedCurrentHueAndCurrentSaturation", id: 3 }
      ]
    },
    {
      tag: "attribute",
      ...
      default: 0,
      quality: "N S",
      details: "The ColorLoopActive attribute specifies the current active status of the color loop. If this attribute\nhas the value 0, the color loop shall not be active. If this attribute has the value 1, the color loop shall be active. All other values (2 to 254) are reserved.",
    ...
    },
    {
      ...
      conformance: "O",
      constraint: "0 to 65279",
      details: "The WhitePointY attribute contains the normalized chromaticity value y, as defined in the CIE xyY Color Space, of the current white point of the device.\nThe value of y shall be related to the WhitePointY attribute by the relationship y = WhitePointY / 65536 (WhitePointY in the range 0 to 65279 inclusive)",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          type: "uint8",
          conformance: "M",
          details: "The Rate field specifies the rate of movement in steps per second. A step is a change in the device\u2019s\nsaturation of one unit. If the MoveMode field is set to 1 (up) or 3 (down) and the Rate field has a value of zero, the command has no effect and a response command shall be sent in response, with the status code set to INVALID_COMMAND. If the MoveMode field is set to 0 (stop) the Rate field shall be ignored.",
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Hue", id: 0, type: "uint8", conformance: "M", constraint: "0 to 254" },
        {
          tag: "datatype",
          name: "Saturation",
          id: 1,
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "StepX", id: 0, type: "int16", conformance: "M" },
        { tag: "datatype", name: "StepY", id: 1, type: "int16", conformance: "M" },
        {
          tag: "datatype",
          name: "TransitionTime",
          id: 2,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { tag: "datatype", name: "DeActivateTheColorLoop", id: 0 },
            {
              tag: "datatype",
        ...
        },
        {
          ...
          children: [
            { tag: "datatype", name: "DecrementTheHueInTheColorLoop", id: 0 },
            { tag: "datatype", name: "IncrementTheHueInTheColorLoop", id: 1 }
          ]
        },
        {
          tag: "datatype",
        ...
        { tag: "datatype", name: "StartHue", id: 4, type: "uint16", conformance: "M" },
        {
          tag: "datatype",
          name: "OptionsMask",
          id: 5,
    ...
    },
    {
      ...
      xref: { document: "cluster", section: "3.2.11.5.1" },
      children: [
        { tag: "datatype", name: "Stop", id: 0, conformance: "M" },
        { tag: "datatype", name: "Up", id: 1, conformance: "M" },
        { tag: "datatype", name: "Down", id: 3, conformance: "M" }
      ]
    },
    {
      tag: "datatype",
    ...
    },
    {
      ...
      xref: { document: "cluster", section: "3.2.11.4.2" },
      children: [
        { tag: "datatype", name: "ShortestDistance", id: 0, conformance: "M" },
        { tag: "datatype", name: "LongestDistance", id: 1, conformance: "M" },
        { tag: "datatype", name: "Up", id: 2, conformance: "M" },
        { tag: "datatype", name: "Down", id: 3, conformance: "M" }
      ]
    },
    {
