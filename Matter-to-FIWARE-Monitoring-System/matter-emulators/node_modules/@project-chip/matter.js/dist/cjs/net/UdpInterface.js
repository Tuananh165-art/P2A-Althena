...
class UdpInterface {
  ...
  static async create(type, port, host, netInterface) {
    return new UdpInterface(
      await import_Network.Network.get().createUdpChannel({ listeningPort: port, type, netInterface, listeningAddress: host })
    );
  }
