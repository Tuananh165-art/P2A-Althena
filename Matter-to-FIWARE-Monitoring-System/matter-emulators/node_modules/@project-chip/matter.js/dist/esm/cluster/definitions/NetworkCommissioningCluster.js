...
((NetworkCommissioning2) => {
  NetworkCommissioning2.TlvNetworkInfoStruct = TlvObject({
    /**
  ...
  NetworkCommissioning2.TlvWiFiInterfaceScanResultStruct = TlvObject({
    security: TlvOptionalField(0, TlvBitmap(TlvUInt8, NetworkCommissioning2.WiFiSecurityBitmap)),
  ...
  NetworkCommissioning2.TlvThreadInterfaceScanResultStruct = TlvObject({
  ...
  NetworkCommissioning2.TlvScanNetworksResponse = TlvObject({
     ...
     */
    wiFiScanResults: TlvOptionalField(2, TlvArray(NetworkCommissioning2.TlvWiFiInterfaceScanResultStruct)),
    /**
     ...
     */
    threadScanResults: TlvOptionalField(3, TlvArray(NetworkCommissioning2.TlvThreadInterfaceScanResultStruct))
  });
  ...
  NetworkCommissioning2.Base = ClusterFactory.Definition({
    id: 49,
    ...
    attributes: {
      ...
      networks: Attribute(
        1,
        TlvArray(NetworkCommissioning2.TlvNetworkInfoStruct),
  ...
  NetworkCommissioning2.WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  NetworkCommissioning2.WiFiNetworkInterfaceComponent = ClusterFactory.Component({
    commands: {
      /**
  ...
  NetworkCommissioning2.ThreadNetworkInterfaceComponent = ClusterFactory.Component({
    commands: {
      /**
  ...
  NetworkCommissioning2.Cluster = ClusterFactory.Extensible(
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...NetworkCommissioning2.Base,
        supportedFeatures: BitFlags(NetworkCommissioning2.Base.features, ...features)
      });
      ...
      ClusterFactory.extend(cluster, NetworkCommissioning2.WiFiNetworkInterfaceComponent, { wiFiNetworkInterface: true });
      ClusterFactory.extend(cluster, NetworkCommissioning2.ThreadNetworkInterfaceComponent, { threadNetworkInterface: true });
  ...
  NetworkCommissioning2.Complete = ClusterFactory.Definition({
