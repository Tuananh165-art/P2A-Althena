...
const TlvPbkdfParamRequest = (0, import_TlvObject.TlvObject)({
  ...
  sessionParams: (0, import_TlvObject.TlvOptionalField)(5, TlvSessionParameters)
});
const TlvPbkdfParamResponse = (0, import_TlvObject.TlvObject)({
  peerRandom: (0, import_TlvObject.TlvField)(1, import_TlvString.TlvByteString.bound({ length: 32 })),
  random: (0, import_TlvObject.TlvField)(2, import_TlvString.TlvByteString.bound({ length: 32 })),
