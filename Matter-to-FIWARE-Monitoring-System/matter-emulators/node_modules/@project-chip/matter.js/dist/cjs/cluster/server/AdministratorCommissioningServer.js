...
const PAKE_PASSCODE_VERIFIER_LENGTH = import_CryptoConstants.CRYPTO_GROUP_SIZE_BYTES + import_CryptoConstants.CRYPTO_PUBLIC_KEY_SIZE_BYTES;
import_AdministratorCommissioningCluster.AdministratorCommissioning.Base.commands = {
...
class AdministratorCommissioningManager {
  constructor(windowStatusAttribute, adminFabricIndexAttribute, adminVendorIdAttribute) {
    ...
    this.fabricRemoveHandler = () => this.adminFabricIndexAttribute.setLocal(null);
