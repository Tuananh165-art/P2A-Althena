...
var BasicInformationCluster_exports = {};
__export(BasicInformationCluster_exports, {
  BasicInformation: () => BasicInformation,
  BasicInformationCluster: () => BasicInformationCluster
});
module.exports = __toCommonJS(BasicInformationCluster_exports);
...
((BasicInformation2) => {
  BasicInformation2.TlvCapabilityMinimaStruct = (0, import_TlvObject.TlvObject)({
    /**
     ...
     */
    caseSessionsPerFabric: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16.bound({ min: 3 })),
    /**
     ...
     */
    subscriptionsPerFabric: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt16.bound({ min: 3 }))
  });
  let ProductFinish;
  ((ProductFinish2) => {
  ...
  BasicInformation2.TlvProductAppearanceStruct = (0, import_TlvObject.TlvObject)({
    finish: (0, import_TlvObject.TlvField)(0, (0, import_TlvNumber.TlvEnum)()),
    primaryColor: (0, import_TlvObject.TlvField)(1, (0, import_TlvNullable.TlvNullable)((0, import_TlvNumber.TlvEnum)()))
  });
  BasicInformation2.TlvStartUpEvent = (0, import_TlvObject.TlvObject)({
    /**
  ...
  BasicInformation2.TlvLeaveEvent = (0, import_TlvObject.TlvObject)({
    /**
  ...
  BasicInformation2.TlvReachableChangedEvent = (0, import_TlvObject.TlvObject)({
    /**
  ...
  BasicInformation2.Cluster = import_ClusterFactory.ClusterFactory.Definition({
    id: 40,
    ...
    attributes: {
       ...
       */
      dataModelRevision: (0, import_Cluster.FixedAttribute)(0, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      vendorName: (0, import_Cluster.FixedAttribute)(1, import_TlvString.TlvString.bound({ maxLength: 32 })),
      /**
       * This attribute shall specify the Vendor ID.
       *
       * @see {@link MatterCoreSpecificationV1_1} § 11.1.5.3
       */
      vendorId: (0, import_Cluster.FixedAttribute)(2, import_VendorId.TlvVendorId),
      /**
       ...
       */
      productName: (0, import_Cluster.FixedAttribute)(3, import_TlvString.TlvString.bound({ maxLength: 32 })),
      /**
       ...
       */
      productId: (0, import_Cluster.FixedAttribute)(4, import_TlvNumber.TlvUInt16),
      /**
       ...
       */
      nodeLabel: (0, import_Cluster.WritableAttribute)(
        5,
        import_TlvString.TlvString.bound({ maxLength: 32 }),
        { persistent: true, default: "", writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
       ...
       */
      location: (0, import_Cluster.WritableAttribute)(
        6,
        import_TlvString.TlvString.bound({ length: 2 }),
        { persistent: true, default: "XX", writeAcl: import_Cluster.AccessLevel.Administer }
      ),
      /**
       ...
       */
      hardwareVersion: (0, import_Cluster.FixedAttribute)(7, import_TlvNumber.TlvUInt16, { default: 0 }),
      /**
       * This attribute shall specify the version number of the hardware of the Node. The meaning of its value,
       ...
       */
      hardwareVersionString: (0, import_Cluster.FixedAttribute)(8, import_TlvString.TlvString.bound({ minLength: 1, maxLength: 64 })),
      /**
       ...
       */
      softwareVersion: (0, import_Cluster.FixedAttribute)(9, import_TlvNumber.TlvUInt32, { default: 0 }),
      /**
       ...
       */
      softwareVersionString: (0, import_Cluster.FixedAttribute)(10, import_TlvString.TlvString.bound({ minLength: 1, maxLength: 64 })),
      /**
       ...
       */
      localConfigDisabled: (0, import_Cluster.OptionalWritableAttribute)(
        16,
        import_TlvBoolean.TlvBoolean,
        { persistent: true, default: true, writeAcl: import_Cluster.AccessLevel.Manage }
      ),
      /**
       ...
       */
      reachable: (0, import_Cluster.OptionalAttribute)(17, import_TlvBoolean.TlvBoolean, { default: true }),
      /**
       ...
       */
      capabilityMinima: (0, import_Cluster.FixedAttribute)(
        19,
        BasicInformation2.TlvCapabilityMinimaStruct,
        { default: { caseSessionsPerFabric: 3, subscriptionsPerFabric: 3 } }
      ),
      productAppearance: (0, import_Cluster.OptionalFixedAttribute)(20, BasicInformation2.TlvProductAppearanceStruct)
    },
    events: {
      /**
       ...
       */
      startUp: (0, import_Cluster.Event)(0, import_Cluster.EventPriority.Critical, BasicInformation2.TlvStartUpEvent),
      /**
       ...
       */
      leave: (0, import_Cluster.OptionalEvent)(2, import_Cluster.EventPriority.Info, BasicInformation2.TlvLeaveEvent),
      /**
       ...
       */
      reachableChanged: (0, import_Cluster.OptionalEvent)(3, import_Cluster.EventPriority.Info, BasicInformation2.TlvReachableChangedEvent)
    }
  });
})(BasicInformation || (BasicInformation = {}));
const BasicInformationCluster = BasicInformation.Cluster;
//# sourceMappingURL=BasicInformationCluster.js.map
