...
import_Matter.Matter.children.push({
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { tag: "datatype", name: "Rate10M", id: 0, conformance: "M", description: "PHY rate is 10Mbps" },
        { tag: "datatype", name: "Rate100M", id: 1, conformance: "M", description: "PHY rate is 100Mbps" },
        { tag: "datatype", name: "Rate1G", id: 2, conformance: "M", description: "PHY rate is 1Gbps" },
        { tag: "datatype", name: "Rate25G", id: 3, conformance: "M", description: "PHY rate is 2.5Gbps" },
        { tag: "datatype", name: "Rate5G", id: 4, conformance: "M", description: "PHY rate is 5Gbps" },
        { tag: "datatype", name: "Rate10G", id: 5, conformance: "M", description: "PHY rate is 10Gbps" },
        { tag: "datatype", name: "Rate40G", id: 6, conformance: "M", description: "PHY rate is 40Gbps" },
        { tag: "datatype", name: "Rate100G", id: 7, conformance: "M", description: "PHY rate is 100Gbps" },
        { tag: "datatype", name: "Rate200G", id: 8, conformance: "M", description: "PHY rate is 200Gbps" },
        { tag: "datatype", name: "Rate400G", id: 9, conformance: "M", description: "PHY rate is 400Gbps" }
      ]
    }
  ]
});
