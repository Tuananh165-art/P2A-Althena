...
import { BitFlag, BitsFromPartial, BitFlags } from "../../schema/BitmapSchema.js";
import {
  Attribute,
  OptionalAttribute,
...
((Thermostat2) => {
  ...
  Thermostat2.ThermostatProgrammingOperationMode = {
    /**
  ...
  Thermostat2.ThermostatRunningState = {
    /**
     * Heat State On
     */
    heat: BitFlag(0),
  ...
  let SetpointAdjustMode;
  ((SetpointAdjustMode2) => {
    SetpointAdjustMode2[SetpointAdjustMode2["Heat"] = 0] = "Heat";
    SetpointAdjustMode2[SetpointAdjustMode2["Cool"] = 1] = "Cool";
    SetpointAdjustMode2[SetpointAdjustMode2["Both"] = 2] = "Both";
  })(SetpointAdjustMode = Thermostat2.SetpointAdjustMode || (Thermostat2.SetpointAdjustMode = {}));
  Thermostat2.TlvSetpointRaiseLowerRequest = TlvObject({
    mode: TlvField(0, TlvEnum()),
    amount: TlvField(1, TlvInt8)
  });
  Thermostat2.Occupancy = { occupied: BitFlag(0) };
  ...
  Thermostat2.ModeForSequence = { heatSetpointPresent: BitFlag(0), coolSetpointPresent: BitFlag(1) };
  Thermostat2.TlvThermostatScheduleTransition = TlvObject({
    /**
  ...
  Thermostat2.TlvSetWeeklyScheduleRequest = TlvObject({
    ...
    dayOfWeekForSequence: TlvField(1, TlvBitmap(TlvUInt8, Thermostat2.DayOfWeek)),
    modeForSequence: TlvField(2, TlvBitmap(TlvUInt8, Thermostat2.ModeForSequence)),
    transitions: TlvField(3, TlvArray(Thermostat2.TlvThermostatScheduleTransition))
  });
  Thermostat2.TlvGetWeeklyScheduleRequest = TlvObject({
    daysToReturn: TlvField(0, TlvBitmap(TlvUInt8, Thermostat2.DayOfWeek)),
    modeToReturn: TlvField(1, TlvBitmap(TlvUInt8, Thermostat2.ModeForSequence))
  });
  ...
  Thermostat2.Base = ClusterFactory.Definition({
    id: 513,
    name: "Thermostat",
    revision: 6,
    features: {
    ...
    attributes: {
       ...
       */
      alarmMask: OptionalAttribute(29, TlvBitmap(TlvUInt8, Thermostat2.AlarmMask)),
      /**
      ...
      thermostatProgrammingOperationMode: OptionalWritableAttribute(
        37,
        TlvBitmap(TlvUInt8, Thermostat2.ThermostatProgrammingOperationMode),
        { writeAcl: AccessLevel.Manage }
      ),
      /**
       ...
       */
      thermostatRunningState: OptionalAttribute(41, TlvBitmap(TlvUInt16, Thermostat2.ThermostatRunningState)),
      /**
       ...
       */
      acCoilTemperature: OptionalAttribute(70, TlvNullable(TlvInt16.bound({ min: -27315 })), { default: null }),
      /**
  ...
  Thermostat2.OccupancyComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.HeatingComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.CoolingComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.NotLocalTemperatureNotExposedComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.CoolingAndOccupancyComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.HeatingAndOccupancyComponent = ClusterFactory.Component({
    attributes: {
      /**
      ...
      unoccupiedHeatingSetpoint: WritableAttribute(
        20,
        TlvInt16.bound({ min: -27315 }),
        { persistent: true, default: 2e3 }
      )
    }
  });
  Thermostat2.AutoModeComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.ScheduleConfigurationComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.SetbackComponent = ClusterFactory.Component({
    attributes: {
      /**
  ...
  Thermostat2.SetbackAndOccupancyComponent = ClusterFactory.Component({
    attributes: {
      /**
       * This attribute specifies the amount that the Thermostat server will allow the LocalTemperature Value to
       ...
       */
      unoccupiedSetbackMax: FixedAttribute(57, TlvNullable(TlvUInt8.bound({ max: 254 })), { default: null })
    }
  });
  Thermostat2.Cluster = ClusterFactory.Extensible(
    Thermostat2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = ClusterFactory.Definition({
        ...Thermostat2.Base,
        supportedFeatures: BitFlags(Thermostat2.Base.features, ...features)
      });
      ClusterFactory.extend(cluster, Thermostat2.OccupancyComponent, { occupancy: true });
      ClusterFactory.extend(cluster, Thermostat2.HeatingComponent, { heating: true });
      ClusterFactory.extend(cluster, Thermostat2.CoolingComponent, { cooling: true });
      ClusterFactory.extend(
        cluster,
        Thermostat2.NotLocalTemperatureNotExposedComponent,
        { localTemperatureNotExposed: false }
      );
      ClusterFactory.extend(cluster, Thermostat2.CoolingAndOccupancyComponent, { cooling: true, occupancy: true });
      ClusterFactory.extend(cluster, Thermostat2.HeatingAndOccupancyComponent, { heating: true, occupancy: true });
      ClusterFactory.extend(cluster, Thermostat2.AutoModeComponent, { autoMode: true });
      ClusterFactory.extend(cluster, Thermostat2.ScheduleConfigurationComponent, { scheduleConfiguration: true });
      ClusterFactory.extend(cluster, Thermostat2.SetbackComponent, { setback: true });
      ClusterFactory.extend(cluster, Thermostat2.SetbackAndOccupancyComponent, { setback: true, occupancy: true });
  ...
  Thermostat2.Complete = ClusterFactory.Definition({
    id: Thermostat2.Cluster.id,
    name: Thermostat2.Cluster.name,
    revision: Thermostat2.Cluster.revision,
    features: Thermostat2.Cluster.features,
    attributes: {
      ...Thermostat2.Cluster.attributes,
      occupancy: ClusterFactory.AsConditional(Thermostat2.OccupancyComponent.attributes.occupancy, { mandatoryIf: [OCC] }),
...
//# sourceMappingURL=ThermostatCluster.js.map
