 ...
 */
import { MAX_MESSAGE_SIZE, MessageCodec, SessionType } from "../codec/MessageCodec.js";
...
class ExchangeManager {
  constructor(sessionManager, channelManager) {
    ...
    this.transportListeners = new Array();
    this.closingSessions = /* @__PURE__ */ new Set();
  }
  ...
  async onMessage(channel, messageBytes) {
    ...
    if (exchange !== void 0 && (exchange.session.getId() !== session.getId() || exchange.isInitiator === message.payloadHeader.isInitiatorMessage)) {
      exchange = void 0;
    }
    if (exchange !== void 0) {
      ...
      if (protocolHandler !== void 0 && message.payloadHeader.isInitiatorMessage && !isDuplicate) {
        ...
        this.exchanges.set(exchangeIndex, exchange2);
        ...
        if (isDuplicate) {
          ...
          logger.warn(
            `Discarding unexpected message ${messageId} for protocol ${message.payloadHeader.protocolId}: ${Logger.toJSON(message)}`
          );
        }
      }
    }
...
class ExchangeCounter {
  constructor() {
    this.exchangeCounter = Crypto.getRandomUInt16();
  }
...
class ExchangeProvider {
  ...
  async reconnectChannel() {
    if (this.reconnectChannelFunc === void 0)
      return false;
