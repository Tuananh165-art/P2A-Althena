...
import { Attribute, OptionalAttribute, WritableAttribute, OptionalWritableAttribute, Command } from "../../cluster/Cluster.js";
export declare namespace LevelControl {
    ...
    const TlvMoveToLevelRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        ...
        optionsMask: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            executeIfOff: BitFlag;
            coupleColorTempToLevel: BitFlag;
        }>>;
        optionsOverride: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            executeIfOff: BitFlag;
            coupleColorTempToLevel: BitFlag;
        }>>;
    }>;
     ...
     */
    const TlvMoveToLevelWithOnOffRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        level: import("../../tlv/TlvObject.js").FieldType<number>;
        transitionTime: import("../../tlv/TlvObject.js").FieldType<number | null>;
        optionsMask: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            executeIfOff: BitFlag;
     ...
     * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
     */
    const TlvMoveWithOnOffRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        moveMode: import("../../tlv/TlvObject.js").FieldType<MoveMode>;
        rate: import("../../tlv/TlvObject.js").FieldType<number | null>;
        optionsMask: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            executeIfOff: BitFlag;
     ...
     * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
     */
    const TlvStepWithOnOffRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        stepMode: import("../../tlv/TlvObject.js").FieldType<StepMode>;
        stepSize: import("../../tlv/TlvObject.js").FieldType<number>;
        transitionTime: import("../../tlv/TlvObject.js").FieldType<number | null>;
        optionsMask: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
     ...
     * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.6
     */
    const TlvStopWithOnOffRequest: import("../../tlv/TlvObject.js").ObjectSchema<{
        optionsMask: import("../../tlv/TlvObject.js").FieldType<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
            executeIfOff: BitFlag;
            coupleColorTempToLevel: BitFlag;
        }>>;
    ...
    const Base: ClusterFactory.Definition<{
        ...
        readonly attributes: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.6.5.8
             */
            readonly options: WritableAttribute<import("../../schema/BitmapSchema.js").TypeFromBitSchema<{
                executeIfOff: BitFlag;
                coupleColorTempToLevel: BitFlag;
            }>, any>;
            /**
     ...
     */
    const LightingComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const FrequencyComponent: ClusterFactory.TypedComponent<{
        readonly attributes: {
            /**
     ...
     */
    const Cluster: {
        id: import("../../util/Type.js").Branded<8 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
        name: "LevelControl";
        revision: 5;
        features: {
            /**
        ...
        readonly id: 8 & import("../../util/Type.js").Brand<"ClusterId">;
        readonly name: "LevelControl";
        readonly revision: 5;
        readonly features: {
            /**
        ...
        readonly with: <T extends ("OnOff" | "Lighting" | "Frequency")[]>(...features_0: T) => Extension<BitFlags<{
            /**
             * OnOff
             *
             * Dependency with the On/Off cluster
    ...
    type Extension<SF extends TypeFromPartialBitSchema<typeof Base.features>> = Omit<typeof Base, "supportedFeatures"> & {
        ...
        lighting: true;
    } ? typeof LightingComponent : {}) & (SF extends {
        frequency: true;
...
export declare const LevelControlCluster: {
    id: import("../../util/Type.js").Branded<8 & import("../../util/Type.js").Brand<"ClusterId">, "ClusterId">;
    name: "LevelControl";
    revision: 5;
    features: {
    ...
    readonly with: <T extends ("OnOff" | "Lighting" | "Frequency")[]>(...features_0: T) => LevelControl.Extension<BitFlags<{
        /**
         * OnOff
         *
         * Dependency with the On/Off cluster
...
//# sourceMappingURL=LevelControlCluster.d.ts.map