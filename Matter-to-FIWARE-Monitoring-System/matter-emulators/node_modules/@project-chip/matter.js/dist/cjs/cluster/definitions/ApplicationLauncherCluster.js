...
var ApplicationLauncherCluster_exports = {};
__export(ApplicationLauncherCluster_exports, {
  ApplicationLauncher: () => ApplicationLauncher,
  ApplicationLauncherCluster: () => ApplicationLauncherCluster
});
module.exports = __toCommonJS(ApplicationLauncherCluster_exports);
...
((ApplicationLauncher2) => {
  ApplicationLauncher2.TlvApplicationStruct = (0, import_TlvObject.TlvObject)({
    /**
  ...
  ApplicationLauncher2.TlvApplicationEPStruct = (0, import_TlvObject.TlvObject)({
    application: (0, import_TlvObject.TlvField)(0, ApplicationLauncher2.TlvApplicationStruct),
  ...
  ApplicationLauncher2.TlvLaunchAppRequest = (0, import_TlvObject.TlvObject)({
     ...
     */
    application: (0, import_TlvObject.TlvOptionalField)(0, ApplicationLauncher2.TlvApplicationStruct),
    /**
  ...
  ApplicationLauncher2.Base = import_ClusterFactory.ClusterFactory.Definition({
    id: 1292,
    ...
    attributes: {
       ...
       */
      currentApp: (0, import_Cluster.OptionalAttribute)(1, (0, import_TlvNullable.TlvNullable)(ApplicationLauncher2.TlvApplicationEPStruct), { default: null })
    },
    commands: {
      /**
  ...
  ApplicationLauncher2.ApplicationPlatformComponent = import_ClusterFactory.ClusterFactory.Component({
    attributes: {
      /**
       ...
       */
      catalogList: (0, import_Cluster.Attribute)(0, (0, import_TlvArray.TlvArray)(import_TlvNumber.TlvUInt16), { persistent: true })
    }
  });
  ApplicationLauncher2.Cluster = import_ClusterFactory.ClusterFactory.Extensible(
    ApplicationLauncher2.Base,
    /**
    ...
    (...features) => {
      ...
      const cluster = import_ClusterFactory.ClusterFactory.Definition({
        ...ApplicationLauncher2.Base,
        supportedFeatures: (0, import_BitmapSchema.BitFlags)(ApplicationLauncher2.Base.features, ...features)
      });
      import_ClusterFactory.ClusterFactory.extend(cluster, ApplicationLauncher2.ApplicationPlatformComponent, { applicationPlatform: true });
      return cluster;
    }
  );
  const AP = { applicationPlatform: true };
  ApplicationLauncher2.Complete = import_ClusterFactory.ClusterFactory.Definition({
    ...
    attributes: {
      ...
      catalogList: import_ClusterFactory.ClusterFactory.AsConditional(
...
//# sourceMappingURL=ApplicationLauncherCluster.js.map
