...
declare const OnOffBaseDevice_base: new (definition: DeviceTypeDefinition, options?: EndpointOptions | undefined) => Device & {
    ...
    removeCommandHandler<K_1 extends keyof OnOffBaseDeviceCommands>(action: K_1, handler: OnOffBaseDeviceCommands[K_1]): void;
    _executeHandler<K_2 extends keyof OnOffBaseDeviceCommands>(action: K_2, ...args: Parameters<OnOffBaseDeviceCommands[K_2]>): Promise<void>;
};
/**
